            ...
            ?>
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="clave">Diagnóstico:</label>
                  <input type="text" size="30" name="diag"  id="clave" class="form-control" 
                  value="<?php echo $row_datos['diagnostico']; ?>" required>
                </div>
                <div class="form-group">
                  <label for="clave">Clave CIE10:</label>
                  <input type="text" size="30" name="id_cie10"  id="clave" class="form-control" 
                  value="<?php echo $row_datos['id_cie10']; ?>" required>
                </div>

                <center><input type="submit" name="edit" class="btn btn-success" value="GUARDAR">
                  <a href="cat_diagnosticos.php" class="btn btn-danger">Cancelar</a>
                </center>

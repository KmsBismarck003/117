            ...
            <div class="modern-card">
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="form-section">
                  <h5><i class="fas fa-utensils"></i> Información de la dieta</h5>
                  <div class="modern-form-group">
                    <label for="dieta"><i class="fas fa-utensils"></i> Nombre de la dieta:</label>
                    <input type="text" size="30" name="dieta" placeholder="Nombre de la dieta" id="dieta" class="form-control modern-form-control" value="<?php echo $row_datos['dieta']; ?>" required>
                  </div>
                  <div class="button-container">
                    <input type="submit" name="edit" class="btn modern-btn modern-btn-success" value="GUARDAR">
                    <a href="../dietas/cat_dietas.php" class="btn modern-btn modern-btn-danger">CANCELAR</a>
                  </div>
                </div>
              </form>
              <?php } ?>

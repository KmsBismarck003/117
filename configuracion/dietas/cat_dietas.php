            ...
            <form action="insertar_dieta.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="dieta" style="color: #2b2d7f; font-weight:600;">Nombre de la dieta:</label>
                        <input type="text" name="dieta" id="dieta" class="form-control modern-search" value="" required placeholder="Nombre de la dieta">
                    </div>
                </div>

...
if( isset($_GET['id_usua'])) { //si existe el id mandado por metodo GET, se hara la consulta donde el id debe ser igual al id mandado por el metodo GET
  ...
  if(mysqli_num_rows($resultado) > 0 ){ //se mostrara si existe mas de 1
    ...
    header("location: header_configuracion.php"); //te regresa a la página principal
  }
}else{
  header("location: header_configuracion.php"); //te regresa a la página principal
}
...
<div class="container-fluid">
       ...
       <div class="row">
             ...
             <div class="col-sm-4">
              ...
              <div class="col-sm-4">
    <label for="img_perfil"><strong><font size="2">Seleccionar imagen del perfil</font></strong></label>
...
//firma.jpg
        ...
        $sql2 = "UPDATE reg_usuarios SET curp_u='$curp_u' , nombre='$nombre', papell='$papell', fecnac='$fecnac', tel='$tel', email='$email', pre='$pre', pass='$pass', cedp='$cedp', cargp='$cargp' WHERE id_usua= ".$_GET['id_usua'];
     // echo $sql2;
      // return 'hbgk';
        $result = $conexion->query($sql2);
        echo "<p class='alert alert-success' id='mensaje'> <i class=' fa fa-check'></i> Dato insertado correctamente...</p>";
        echo '<script type="text/javascript">window.location ="../../template/menu_configuracion.php"</script>';
      }
?>
 </div>

...
if (isset($_POST['clave']) and
    ...
    $serv_tipo = ($_POST['tipo']);
     ...
     $ingresar=mysqli_query($conexion,'insert into cat_servicios (serv_cve,serv_desc,serv_costo,serv_umed,serv_activo,tipo) values("' . $serv_cve . '","' . $serv_desc . '","' . $serv_costo . '","' . $serv_umed . '","SI","' . $serv_tipo . '")') or die ('<p>Error al registrar</p><br>'.mysqli_error($conexion));

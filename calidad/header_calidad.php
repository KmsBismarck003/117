...
if (!($usuario['id_rol'] == 12 || $usuario['id_rol'] == 5 || $usuario['id_rol'] == 1)) {
    session_unset();
    session_destroy();
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p><font size ="2"><?php echo $usuario['nombre']; ?> <?php echo $usuario['papell']; ?></font></p>
            ...
            <ul class="sidebar-menu">
               ...
               <li class="">
                ...
                <a href="../estadisticas/observaciones.php">
            ...
            <li class="">
                <a href="../estadisticas/estadisticas.php" >
                    <i class="fa fa-line-chart"></i> <span><font size ="2">REPORTE DE ESTADÍSTICAS <br>  MENSUAL</font></span> <i class="fa fa-angle-left pull-right"></i>
                </a>
            </li>
            <li class="">
                <a href="../reportes/reporte_medico.php">
                    <i class="fa fa-heart" aria-hidden="true"></i> <span><font size ="2">REPORTES MEDICOS </font></span> <i class="fa fa-angle-left pull-right"></i>
                </a>
            </li>
            <li class="">
                <a href="../reportes_trans/reporte_quir.php">
                    <i class="fa fa-heartbeat" aria-hidden="true"></i> <span><font size ="2">REPORTES QUIRURGICOS </font></span> <i class="fa fa-angle-left pull-right"></i>
                </a>
            </li>
            <li class="">
                <a href="../reportes_admin/reportes_admin.php">
                    <i class="fa fa-archive" aria-hidden="true"></i> <span><font size ="2">REPORTES <br> ADMINISTRATIVOS </font></span> <i class="fa fa-angle-left pull-right"></i>
                </a>
            </li>
            </ul>
        </section>

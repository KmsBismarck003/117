    ...
    <div class="row">
        <div class="col  col-12">
            <h2>
                ...
                <center><font id="letra"><i class="fa fa-question-circle"></i> REPORTE DE OBSERVACIONES MENSUAL</font></h2></center><hr>
...
<form action="pdf_estadisticas.php" method="POST" target="_blank">
    <div class="container box">

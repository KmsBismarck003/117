...
$sql_tabla = "SELECT motivo_atn, COUNT(motivo_atn) as cuantos FROM `dat_ingreso` WHERE MONTH(fecha)=$mes and YEAR(fecha)=$anio and motivo_atn='$diagn' GROUP BY 1 HAVING COUNT(motivo_atn)>=1 ORDER BY cuantos DESC";

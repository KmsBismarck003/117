...
$sql_tabla = "SELECT motivo_atn, COUNT(motivo_atn) as cuantos FROM `dat_ingreso` WHERE YEAR(fecha)=$anio GROUP BY 1 HAVING COUNT(motivo_atn)>=1 ORDER BY cuantos DESC";

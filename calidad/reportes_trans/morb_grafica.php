...
<body>
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      <div class="thead">
     <h3><center><font id="letra"> GRÁFICA DE PRINCIPALES CAUSAS DE MORBILIDAD EN EL AÑO <?php echo $anio ?></font></h3></center>
   </div>
    </div>
    <div class="col-sm">
...
$sql_tabla = "SELECT motivo_atn, COUNT(motivo_atn) as cuantos FROM `dat_ingreso` WHERE YEAR(fecha)=$anio GROUP BY 1 HAVING COUNT(motivo_atn)>=0 ORDER BY cuantos DESC LIMIT 10";
...
$motivo_atn = $motivo_atn . '"'. $f2['motivo_atn'].'",';
}
$motivo_atn = trim($motivo_atn,",");
$cuantos = trim($cuantos,",");




 $sql_tabla3 = "SELECT count(motivo_atn) as sum FROM `dat_ingreso` 
 WHERE YEAR(fecha)=$anio limit 1";

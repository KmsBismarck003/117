...
$pdf->SetX(25);
$pdf->Cell(170, 5, utf8_decode('REPORTE DE CIRUGÍA MENSUAL'), 0, 0, 'C');
$pdf->Ln(6);

$pdf->Cell(30, 11, utf8_decode($mess.' '.$anio),0, 'L');
$pdf->Ln(11);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(10, 11, utf8_decode('#'), 1, 'R');
$pdf->Cell(170, 11, utf8_decode('CIRUGÍA'), 1, 'L');
$pdf->SetFont('Arial', 'B', 7);
$pdf->Cell(14, 11, utf8_decode('CANTIDAD'), 1, 'C');
$pdf->Ln(11);
$pdf->SetFont('Arial', '', 7);
$sql_tabla = "SELECT diag_postop, COUNT(diag_postop) as cuantos FROM `dat_not_inquir`
 ...
 while ($row_tabla = $result_tabla->fetch_assoc()) {
      ...
      $pdf->Cell(170, 11, utf8_decode($row_tabla['diag_postop']), 1, 'L');
      $pdf->SetFont('Arial', '', 8);
      $pdf->Cell(14, 11, utf8_decode($row_tabla['cuantos']), 1, 'C');
      $pdf->Ln(11);
      $no++;
    }

...
<body>
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      <div class="thead">
     <h3><center><font id="letra"> GRÁFICA DE LAS 15 PRINCIPALES CIRUGIAS REALIZADAS EN EL AÑO <?php echo $anio ?></font></h3></center>
   </div>
    </div>
    <div class="col-sm">
...
$cuantos = '';
 ...
 WHERE YEAR(fecha)=$anio GROUP BY 1 HAVING COUNT(diag_postop)>=1 ORDER BY cuantos DESC limit 15";
...
<font size="5" color="white">TOTAL DE CIRUGIAS EN EL AÑO: <strong> <?php echo $sum?></strong></font>
</span></h5>
  </div>
</div>  
    </div>

    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <a href="#">
                        <i class="fa fa-user-friends"></i> <span>MENÚ GERENTE GENERAL</span><i class="fa fa-angle-left pull-right"></i>
                </a>
                <li class="active treeview">
                        <li><a href="../template/menu_administrativo.php"><i class="fa fa-folder"></i> ADMINISTRATIVO</a></li>
                        <li><a href="../template/menu_administrativo.php"><i class="fa fa-folder"></i> SERVICIOS AUXILIARES</a></li>

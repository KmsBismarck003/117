       ...
       <br>
            ...
            while ($row_datos = $result->fetch_assoc()) {
              ...
              <div class="form-group">
                  ...
                  <a href="cambio_de_cama.php" class="btn btn-danger">CANCELAR</a>
              </div>
              </form>
          </div>
          <div class="col-md-2"></div>
...
$fecha_actual = date("Y-m-d H:i:s");
 ...
 if ($hab_new != $hab) {// comparar si la nueva habitacion es igual a la habitacion anterior
  if ($cama >= 101 && $cama <= 209) { //camas standar, se cambia de cama y se agrega a la cuenta

// nueva fecha_cama
$sql_dia_hab = "UPDATE dat_ingreso SET fecha_cama='$fecha_actual' WHERE id_atencion = $id_atencion";// nueva fecha_cama
$result_dia_hab = $conexion->query($sql_dia_hab);

// insertar nueva cuenta con el tipo de servicio standar=1
$sql2 = "INSERT INTO dat_ctapac(id_atencion,prod_serv,insumo,cta_fec,cta_cant, cta_tot, id_usua, cta_activo)VALUES($id_atencion,'S',1,'$fecha_actual',1,0,$id_usua,'SI')"; 
...
$result = $conexion->query($sql2);
     }elseif ($cama >= 301 && $cama <= 303) {
   // nueva fecha_cama
$sql_dia_hab = "UPDATE dat_ingreso SET fecha_cama='$fecha_actual' WHERE id_atencion = $id_atencion";// nueva fecha_cama
$result_dia_hab = $conexion->query($sql_dia_hab);

// insertar nueva cuenta con el tipo de servicio suite=2
$sql2 = "INSERT INTO dat_ctapac(id_atencion,prod_serv,insumo,cta_fec,cta_cant, cta_tot, id_usua, cta_activo)VALUES($id_atencion,'S',2,'$fecha_actual',1,0,$id_usua,'SI')"; 
$result = $conexion->query($sql2);
...
$sql2 = "UPDATE cat_camas SET estatus = 'OCUPADA', id_atencion='$id_atencion' WHERE num_cama = $cama";
$result = $conexion->query($sql2);
 }elseif ($cama >= 401 && $cama <= 404) {
   // nueva fecha_cama
$sql_dia_hab = "UPDATE dat_ingreso SET fecha_cama='$fecha_actual' WHERE id_atencion = $id_atencion";// nueva fecha_cama
$result_dia_hab = $conexion->query($sql_dia_hab);

// insertar nueva cuenta con el tipo de servicio uci=3
$sql2 = "INSERT INTO dat_ctapac(id_atencion,prod_serv,insumo,cta_fec,cta_cant, cta_tot, id_usua, cta_activo)VALUES($id_atencion,'S',3,'$fecha_actual',1,0,$id_usua,'SI')"; 
$result = $conexion->query($sql2);
...
$sql2 = "UPDATE cat_camas SET estatus = 'OCUPADA', id_atencion='$id_atencion' WHERE num_cama = $cama";
$result = $conexion->query($sql2);
 }elseif ($cama >= 405 && $cama <= 407) {
   // nueva fecha_cama
$sql_dia_hab = "UPDATE dat_ingreso SET fecha_cama='$fecha_actual' WHERE id_atencion = $id_atencion";// nueva fecha_cama
$result_dia_hab = $conexion->query($sql_dia_hab);

// insertar nueva cuenta con el tipo de servicio ucin=4
$sql2 = "INSERT INTO dat_ctapac(id_atencion,prod_serv,insumo,cta_fec,cta_cant, cta_tot, id_usua, cta_activo)VALUES($id_atencion,'S',4,'$fecha_actual',1,0,$id_usua,'SI')"; 
$result = $conexion->query($sql2);
...
$sql2 = "UPDATE cat_camas SET estatus = 'OCUPADA', id_atencion='$id_atencion' WHERE num_cama = $cama";
$result = $conexion->query($sql2);
 }elseif ($cama >= 501 && $cama <= 503) {
   // nueva fecha_cama
$sql_dia_hab = "UPDATE dat_ingreso SET fecha_cama='$fecha_actual' WHERE id_atencion = $id_atencion";// nueva fecha_cama
$result_dia_hab = $conexion->query($sql_dia_hab);

// insertar nueva cuenta con el tipo de servicio urgencias=8
$sql2 = "INSERT INTO dat_ctapac(id_atencion,prod_serv,insumo,cta_fec,cta_cant, cta_tot, id_usua, cta_activo)VALUES($id_atencion,'S',8,'$fecha_actual',1,0,$id_usua,'SI')"; 
$result = $conexion->query($sql2);
...
$result = $conexion->query($sql2);
  ...
  $sql2 = "UPDATE cat_camas SET estatus = 'LIBRE', id_atencion=0 WHERE num_cama= $id";
          ...
          echo '<script type="text/javascript">window.location.href = "cambio_de_cama.php";</script>';
        }
        ?>
      </div>
    </div>

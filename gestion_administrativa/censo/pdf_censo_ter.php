...
$pdf->setX(15);
$pdf->Cell(260, 6, utf8_decode('CENSO DIARIO Y REPORTE DE VIGILANCIA EPIDEMIOLÓGICA - TERAPIA INTENSIVA'), 0, 0, 'C');
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->setX(10);
$pdf->MultiCell(276, 5, utf8_decode('CENSO DE UCIN'), 0, 'L');

...
include '../../conexionbd.php';
  ...
  function Footer()
  {
    ...
    $this->Cell(0, 10, utf8_decode('MAC-12.02'), 0, 1, 'R');
  }
}
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(94, 5.5, utf8_decode($papell . ' ' . $sapell . ' ' . $nom_pac) , 'B', 'C');
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(20, 6, 'Expediente: ', 0, 'L');

$pdf->SetFont('Arial', '', 8);
$pdf->Cell(10.5, 5.5, utf8_decode($folio), 'B', 1, 'C');
...
$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(17, 5, utf8_decode('Domicilio (calle, número, colona, localidad, municipio, estado: '), 0,1, 'L');
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(192, 5, utf8_decode($dir. ' ' .$loc . ', ' .$nom_mun . ', Estado de ' . $nom_es), 'B', 'L');
$pdf->SetFont('Arial', '', 8);
...
$pdf->Cell(120, 6, utf8_decode($tipo_a), 'B', 'L');
...
$pdf->Cell(159, 6, utf8_decode($motivo_atn), 'B', 'L');

$pdf->Ln(8);
$pdf->MultiCell(191, 6, utf8_decode('Estudios de laboratorio, gabinete e histopatológicos: Los indicados previamente por su médico tratante, tales como: biometria hematica, quimica sanguínea, electrolitos séricos, tiempos de coagulación, electrocardiograma, radiografia y/o tomografia'), 0, 'J');

$pdf->MultiCell(191, 6, utf8_decode('Actos anestésicos: Los necesarios, previamente indicado por su médico tratante.'), 0, 'J');
$pdf->Ln(1);
$pdf->MultiCell(191, 6, utf8_decode('Tratamiento(s) médico(s): Los indicados previamente por su médico tratante, tales como: soluciones parenterales, medicamentos intravenosos, colocación de sonda urinaria, sonda nasogástrica,etc..'), 0, 'J');

$pdf->MultiCell(191, 6, utf8_decode('Tratamiento(s) quirúrgico(s): El indicado por el médico tratante'), 0, 'J');
$pdf->MultiCell(191, 6, utf8_decode('Riesgos y complicaciones: Los propios del padecimiento y/o procedimiento, tales como: infección, hemorragia, reacción alergica, sepsis, choque e incluso la muerte.'), 0, 'J');
$pdf->Ln(1);
...
Tengo la plena libertad de evocar la autorización de los estudios y tratamientos en cualquier momento, antes de realizarse.
...
$pdf->SetX(110);
$pdf->Cell(90, 6, utf8_decode($user_pre . ' ' . $user_papell), 'B', 1, 'C');
$pdf->SetX(109);

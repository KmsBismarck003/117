...
$pdf->SetFont('Arial', '', 11);
$pdf->MultiCell(195, 8, utf8_decode('OTORGO MI CONSENTIMIENTO EXPRESO a efecto de que INEO Metepec, recabe, almacene, proteja y trate mis datos personales, que son necesarios para brindarme una atención médica.'), 0, 'J');

$pdf->Ln(2);
$pdf->MultiCell(195, 8, utf8_decode('Para tales efectos, manifiesto que tengo pleno conocimiento del contenido del Aviso de Privacidad Integral relativo al tratamiento de mis datos personales, el cual también es público y consultable a través del portal de internet https://medicasanisidro.com/privacidad y que me encuentro plenamente informado del nombre, domicilio y teléfono del Responsable del tratamiento de mis datos personales; del fundamento legal que lo faculta para llevarlo a cabo; de los datos personales que serán recabados, según sea el caso; de la finalidad de su tratamiento; del ciclo de vida de los mismos; de los mecanismos, medios y procedimientos disponibles para ejercer mis derechos de Acceso, Rectificación, Cancelación y Oposición (derechos ARCO). Asimismo, en este acto manifiesto que me encuentro informado que derivado de la atención médica se requieren estudios de diagnóstico y tratamiento que se me realicen; y documentos que integren mi expediente. Finalmente, de manera voluntaria, libre y expedita SI otorgo mi consentimiento para que, por razones de control de calidad y transparencia, la atención médica que en su caso me realice INEO Metepec con motivo de mejorar mi estado de salud, puedan ser registradas en medios electrónicos e impresos, quedando bajo su más estricto resguardo y protección en un Expediente Clínico, los cuales estarán almacenados durante el tiempo que establece la Ley para tal efecto, en términos de las disposiciones jurídicas aplicables en materia de Protección de Datos Personales y de Normas oficiales Mexicanas.'), 0, 'J');

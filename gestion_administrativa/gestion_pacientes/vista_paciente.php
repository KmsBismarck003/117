...
while ($row1 = mysqli_fetch_array($resultado)) {
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $row1['folio'] ?>" name="folio" placeholder="FOLIO" id="folio" class="form-control"
                               disabled>
                    </div>
                    <div class="form-group">
<!--                        <label for="Id_exp">EXPEDIENTE:</label>-->
                        <input type="hidden" value="<?php echo $row1['Id_exp'] ?>" name="Id_exp" placeholder="Expediente" id="Id_exp" class="form-control"
                               disabled>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="papell" placeholder="APELLIDO PATERNO" id="papell"
                                   class="form-control" style="text-transform:uppercase;" value="<?php echo $row1['papell']?>"
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="sapell" placeholder="APELLIDO MATERNO" id="sapell"
                                   class="form-control" style="text-transform:uppercase;" value="<?php echo $row1['sapell']?>"
                                   onkeypress="return SoloLetras(event);" maxlength="50"
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nom_pac" placeholder="NOMBRES(s)" id="nom_pac" class="form-control"
                                   style="text-transform:uppercase;" value="<?php echo $row1['nom_pac']?>" onkeypress="return SoloLetras(event);"
                                   maxlength="50" onkeyup="javascript:this.value=this.value.toUpperCase();" required disabled>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
        ...
        <div class="col-sm-4">
                            <div class="form-group">
                               ...
                               <input type="text" name="loc" placeholder="Localidad" id="loc" class="form-control" required style="text-transform:uppercase;" value="<?php echo $row1['loc'] ?>" onkeypress="return SoloLetras(event);" maxlength="50" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled>
                            </div>
                        </div>
    </div>
                <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="tel_resp" placeholder="Teléfono 10 digitos" id="tel_resp" value="<?php echo $row1['tel_resp'] ?>" 
                                       class="form-control" onkeypress="return SoloNumeros(event);" required disabled>
                            </div>
 ...
 ORDER by id_atencion DESC LIMIT 1") or die($conexion->error);
        while ($row2=mysqli_fetch_array($resultado1)) {
                                ...
                                <select name="id_usua"class="form-control" required disabled=""> 
                                         <option value=""><?php echo $row2['nombre']?> <?php echo $row2['papell']?> <?php echo $row2['sapell']?></option>
                                  </select>
                                </div>
                              </div>
                    ...
                    <div class="row">
                              <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="motivo_atn" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $row2['motivo_atn']?>" placeholder="Diagnostico" required disabled > 
                            ...
                            <div class="col-sm-5">
                              <div class="form-group">
                                ...
                                <input type="text" name="especialidad" value="<?php echo $row2['especialidad']?>" class="form-control" placeholder="Tratamiento Médico" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"  required disabled>
                              </div>
                            </div>
                            <div class="col-sm-5">
                              <div class="form-group">
                                <label for="alergias"> ALERGIAS:</label>
                                <input type="text" name="alergias" value="<?php echo $row2['alergias']?>" class="form-control" disabled style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"  placeholder="Alergias" required>
                              </div>
                            </div>
                            <?php } ?>
                            <div class="col-sm-5">
 ...
 ORDER by id_atencion DESC LIMIT 1") or die($conexion->error);
                             ...
                             <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="deposito" placeholder="Dep. inicial" id="deposito"
                                           value="<?php echo '$'.number_format($row3['deposito'],2)?>" maxlength="13" minlength="1"  required
                                           class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-sm-5">
   ...
   if(mysqli_num_rows($res_dat) > 0 ){ //se mostrara si existe mas de 1
          ...
          $id_exp=$fila[0];
                    ...
                    ?>
                    <a href="../cartas_consentimientos/consent_lis_pac.php?Id_exp=<?php echo $id_exp; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><font id="letra"> VISUALIZAR DOCUMENTOS</font></button>
                </div>
                <div class="col-sm-4">

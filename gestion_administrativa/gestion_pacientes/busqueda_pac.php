...
<div class="row"><hr>
  <div class="col"><h2 class="h5"><font color="black">Resultados de búsqueda de expediente del paciente:</font><br> <font color="#407959"><?php echo $_GET['texto'];?></font></h2><!-- Imprimos el texto que escribimos en el buscador--></div>

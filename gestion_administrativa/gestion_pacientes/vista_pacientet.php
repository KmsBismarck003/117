...
while ($row1 = mysqli_fetch_array($resultado)) {
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $row1['Id_exp'] ?>" name="folio" placeholder="FOLIO" id="folio" class="form-control"
                               disabled>
                    </div>
                    <div class="form-group">
<!--                        <label for="Id_exp">Expediente:</label>-->
        ...
        <div class="col-sm-4">
                            <div class="form-group">
                               ...
                               <input type="text" name="loc" placeholder="Localidad" id="loc" class="form-control" required  value="<?php echo $row1['loc'] ?>" onkeypress="return SoloLetras(event);" maxlength="50" disabled>
                            </div>
                        </div>
    </div>
                <div class="row">
 ...
 <div class="col-sm-5">
                              ...
                              <div class="col-sm-5">
                                ...
                                <select id="cama" name="habitacion" class="form-control" enabled="" required >
                                        ...
                                        <?php foreach ($resultado1 as $opciones):?>
                                         <option value="<?php echo $opciones['id']?>"><?php echo $opciones['num_cama']?> <?php echo $opciones['tipo']?></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                              <div class="form-group">
                                ...
                                <input type="text" placeholder="Alergias del paciente" name="alergias" class="form-control" onkeypress="return SoloLetras(event);" required >
                              </div>

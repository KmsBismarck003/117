      ...
      <div class="container">
        ...
        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-sm-4">
            <select class="selectpicker tipos" data-live-search="true" name="serv" id="serv"  onchange="mostrar(this.value);">
              <?php
         ...
         <div class="collapse div1" id="div1" style="display:;" >
                   <form class="form-horizontal" action="" method="post" enctype="multipart/form-data"><center> <h4> DESCRIBIR OTROS SERVICIOS </h4></center>
          <div class="row">
          <div class="col-md-6">
...
if ($precio == 0 ) {
  ...
  echo ' <td> <a href="editarcuenta.php?id='.$id_ctapac.'&des='.$descripcion.'&id_at='.$id_atencion.'&id_exp='.$id_exp.'&id_usua='.$usuario1.'&rol='.$rol.'" type="button" class="btn btn-info btn-sm"><font color="white"><span class = "fa fa-edit"></span></font></a></td>';
              ...
              <td>Total</td>
              <td></td>
              <td><?php echo number_format($Stotiva, 2); ?></td>

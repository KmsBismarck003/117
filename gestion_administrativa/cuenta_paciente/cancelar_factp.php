...
if (isset($_GET['id'])) {
    ...
    ?>
            ...
            <br><a href="facturas.php?id_atencion=<?php echo $id_at ?>"><button type="submit" class="btn btn-success">Regresar</button></a>
...
$sql_dat_ingca = "SELECT * from comprobantes where id_atencion = $id_at and id_comp=$id";
...
$to="facturacion@medicasanisidro.com"; 
...
$message.='<html><body>
    <h4 style="color:black;">Se ha cancelado una factura desde "Médica San isidro".</h4>
            <h6 style="color:black;">La factura cancelada es del paciente: '.$nopac.' por el siguiente motivo: '.$motivo.'</h6>';
$message.='<h6 style="color:black;">Folio fiscal: '.$uuid.'</h6>
...
//  echo "No se pudo enviar el email";
 ...
 echo '<script type="text/javascript">window.location.href ="facturas.php?id_atencion='.$id_at.'&nopac='.$nopac.'" ;</script>';
}

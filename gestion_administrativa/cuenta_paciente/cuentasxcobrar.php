...
<form action="pdf_cxc.php" target="_blank" method="POST">
    <div class="container box">
        <h5><strong>REPORTE DE CUENTAS POR COBRAR POR RANGO DE FECHAS</strong></h5><hr>
       <div class="row">
            <div class="container">
                <div class="row">
                    <div class="col-sm-2">
                    ...
                    <!--<div class="col-sm-1">
                        <a href="excel.php"><button type="button" class="btn btn-warning"><img src="https://img.icons8.com/color/48/000000/ms-excel.png"/></a>
                    </div>-->
                </div>
            </div>
        </div>

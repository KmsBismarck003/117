      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="#">
              <i class="fa fa-donate"></i> <span><font size ="2">FACTURACIÓN</font></span>
              <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <!--<li><a href="../cuenta_paciente/facturacion.php" ><i class="fa fa-donate"></i> <font size ="2">NUEVA FACTURA</font></a></li>-->
              <li><a href="../cuenta_paciente/facturas_global.php"><i class="fa fa-file-invoice-dollar"></i><font size ="2"> MIS FACTURAS</font></a></li>
            </ul>
          </li>
<li class="treeview">
            <a href="#">
              <i class="fa fa-donate"></i> <span><font size ="2">CATÁLOGOS</font></span>
              <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <li><a href="../cuenta_paciente/cat_productos.php"><i class="fa fa-donate"></i> <font size ="2">PRODUCTOS</font></a></li>
              <li><a href="../cuenta_paciente/cat_clientes.php"><i class="fa fa-file-invoice-dollar"></i><font size ="2"> CLIENTES</font></a></li>
              <li><a href="../presupuesto/presupuesto.php"><i class="fa fa-file-invoice-dollar"></i><font size ="2"> IMPUESTOS</font></a></li>
            </ul>
          </li>

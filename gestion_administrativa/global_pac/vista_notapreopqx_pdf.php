            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_preop=$f['id_not_preop'];
                    ...
                    <tr>
                        <td><a href="../../gestion_medica/quirurgico/pdf_nota_preoperatoriaqx.php?id_not_preop=<?php echo $id_not_preop; ?>&id_exp=<?php echo $id_exp ?>&id=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

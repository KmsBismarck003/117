            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_unid_cuid=$f['id_unid_cuid'];
                    ...
                    <tr>
                        <td><a href="../../gestion_medica/pdf/pdf_nota_recup.php?id_unid_cuid=<?php echo $id_unid_cuid; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

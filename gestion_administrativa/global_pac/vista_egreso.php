...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
              ...
              $id_atencion=$f['id_atencion'];
                    ...
                    <tr>
                        <td><a href="../../gestion_medica/pdf/pdf_egreso.php?id_in=<?php echo $id_egreso; ?>&id_exp=<?php echo $id_exp?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

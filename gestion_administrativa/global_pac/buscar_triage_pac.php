...
//include "../../conexionbd.php";
   /* if (isset($_SESSION['hospital'])) {
    ...
    }else if(isset($_GET['id_atencion']) and isset($_GET['id_exp'])) {
...
<body>
  <div class="container">
  <a class="btn btn-danger btn-sm" onclick="window.history.back();">Regresar...</a>
...
<div class="container-fluid">
     <div class="row">
         <div class="col col-12">
            ...
            include "../../conexionbd.php";
$resultado = $conexion->query("SELECT * from triage WHERE id_atencion=$id_atencion ORDER BY id_triage DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_triage=$f['id_triage'];
 while($f4 = mysqli_fetch_array($resultador)){
                  $id_rec_urgen=$f4['id_rec_urgen'];
                    ?>

                    <tr>
<td><a type="submit" class="btn btn-danger btn-sm" href="../../gestion_medica/urgencias/pdf_triage.php?tri=<?php echo $f['id_triage']?>&id=<?php echo $f['id_atencion'];?>&id_med=<?php echo $f['id_usua'] ?>&rec=<?php echo $id_rec_urgen ?>"target="_blank"><span class="fa fa-file-pdf-o"style="font-size:28px"></span></a></td>
                        
                        
                        <td><strong><?php $date=date_create($f['fecha_t']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_t']); echo date_format($date,"H:i") .' horas';?></strong></td>
                    </tr>
                    <?php
                }
}

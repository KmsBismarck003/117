...
include "../../conexionbd.php";
$resultado = $conexion->query("SELECT * from resumen_clinico WHERE id_atencion=$id_atencion ORDER BY id_resum DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_resum=$f['id_resum'];
                    ...
                    ?>
                    <tr>
                        <td><a href="../../gestion_medica/pdf/pdf_resum_clin.php?id_in=<?php echo $id_resum; ?>&id_exp=<?php echo $id_exp?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

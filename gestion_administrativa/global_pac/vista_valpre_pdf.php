...
-->
  ...
  <title>VALORACIÓN PRE-ANESTESICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_peranest=$f['id_peranest'];
                    ...
                    <tr>
                        <td><a href="../../gestion_medica/pdf/pdf_pre_anestesica.php?id_peranest=<?php echo $id_peranest; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

...
-->
  ...
  <title>NOTA POST-ANESTÉSICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_post_anest=$f['id_post_anest'];
                    ...
                    <tr>
                        <td><a href="../../gestion_medica/pdf/pdf_postanestesica.php?id_post_anest=<?php echo $id_post_anest; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        ...
                        <td><strong><?php $date=date_create($f['hora_pos']); echo date_format($date,"h:i");?></strong></td>
                    </tr>
                    <?php
                }
                ?>

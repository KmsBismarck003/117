...
<section class="content container-fluid">
    ...
    <div class="row">
        ...
        ?>
         ...
         <tr><strong><center>PRODUCTOS CON FECHA DE CADUCIDAD MENOR A 90 DÍAS</center></strong>
      </div><br>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    <tr>
                        ...
                        <th><font color="white">Precio venta</th>
...
$sql = " SELECT * FROM item_almacen, stock_almacen, item_type where 
    ...
    item_almacen.item_id = stock_almacen.item_id and stock_qty != 0";
...
while ($row = $result->fetch_assoc()) {
  ...
  $contador = $date1 -> diff($caduca);
                        ...
                        if ($contador->days.'days' < 90){
                            echo '<tr>'
                                . '<td>' . utf8_decode($item_id) . '</td>'
                                . '<td>' . $row['item_name'] .', ' . $row['item_grams'] . '</td>'
                                . '<td>$' . number_format($row['item_price'],2) . '</td>'
                                . '<td>' . $row['stock_qty'] . '</td>'
                                . '<td>' . utf8_decode($lote) . '</td>'

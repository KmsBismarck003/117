    ...
    <div class="container box">
      <div class="content">
          ...
          if ($usuario1['id_rol'] == 4) {
              ...
              ?>
              <a type="submit" class="btn btn-primary btn-block" href="../../template/menu_farmacia.php">REGRESAR</a>
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <tbody>
              ...
              $resultado2 = $conexion->query("SELECT * from paciente p, dat_ingreso di, cart c, item i where di.id_atencion = c.paciente and di.Id_exp = p.Id_exp and di.id_atencion = $paciente1 and i.item_id = c.item_id ORDER BY c.cart_fecha ASC") or die($conexion->error);
              $no = 1;
              $total = 0;

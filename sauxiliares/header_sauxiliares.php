    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <a href="#">
                        <i class="fa fa-user-friends"></i> <span>SERVICIOS AUXILIARES</span><i class="fa fa-angle-left pull-right"></i>
                </a>
                <li class="active treeview">
                        <li><a href="../../template/menu_almacencentral.php"><i class="fa fa-folder">
                        </i> ALMACEN CENTRAL</a></li>
                        <li><a href="../../template/menu_farmacia.php"><i class="fa fa-folder">
                        </i> FARMACIA</a></li>
                        <li><a href="../../template/menu_ceye.php"><i class="fa fa-folder">
                        </i> CEYE</a></li>
                </li>                  
            </ul>
        </section>

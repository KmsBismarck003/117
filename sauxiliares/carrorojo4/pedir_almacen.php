        ...
        <div class="col-sm-4">
          <label>Materiales</label>
            <select name="item_id" class="form-control" data-live-search="true" id="mibuscador" style="width : 100%; heigth : 100%">
                  ...
                  $sql = "SELECT * FROM material_rojo1" ;
           ...
           <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                ...
                $resultado2 = $conexion_almacen->query("SELECT * from cart_recib c, item_almacen i where i.item_id = c.item_id and c.confirma='NO' AND c.almacen='CARRO ROJO1'") or die($conexion_almacen->error);
                $no = 1;

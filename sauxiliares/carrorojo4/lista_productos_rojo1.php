    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="insertar_material_rojo1.php" method="POST" enctype="multipart/form-data">
...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <a href="excelrojo1.php"><button type="button" class="btn btn-warning"><img src="https://img.icons8.com/color/48/000000/ms-excel.png"/><strong>EXPORTAR A EXCEL</strong></button></a>
        </div>
    </div>
</div>
<?php } ?>

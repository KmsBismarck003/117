...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
         <a type="submit" class="btn btn-danger" href="../../template/menu_ceye.php">Regresar</a>   
        </div>
    </div>
</div>
...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
         <tr><strong><center>INVENTARIO CEYE</center></strong>
      ...
      <div class="col  col-12">
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            <center>
              <button type="button" class="btn btn-primary col-md-" data-toggle="modal" data-target="#exampleModalistock"><i class="fa fa-plus"></i>
    ...
    <!-- Modal Insertar -->
    <div class="modal fade" id="exampleModalistock" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <!-- FORM -->
            <form action="insertar_inventario_ceye.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="control-label col-sm-3" for="">Stock máximo:</label>
                <div class="col-sm-9">
                  <input type="number" min="0" class="form-control" name="stock_max" placeholder="Ingresa la cantidad" required="">
                </div>
              </div>
            ...
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <thead class="thead" style="background-color: #2b2d7f;color:white;">
                <tr>
                  ...
                  <th><font color="white">Entrada productos</th>
                </tr>
              </thead>
              <tbody>
                <?php
                // $sql = "SELECT id_usua, curp_u, nombre, papell,sapell,fecha,mat,cedp,cargp,email,u_activo FROM reg_usuarios;";
                //  $result = $conn->query($sql);
                $resultado2 = $conexion->query("SELECT * FROM material_ceye, stock_ceye, item_type where  item_type.item_type_id=material_ceye.material_tipo and material_ceye.material_id = stock_ceye.material_id and stock_ceye.stock_qty > 0") or die($conexion->error);
                $no = 1;
                while ($row = $resultado2->fetch_assoc()) {
                  ...
                  echo '<tr>'
                    ...
                    . '<td> <a href="edit_stock_ceye.php?id=' . $row['stock_id'] . '" title="Editar datos" class="btn btn-warning btn-sm "><span class="fa fa-edit" aria-hidden="true"></span></a></td>';
                  echo '</tr>';
                  $no++;
                }
                ?>

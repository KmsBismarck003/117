        ...
        <div class="container box">
            <div class="content">
                ...
                <div class="thead" style="background-color: #0c675e; color: white; font-size: 20px;">
                    <strong>
                        <center>SALIDAS DE MEDICAMENTOS E INSUMOS POR FECHA</center>
                    </strong>
                </div><br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-4">
                            <a type="submit" class="btn btn-danger" href="./salidash.php">Regresar</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="mytable">
                        <thead class="thead" style="background-color: #0c675e; color:white;">
                            <tr>
                                <th>
                                    <font color="white">FECHA SOLICITUD
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            $resultado2 = $conexion->query("SELECT distinct(date(s.fecha_solicitud)) AS fecha_solicitud 
                                FROM salidas_almacenh s 
                                WHERE s.id_atencion = $id_atencion") or die($conexion->error);

                            $no = 1;
                            $total = 0;
                            while ($row = $resultado2->fetch_assoc()) {
                                echo '<tr>'
                                    . '<td><a type="submit" class="btn btn-danger btn-sm" href="salidas_vista.php?id_atencion=' . $id_atencion . '&fecha=' . $row['fecha_solicitud'] . '">' . $row['fecha_solicitud'] . '</a></td>';
                                echo '</tr>';
                                $no++;
                            }
                            ?>

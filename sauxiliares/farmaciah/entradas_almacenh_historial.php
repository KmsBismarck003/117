...
<head>
    ...
    <title>Resurtimiento - Farmacia Hospitalaria</title>
            ...
            <div class="header-principal">
                <div class="contenido-header">
                    <div class="icono-header">
                        <i class="fas fa-arrow-down icono-principal"></i>
                    </div>
                    <h1>RESURTIMIENTO - FARMACIA HOSPITALARIA</h1>
                </div>
            </div>
                ...
                <form method="POST" action="">
                    <div class="form-row align-items-end">
                        ...
                        <div class="form-group col-md-3 d-flex align-items-end">
                            ...
                            <a href="entradas_almacenh_historial.php" class="btn-moderno btn-borrar w-100">
            ...
            <?php if ($resultado->num_rows > 0): ?>
                ...
                <div class="contenedor-paginacion">
                    <div class="paginacion-moderna">
                        ...
                        if ($pagina > 1) {
                            echo "<a href='?pagina=1$query_params' class='btn-paginacion'><i class='fas fa-angle-double-left'></i></a>";
                        }
                        ...
                        if ($pagina < $total_paginas) {
                            echo "<a href='?pagina=$total_paginas$query_params' class='btn-paginacion'><i class='fas fa-angle-double-right'></i></a>";
                        }
                        ?>
                    </div>
                </div>

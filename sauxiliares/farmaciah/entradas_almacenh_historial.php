...
<body>
    <a href='kardexh.php' class="btn btn-danger" style="margin-left: 10px; margin-bottom: 5px;">Regresar</a>
        ...
        <div class="content">
            <div class="thead" style="background-color: white;margin-top: 10px; color: black; font-size: 20px;">
                <div class="thead" style="background-color: #0c675e; margin: 5px auto; padding: 5px; color: white; width: fit-content; text-align: center; border-radius: 5px;">
                    <h1 style="font-size: 26px; margin: 0; color: white;">RESURTIMIENTO</h1>
                </div>
            </div>
             ...
             <form method="POST" action="">
                    <div class="form-row align-items-end">
                        ...
                        <div class="form-group col-md-3 d-flex align-items-end">
                            ...
                            <a href="entradas_almacenh_historial.php" class="btn btn-danger w-100">Borrar Filtros</a>
                        </div>
                    </div>

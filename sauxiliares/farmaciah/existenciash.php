...
if ($usuario['id_rol'] == 7 || $usuario['id_rol'] == 4 || $usuario['id_rol'] == 5 || $usuario['id_rol'] == 1) {
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 d-flex justify-content-center">
          <a type="submit" class="btn btn-danger mx-2" href="../../template/menu_farmaciahosp.php">Regresar</a>
          <a type="submit" class="btn btn-warning mx-2" href="existencias_globalh.php">Existencias Globales</a>
          <a href="excelexistenciash.php" class="btn btn-success mx-2">Exportar a Excel</a>
        </div>
      </div>
    </div>

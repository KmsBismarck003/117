...
// Obtener información del paciente y su Id_exp (clave del paciente)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $query = "INSERT INTO trat_farma (
    id_atencion, medicamento, principio_activo, dosis, intervalo, horario, via_administracion, lote, caducidad, ultima_dosis, continuidad
) VALUES (
    '$id_atencion', '$medicamento', 'NO APLICA', '$dosis', '$intervalo', '$horario', '$via_administracion', 'NO APLICA', '0000-00-00', '$ultima_dosis', '$continuidad'
)";

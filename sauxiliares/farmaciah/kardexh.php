...
<body>
    <section class="content container-fluid" style="padding: 10px;">
        <a href="../../template/menu_farmaciahosp.php" class="btn btn-danger" style="margin-left: 10px; margin-bottom: 10px;">Regresar</a>
                ...
                <form method="POST" action="">
                    <div class="form-row align-items-end">
                        ...
                        <div class="form-group col-md-3 d-flex align-items-end">
                            ...
                            <a href="kardexh.php" class="btn btn-danger w-100">Borrar Filtros</a>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col text-center">
                            <a href="entradas_almacenh_historial.php" class="btn btn-success mr-2 custom-btn">RESURTIMIENTO</a>
                            <a href="salidas_almacenh_historial.php" class="btn btn-success mr-2 custom-btn">SALIDAS</a>

                            <a href="devoluciones_almacenh_historial.php" class="btn btn-success mr-2 custom-btn">DEVOLUCIONES</a>
                            <a href="mermas_almacenh_historial.php" class="btn btn-success mr-2 custom-btn">MERMAS</a>

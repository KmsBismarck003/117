...
<body>
    <section class="content container-fluid" style="padding: 10px;">
        <a href="kardexh.php" class="btn btn-danger" style="margin-left: 10px; margin-bottom: 10px;">Regresar</a>
        ...
        <div class="container box">
            <div class="content">
                <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 10px; position: relative;">
                    ...
                    <a href="salidasPorAjusteh.php" class="btn btn-primary" style="position: absolute; right: 0;">Salidas por Ajuste</a>
                </div>
                ...
                <form method="POST" action="">
                    <div class="form-row align-items-end">
                        ...
                        <div class="form-group col-md-3 d-flex align-items-end">
                            ...
                            <a href="salidas_almacenh_historial.php" class="btn btn-danger w-100">Borrar Filtros</a>
                        </div>
                    </div>

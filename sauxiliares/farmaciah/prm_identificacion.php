...
<body>
    <div class="container">
        ...
        <div class="container mt-4">
            <div class="card">
                <div class="card-header">
                    <h4>Registro de PRM (IDENTIFICACION)</h4>
                </div>
                <div class="card-body">
    ...
    <script>
        ...
        document.getElementById('situacion3').addEventListener('click', function() {
            document.getElementById('situacion_otro').style.display = 'block';
        });

        document.getElementById('causa4').addEventListener('click', function() {
            document.getElementById('causa_otro').style.display = 'block';
        });
        ...
        document.querySelectorAll('input[name="situacion"]').forEach(function(radio) {
            radio.addEventListener('click', function() {
                if (this.value !== 'Otro') {
                    document.getElementById('situacion_otro').style.display = 'none';
                }
            });
        });
        ...
        document.querySelectorAll('input[name="causa"]').forEach(function(radio) {
            radio.addEventListener('click', function() {
                if (this.value !== 'Otro') {
                    document.getElementById('causa_otro').style.display = 'none';
                }
            });
        });
    </script>

...
include("../header_sauxiliares.php");
...
if( isset($_GET['id_usua'])) { //si existe el id mandado por metodo GET, se hara la consulta donde el id debe ser igual al id mandado por el metodo GET
  ...
  if(mysqli_num_rows($resultado) > 0 ){ //se mostrara si existe mas de 1
    ...
    header("location: header_sauxiliares.php"); //te regresa a la página principal
  }
}else{
  header("location: header_sauxiliares.php"); //te regresa a la página principal
}
...
<hr>
    ...
    <center>
            ...
            <a href="../../template/menu_sauxiliares.php" class="btn btn-danger">CANCELAR</a>
    </center>
...
//firma.jpg
     ...
     // echo $sql2;
      // return 'hbgk';
        ...
        echo '<script type="text/javascript">window.location ="../../template/menu_sauxiliares.php"</script>';
      }
?>
 </div>

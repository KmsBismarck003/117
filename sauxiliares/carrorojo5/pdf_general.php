...
class PDF extends FPDF
{
  function Header()
  {
    ...
    $this->SetX(80);
    $this->Cell(145, 10, utf8_decode('EXISTENCIAS DE CARRO ROJO OBSERVACIÓN (DETALLE)'), 1, 0, 'C');
  ...
  function Footer()
  {
    ...
    $this->Cell(0, 10, utf8_decode('CMSI-43'), 0, 1, 'R');
  }
}
...
$sql = "SELECT * FROM material_rojo1 m, stock_rojo1 s, item_type i where i.item_type_id=m.material_tipo and m.material_id = s.item_id ";
...
while ($row = $result->fetch_assoc()) {
  ...
  $sql2 = " SELECT * FROM entradas_rojo1 where item_id = $item_id ORDER BY entrada_added ASC";
  ...
  $sql3 = "SELECT * FROM sales_rojo1 where item_id = '$item_id' ORDER BY date_sold ASC";
  ...
  $pdf->SetTextColor(43, 45, 127);  
  $sql4 = "SELECT * FROM devolucion_rojo1 where dev_producto = '$item_id' and dev_estatus = 'NO'

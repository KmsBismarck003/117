...
if (!($usuario1['id_rol'] == 11 || $usuario1['id_rol'] == 5 || $usuario1['id_rol'] == 4)) {
    session_unset();
    session_destroy();
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                        <a href="../editar_perfil/editar_perfil_alma.php?id_usua=<?php echo $usuario1['id_usua'];?>" class="btn btn-default btn-flat">MIS DATOS</a>
                                    </div>  
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class=" treeview">
                    <a href="../AlmacenC/lista_productos.php">
                        <i class="fa fa-folder"></i> <font size="2">CATÁLOGO DE PRODUCTOS</font>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>

                </li>
                <li class=" treeview">
                    <a href="../AlmacenC/entrada_almacen.php">
                        <i class="fa fa-folder"></i> <font size="2">ENTRADAS DE ALMACÉN</font>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                </li>
                
                <li class=" treeview">
                    <a href="../AlmacenC/surtir_almacen.php">
                        <i class="fa fa-folder"></i> <font size="2">SURTIR PEDIDOS</font>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                ...
                <li class=" treeview">
                    <a href="../AlmacenC/inventario.php">
                        <i class="fa fa-folder"></i> <font size="2">DETALLE DE INVENTARIO</font>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                ...
                <li class=" treeview">
                    <a href="../AlmacenC/caducado.php">
                        <i class="fa fa-folder"></i> <font size="2">REVISAR CADUCIDAD</font>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>

                </li>
                <li class=" treeview">
                    <a href="../AlmacenC/devoluciones.php">
                        <i class="fa fa-folder"></i> <font size="2">DEVOLUCIONES</font>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>

                </li>
                 <li class="treeview">
                    <a href="../AlmacenC/compras.php">
                        <i class="fa fa-folder"></i> <font size="2">COMPRAS</font>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>

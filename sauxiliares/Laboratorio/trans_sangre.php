...
<div class="thead" style="background-color: #2b2d7f ; color: white; font-size: 25px;">
         <tr><strong><center>SOLICITUDES DE BANCO DE SANGRE PENDIENTES</center></strong>
      </div><br>
        ...
        <div class="content box">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    $query = "SELECT * FROM notificaciones_sangre n, reg_usuarios u where n.realizado = 'NO' and n.id_usua = u.id_usua order by n.fecha_ord DESC ";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<tr>'
                            ...
                            . '<td class="fondosan" style="color:white;"><a style="color: white;">' . $sangre . '</a></td>'
                            . '<td class="fondosan" style="color:white;">' . $row['realizado'] . '</td>'
                            . '<td class="fondosan" style="color:white;">' . $row['det_sang'] . '</td>';
                        echo '<td class="fondosan" style="color:white;"><center>'
                            . ' <a href="subir_resultado_sangre.php?not_id=' . $row['not_id'] . '&id_atencion='.$row['id_atencion'].'" title="Editar datos" class="btn btn-success "><span class="fa fa-cloud-upload" aria-hidden="true"></span></a>';
                        echo '</center></td></tr>';
                        $no++;
                    }
                    ?>

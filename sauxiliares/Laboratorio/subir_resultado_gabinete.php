    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        for ($i = 0; $i < count($files['name']); $i++) {
            if ($files['error'][$i] === UPLOAD_ERR_OK) {
                ...
                $new_filename = "resultado_gabinete_{$not_id}_" . date('Ymd_His') . "_$i." . $file_ext;
...
<head>
    ...
    <title>Subir Resultado de Estudio de Gabinete</title>
</head>
<body>
<div class="container-fluid">
    <a href="sol_gabinete.php" class="btn btn-danger mb-3"><i class="fas fa-arrow-left"></i> Regresar</a>
    <h2><i class="fas fa-upload"></i> Subir Resultado de Estudio de Gabinete</h2>
    <?php if ($notificacion): ?>
        <div class="card mb-3">
            <div class="card-body">

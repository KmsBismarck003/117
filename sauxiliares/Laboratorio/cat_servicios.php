                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="number" step="0.01" min="0" name="costo2"  id="costo2" 
                               class="form-control"value="" required>
                    </div>
                    <div class="form-group">
                        <label for="costo3">Precio 3:</label>
                        <input type="number" step="0.01" min="0" name="costo3"  id="costo3" 
                               class="form-control"value="" required>
                    </div>
                    <div class="form-group">
                        <label for="costo4">Precio 4:</label>
                        <input type="number" step="0.01" min="0" name="costo4"  id="costo4" 
                               class="form-control"value="" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    <tr>
                        ...
                        <th>Clave</th>
                        <th>Nombre</th>
                        <th>Precio1 <br>(Part.)</th>
                        <th>Precio2 <br>(Axa)</th>
                        <th>Precio3 <br>(GNP)</th>
                        <th>Precio4 <br>(Otros)</th>
                        <th>U.M.</th>
                        <th>Tipo</th>
                        <th>Activo</th>
                    ...
                    if ($usuario['id_usua'] == 266 || $usuario['id_usua'] == 1) { ?>
                        <th>Edita</th>
                       <?php } ?>
                    </tr>
                    </thead>
                    ...
                    // $sql = "SELECT id_usua, curp_u, nombre, papell,sapell,fecha,mat,cedp,cargp,email,u_activo FROM reg_usuarios;";
                    //  $result = $conn->query($sql);
                    $resultado2 = $conexion->query("SELECT id_serv, serv_cve,serv_desc, serv_costo, serv_costo2, serv_costo3,serv_costo4, serv_umed,serv_activo,t.ser_type_desc as tipo FROM cat_servicios s, service_type t where s.tipo = t.ser_type_id and t.ser_type_desc='LABORATORIO' order by id_serv") or die($conexion->error);

                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    while ($row_pac = $result_pac->fetch_assoc()) {
                        ...
                        echo '<td class="fondo" style="color:white;"><center>'
                            . ' <a href="../Laboratorio/editar_pato.php?id_notp=' . $row['id_notp'] . '" title="Editar resultados" class="btn btn-danger "><span class="fa fa-edit" aria-hidden="true"></span></a>';

                        echo '<td class="fondo" style="color:white;"><center>'
                            . ' <a href="../Laboratorio/verpdfpato.php?id_notp=' . $row['id_notp'] . '" title="Ver resultados" class="btn btn-danger "><span class="fa fa-file-pdf-o" aria-hidden="true"></span></a>';
                        echo '</center></td>';
                        $no++;

...
<div class="thead" style="background-color: #2b2d7f ; color: white; font-size: 20px;">
         <tr><strong><center>PERFILES DE LABORATORIO</center></strong>
      </div><br>
    <div class="row">

        <div class="col  col-12">
            <hr>
            <a type="submit" class="btn btn-primary " href="insert_paquete_labo.php">NUEVO PERFIL</a>
        ...
        //    $resultado2 = $conexion->query("SELECT id_serv, serv_cve, serv_costo, serv_umed,serv_activo FROM cat_servicios") or die($conexion->error);
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    // $sql = "SELECT id_usua, curp_u, nombre, papell,sapell,fecha,mat,cedp,cargp,email,u_activo FROM reg_usuarios;";
                    //  $result = $conn->query($sql);
                    $resultado2 = $conexion->query("SELECT DISTINCT nombre FROM paquetes_labo") or die($conexion->error);
                    $no = 1;

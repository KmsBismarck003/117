        ...
        <div class="col  col-12">
            <h2>
                <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"
                                                                                              id="side"></i></a>
                <center><font id="letra"><i class="fa fa-plus-square"></i> Editar Resultados de Laboratorio</font>
            </h2>
            </center>
            <hr>
...
<div class="container">
  <div class="row">
    <div class="col-sm">
   <iframe src="resultados/<?php echo $row['resultado'] ?>" width="450px" height="400px"></iframe>
    </div>
    <div class="col-sm">
...
<center>
          <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <a href="../Laboratorio/resultados_labo.php" class="btn btn-danger">Cancelar</a>
...
//imagen1.jpg
    ...
    if($extension6=='jpg' || $extension6=='png' || $extension6=='dcm' ||$extension6=='jpeg' || $extension6=='pdf'){
        ...
        if(move_uploaded_file($_FILES['resultado']['tmp_name'], $carpeta6.$img6)){
            $fila6=$conexion->query("select resultado from notificaciones_labo where not_id = $id");
            $idd6=mysqli_fetch_row($fila6);
            if(file_exists('./resultados/'.$idd6[0])){
            unlink('./resultados/'.$idd6[0]);
                }
            $conexion->query("UPDATE notificaciones_labo SET resultado='$img6' where not_id = $id");
                }
            }//llave tipo archivo
        }    //llave si no esta vacio


                echo '<script type="text/javascript">window.location ="../Laboratorio/resultados_labo.php"</script>';

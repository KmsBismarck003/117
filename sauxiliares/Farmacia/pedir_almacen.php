        ...
        <div class="col-sm-4">
          <label>Medicamentos:</label>
            <select name="item_id" class="form-control" data-live-search="true" id="mibuscador" style="width : 100%; heigth : 100%">
                  <?php
                  include "../../conexionbd.php";
                  $sql = "SELECT * FROM item i, item_type where controlado = 'NO' AND item_type.item_type_id=i.item_type_id ";
           ...
           <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                ...
                $resultado2 = $conexion_almacen->query("SELECT * from cart_recib c, item_almacen i where i.item_id = c.item_id and c.confirma='NO' AND c.almacen='FARMACIA'") or die($conexion_almacen->error);
                $no = 1;
                while ($row_lista = $resultado2->fetch_assoc()) {
                  echo '<tr>'
                    . '<td>' . $no . '</td>'
                    . '<td>' . $row_lista['item_name'] .', ' . $row_lista['item_grams'] . '</td>'

...
if(isset($_POST['btnexcel']))
{
 //   header('Content-Type: application/xls; charset="UTF-8"');
    ...
    header('Content-Disposition: attachment; filename="salidas _farmacia.xls"');
?>
<head>
    ...
    <thead class="thead" style="background-color: #0c675e">
        <tr>
                    ...
                    <tbody>
                        <?php
                        include '../../conexionbd.php';
                        $resultado2 = $conexion->query("SELECT s.* from sales s WHERE (date_sold BETWEEN '$date1' and '$date2')") or die($conexion->error);

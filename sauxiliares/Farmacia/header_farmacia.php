    ...
    if (!($usuario1['id_rol'] == 7 || $usuario1['id_rol'] == 5 || $usuario1['id_rol'] == 1 || $usuario1['id_rol'] == 9 || $usuario1['id_rol'] == 3 || $usuario1['id_rol'] == 4)) {
        session_unset();
        session_destroy();
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <!-- <img src="dist/img/logo.jpg" alt="logo">-->
                ...
                <?php
                if ($usuario1['id_rol'] == 7) {
                ?>

                <a href="../../template/menu_farmacia.php" class="logo">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs"> <?php echo $usuario1['papell']; ?> <?php echo $usuario1['sapell']; ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        <?php echo $usuario1['papell']; ?> <?php echo $usuario1['sapell']; ?>
                                    </p>
                                </li>
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="../editar_perfil/editar_perfil_farma.php?id_usua=<?php echo $usuario1['id_usua'];?>" class="btn btn-default btn-flat">MIS DATOS</a>
                                    </div>  
            ...
            <section class="sidebar">
                ...
                <?php if ($usuario1['id_rol']==3) {?>
                    <ul class="sidebar-menu">
                        <li class="treeview">
                            <a href="../../template/menu_farmacia.php">
                                <i class="fa fa-folder"></i> <span>SALIDAS DE MEDICAMENTOS</span>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class=" treeview">
                     ...
                     <li class=" treeview">
                        <a href="../Farmacia/orderqx.php">
                            <i class="fa fa-folder"></i> <span>REGISTRAR MEDICAMENTOS <BR>QX / OBSERVACION</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>

                    </li>
                    <li class=" treeview">
                        <a href="../Farmacia/lista_productos.php">
                    ...
                    <li class=" treeview">
                        <a href="../Farmacia/inventario.php">
                    ...
                    <li class=" treeview">
                        <a href="../Farmacia/devoluciones.php">
                    ...
                    <li class="treeview">
                            <a href="../Farmacia/pedir_almacen.php">
                        ...
                        <li class="treeview">
                            <a href="../Farmacia/confirmar_envio.php">

...
if (!($usuario1['id_rol'] == 5 || $usuario1['id_rol'] == 8 || $usuario1['id_rol'] == 1 || $usuario1['id_rol'] == 3 || $usuario1['id_rol'] == 4 || $usuario1['id_rol'] == 12  || $usuario1['id_rol'] == 2)) {
    session_unset();
    session_destroy();
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <?php
        if ($usuario1['id_rol'] == 8) {
            ?>

            <a href="../../template/menu_ceye.php" class="logo">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="../editar_perfil/editar_perfil_ceye.php?id_usua=<?php echo $usuario1['id_usua'];?>" class="btn btn-default btn-flat">MIS DATOS</a>
                                </div> 
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class=" treeview">
                    <a href="../Ceye/lista_productos_ceye.php">
                        <font size="2">
                ...
                <li class=" treeview">
                    <a href="../Ceye/inventario_ceye.php">
                        <font size="2">
                ...
                <li class=" treeview">
                    <a href="../Ceye/devoluciones_ceye.php">
                        <font size="2">
                ...
                <li class="treeview">
                    <a href="../Ceye/confirmar_envio.php">
                        <font size="2">
                ...
                <li class="treeview">
                    <a href="../Ceye/lista_paquetes_ceye.php">
                       <font size="2">
        ...
        <?php } 
            ...
            <ul class="sidebar-menu">
                ...
                <li class=" treeview">
                        <a href="../Ceye/orderqx.php">
                        <font size="2">
                            <i class="fa fa-folder"></i> <span>REGISTRAR MATERIALES <br> Qx / OBSERVACION</span>
                        </font>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>

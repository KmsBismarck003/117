...
<div class="container-fluid">
    ...
    if ($usuario1['id_rol'] == 4) {
        ...
        ?>
        <a type="submit" class="btn btn-primary" href="../../template/menu_medico.php">Regresar</a>
        ...
        <div class="col  col-12">
            <h2>
                <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"
                                                                                              id="side"></i></a>
                <center><font id="letra"><i class="fa fa-plus-square"></i> Resultados de Patologia</font>
            </h2>
            </center>
            <hr>
    ...
    <div class="container box">
        <div class="content">
            <div class="col-md-10">
                ...
                $id = $_GET['id_notp'];
                //  echo $id;
                $file_doc = "SELECT id_notp, resultado FROM `notificaciones_pato` WHERE id_notp = $id";
              // echo $file_doc;

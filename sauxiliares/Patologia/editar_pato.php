...
<div class="container-fluid">
    ...
    if ($usuario1['id_rol'] == 4) {
        ...
        ?>
        <a type="submit" class="btn btn-primary" href="../../template/menu_patologia.php">Regresar</a>
...
<center>
          <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <a href="../Patologia/resultados_pato.php" class="btn btn-danger">Cancelar</a>
    ...
    if($extension6=='jpg' || $extension6=='png' || $extension6=='dcm' ||$extension6=='jpeg' || $extension6=='pdf'){
        ...
        if(move_uploaded_file($_FILES['resultado']['tmp_name'], $carpeta6.$img6)){
            ...
            $conexion->query("UPDATE notificaciones_pato SET resultado='$img6' where id_notp = $id");
                ...
                echo '<script type="text/javascript">window.location ="../Patologia/resultados_pato.php"</script>';

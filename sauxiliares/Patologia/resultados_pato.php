...
<div class="thead" style="background-color: #2b2d7f ; color: white; font-size: 25px;">
         <tr><strong><center>RESULTADOS DE ESTUDIOS DE PATOLOGÍA</center></strong>
      </div><br>
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    while ($row_pac = $result_pac->fetch_assoc()) {
                        ...
                        echo '<tr>'
                            ...
                            . '<td >' . $row['hora'] . '</td>'
                            . '<td >' . $medico . '</td>'
                            . '<td ><a style="color: black;"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> ' . $row['dispo_p'] . '</a></td>'
                            . '<td >' . $row['realizado'] . '</td>';

                        echo '<td class="fondo" style="color:white;"><center>'
                            . ' <a href="../Patologia/editar_pato.php?id_notp=' . $row['id_notp'] . '" title="Editar resultados" class="btn btn-danger "><span class="fa fa-edit" aria-hidden="true"></span></a>';

                        echo '<td class="fondo" style="color:white;"><center>'
                            . ' <a href="../Patologia/verpdf.php?id_notp=' . $row['id_notp'] . '" title="Ver resultados" class="btn btn-danger "><span class="fa fa-file-pdf-o" aria-hidden="true"></span></a>';
                        echo '</center></td>';
                        $no++;

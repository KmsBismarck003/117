          ...
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <tbody>
             ...
             echo'<tr><h4><strong>PACIENTE: '.$paciente.'</strong></h4></tr>';
              $resultado2 = $conexion->query("SELECT s.*,di.id_atencion,di.Id_exp,p.* from salidas_almacenh s, dat_ingreso di, paciente p where s.id_atencion=$id_atencion and date(s.fecha_solicitud)='$fecha' and s.id_atencion=di.id_atencion and di.Id_exp=p.Id_exp ") or die($conexion->error);
              $no = 1;
              $total = 0;
              while ($row = $resultado2->fetch_assoc()) {
                ...
                echo '<tr>'
                  ...
                  . '<td bgcolor="blue"><font color="white">' . $row['generic_name'] . '</td>'

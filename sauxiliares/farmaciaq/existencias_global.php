...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
           <a type="submit" class="btn btn-danger" href="existencias.php">Regresar</a> 
        </div>
    </div>
</div>
       <p>
            <div class="thead" style="background-color:  #0c675e; color: white; font-size: 20px;">
                <tr><strong><center>EXISTENCIAS GLOBALES DE FARMACIA CENTRAL</center></strong>
            </div>
            <p>
          <!--Fin de los filtros-->
         ...
         <div class="table-responsive">
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <tbody>
                <?php
                  $resultado2 = $conexion->query("SELECT *, SUM(existe_qty) as cuantos FROM existencias_almacen GROUP BY item_id") or die($conexion->error);
                $no = 1;

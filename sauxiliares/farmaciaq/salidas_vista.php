  ...
  <section class="content container-fluid">
    <div class="container box">
      <div class="content">
        ...
        <br>
        <center>
          <h1>MEDICAMENTOS SURTIDOS DE QUIROFANO</h1>
        </center>
          ...
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <thead class="thead" style="background-color: #0c675e; color:white;">
              <tr>
                ...
                <th><font color="white">FECHA SOL.</th>
                <th><font color="white">SURTIO</th>
                <th><font color="white">FECHA</th>
                <th><font color="white">MÉDICAMENTO</th>
            ...
            <tbody>
              ...
              $resultado2 = $conexion->query("SELECT s.*, di.id_atencion, di.Id_exp, p.*, s.salida_lote, s.salida_caducidad FROM salidas_almacenq s, dat_ingreso di, paciente p WHERE s.id_atencion=$id_atencion AND date(s.fecha_solicitud)='$fecha' AND s.id_atencion=di.id_atencion AND di.Id_exp=p.Id_exp") or die($conexion->error);
              $no = 1;
              $total = 0;
              while ($row = $resultado2->fetch_assoc()) {
                ...
                while ($row_usua = $result4->fetch_assoc()) {
                  ...
                  echo '<tr>'
                    ...
                    //. '<td bgcolor="blue"><font color="white">' . $row['gram'] . '</td>'

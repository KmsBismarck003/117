...
$this->Ln(33);
    ...
    $this->SetX(98);
    $this->Cell(145, 10, utf8_decode('DEVOLUCIONES DE FARMACIA RASTREO'), 1, 0, 'C');
    ...
    $this->Cell(35, 10, 'FECHA: ' . date_format($date1,"d/m/Y H:i"), 0, 1, 'R');
        ...
        $this->Cell(120, 5, utf8_decode('Usuario'), 1, 0, 'C');
        $this->Ln(5);
    }
    function Footer()
    {
...
$sql = "SELECT * FROM item i, devolucion d,reg_usuarios r WHERE i.item_id = d.dev_item and r.id_usua=d.id_usua order by d.fecha desc";
...
if ($rowcount != 0) {
    ...
    $pdf->Cell(120, 5, utf8_decode($row_tabla['papell']), 1, 0, 'L');

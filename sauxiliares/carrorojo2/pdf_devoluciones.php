...
class PDF extends FPDF
{
  ...
  $this->Image('../../imagenes/SI.PNG', 5, 15, 65, 21);
    ...
    $this->SetX(98);
    $this->Cell(145, 10, utf8_decode('DEVOLUCIONES DE CARRO ROJO DE TERAPIA INTENSIVA'), 1, 0, 'C');
...
$sql = "SELECT * FROM material_rojo2 i, devolucion_rojo2 d WHERE i.material_id = d.id_dev and d.dev_estatus = 'NO'";

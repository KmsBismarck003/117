...
<section class="content container-fluid">
        ...
        <div class="content">
          <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
            <strong><center>EXISTENCIAS DE CARRO ROJO OBSERVACIÓN</center></strong>
          </div>
      <p>
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <tbody>
             ...
             $resultado2 = $conexion->query("SELECT * FROM material_rojo2, stock_rojo2, item_type where  item_type.item_type_id=material_rojo2.material_tipo and material_rojo2.material_id = stock_rojo2.item_id and stock_rojo2.stock_qty > 0 ORDER BY material_rojo2.material_nombre ASC") or die($conexion->error);
                $no = 1;

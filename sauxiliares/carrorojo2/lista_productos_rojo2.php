...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
           <a type="submit" class="btn btn-danger" href="../../template/menu_rojo2.php">Regresar</a> 
        </div>
    </div>
</div>
...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
         <tr><strong><center>MATERIALES DE CARRO ROJO OBSERVACIÓN</center></strong>
      </div><br>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="insertar_material_rojo2.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" id="item-id">
                    <div class="form-group">
                        <label class="control-label col-sm-6" for="">Nombre del material:</label>
                        <div class="col-sm-9">
                            <input type="text" maxlength="50" name="nommat" class="form-control" id="item-name" placeholder="Ingresa el nombre generico" required="" autofocus="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="">RENTADO.?:</label>
                        <div class="col-sm-9">
                            <select name="rentado" id="rentado">
                                <option value="SI">Si</option>
                                <option value="NO">No</option>
...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <a href="excelrojo2.php"><button type="button" class="btn btn-warning"><img src="https://img.icons8.com/color/48/000000/ms-excel.png"/><strong>EXPORTAR A EXCEL</strong></button></a>
        </div>
    </div>
</div>
<?php } ?>
        ...
        //    $resultado2 = $conexion->query("SELECT id_serv, serv_cve, serv_costo, serv_umed,serv_activo FROM cat_servicios") or die($conexion->error);
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    // $sql = "SELECT id_usua, curp_u, nombre, papell,sapell,fecha,mat,cedp,cargp,email,u_activo FROM reg_usuarios;";
                    //  $result = $conn->query($sql);
                    $resultado2 = $conexion->query("SELECT * FROM material_rojo1, item_type where item_type.item_type_id=material_rojo1.material_tipo") or die($conexion->error);
                    $no = 1;
                    $usuario = $_SESSION['login'];
                          if ($usuario['id_rol'] == 5) {

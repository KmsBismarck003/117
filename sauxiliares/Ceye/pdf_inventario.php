...
$this->Ln(33);
    ...
    $this->SetX(80);
    $this->Cell(145, 10, utf8_decode('REPORTE DE EXISTENCIAS QUIRÓFANO (GLOBAL)'), 1, 0, 'C');
  ...
  function Footer()
  {
    ...
    $this->Cell(0, 10, utf8_decode('CMSI-39'), 0, 1, 'R');
  }
}
...
$resultado2 = $conexion->query("SELECT * FROM material_ceye m, stock_ceye s, item_type i 

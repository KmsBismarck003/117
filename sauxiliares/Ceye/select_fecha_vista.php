...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
         <strong><center>SALIDAS DE MEDICAMENTO DE QUIRÓFANO
          ...
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <tbody>
             ...
             echo'<tr><h4><strong>PACIENTE: '.$paciente.'</strong></h4></tr>';
              $resultado2 = $conexion->query("SELECT distinct(date(s.fecha_solicitud)) AS fecha_solicitud from sales_ceye s where s.paciente=$id_atencion order by s.fecha_solicitud DESC") or die($conexion->error);
              $no = 1;
              $total = 0;

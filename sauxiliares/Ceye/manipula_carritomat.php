...
if (@$_GET['q'] == 'del_car') {
  ...
  $result1 = $conexion->query($sql1);
   ...
   echo '<script type="text/javascript">window.location.href = "orderqx.php?id_atencion=' . $paciente . '";</script>';
...
/*************************** inserta dat_ctapac  **********************/   
    $sql_insert_cuenta = "INSERT INTO dat_ctapac(
        id_atencion,
        prod_serv,
        insumo,
        cta_fec,
    ...
    echo '<script>
                    $(document).ready(function() {
                        swal({
                            ...
                            if (isConfirm) {
                            window.location.href = "orderqx.php?id_atencion='.$paciente.'";

...
class PDF extends FPDF
{
  ...
  include '../../conexionbd.php';
    ...
    $this->Image("../../configuracion/admin/img3/".$f['img_cpdf'],100,15, 109, 24);
    $this->Image("../../configuracion/admin/img4/".$f['img_dpdf'], 235, 16, 50, 20);
}
...
$this->Ln(33);
    ...
    $this->SetX(80);
    $this->Cell(145, 10, utf8_decode('EXISTENCIAS DE QUIRÓFANO (DETALLE)'), 1, 0, 'C');
  ...
  function Footer()
  {
    ...
    $this->Cell(0, 10, utf8_decode('CMSI-40'), 0, 1, 'R');
  }
}
...
$sql = "SELECT * FROM material_ceye m, stock_ceye s, item_type i where i.item_type_id=m.material_tipo and m.material_id = s.item_id ";
...
while ($row = $result->fetch_assoc()) {
  ...
  $sql2 = " SELECT * FROM entradas_ceye where item_id = $item_id ORDER BY entrada_added ASC";
  ...
  $sql3 = "SELECT * FROM sales_ceye where item_id = '$item_id' ORDER BY date_sold ASC";
  ...
  $pdf->SetTextColor(43, 45, 127);  
  $sql4 = "SELECT * FROM devolucion_ceye where dev_producto = '$item_id' and dev_estatus = 'NO'

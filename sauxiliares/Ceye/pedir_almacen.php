           ...
           <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                ...
                $resultado2 = $conexion_almacen->query("SELECT * from cart_recib c, item_almacen i where i.item_id = c.item_id and c.confirma='NO' AND c.almacen='CEYE'") or die($conexion_almacen->error);
                $no = 1;

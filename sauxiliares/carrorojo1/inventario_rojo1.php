        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <tbody>
             ...
             $resultado2 = $conexion->query("SELECT * FROM material_rojo1, stock_rojo1, item_type where  item_type.item_type_id=material_rojo1.material_tipo and material_rojo1.material_id = stock_rojo1.item_id and stock_rojo1.stock_qty > 0 ORDER BY material_rojo1.material_nombre ASC") or die($conexion->error);
                $no = 1;

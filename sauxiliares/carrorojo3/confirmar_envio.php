           ...
           <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                ...
                $resultado2 = $conexion_almacen->query("SELECT * from cart_recib c, item_almacen i, item_type t where i.item_id = c.item_id and c.confirma='SI' and c.enviado='SI' and c.almacen='CARRO ROJO3' and t.item_type_id = i.item_type_id") or die($conexion_almacen->error);

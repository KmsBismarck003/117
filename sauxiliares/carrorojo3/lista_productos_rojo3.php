...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
         <tr><strong><center>MATERIALES DE CARRO ROJO QUIRÓFANO</center></strong>
      </div><br>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="insertar_material_rojo3.php" method="POST" enctype="multipart/form-data">
...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <a href="excelrojo3.php"><button type="button" class="btn btn-warning"><img src="https://img.icons8.com/color/48/000000/ms-excel.png"/><strong>EXPORTAR A EXCEL</strong></button></a>
        </div>
    </div>
</div>
<?php } ?>

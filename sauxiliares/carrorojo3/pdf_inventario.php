...
function Header()
  {
    ...
    $this->SetX(80);
    $this->Cell(145, 10, utf8_decode('REPORTE DE EXISTENCIAS CARRO ROJO QUIRÓFANO (GLOBAL)'), 1, 0, 'C');
  ...
  function Footer()
  {
    ...
    $this->Cell(0, 10, utf8_decode('CMSI-48'), 0, 1, 'R');
  }
}
...
$resultado2 = $conexion->query("SELECT * FROM material_rojo3 m, stock_rojo3 s, item_type i 

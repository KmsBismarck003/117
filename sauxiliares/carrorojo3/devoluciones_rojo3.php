...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
    <tr><strong><center>DEVOLUCIÓNES CARRO ROJO QUIRÓFANO PENDIENTES</center></strong>
    </div><br>
            </center>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    $resultado2 = $conexion->query("SELECT * FROM material_rojo3 i, devolucion_rojo3 d, item_type it WHERE i.material_id = d.dev_producto and d.dev_estatus = 'SI' and it.item_type_id=i.material_tipo") or die($conexion->error);
                    $no = 1;

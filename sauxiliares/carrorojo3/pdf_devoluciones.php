...
class PDF extends FPDF
{
  ...
  $this->Image('../../imagenes/SI.PNG', 5, 15, 65, 21);
    ...
    $this->SetX(98);
    $this->Cell(145, 10, utf8_decode('DEVOLUCIONES DE CARRO ROJO QUIRÓFANO'), 1, 0, 'C');
     ...
     function Footer()
  {
    ...
    $this->Cell(0, 10, utf8_decode('CMSI-50'), 0, 1, 'R');
  }
  }
...
$sql = "SELECT * FROM material_rojo3 i, devolucion_rojo3 d WHERE i.material_id = d.id_dev_ceye and d.dev_estatus = 'NO'";

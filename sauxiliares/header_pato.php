...
if (!($usuario1['id_rol'] == 10 || $usuario1['id_rol'] == 5 || $usuario1['id_rol'] == 12 || $usuario1['id_rol'] == 13 || $usuario1['id_rol'] == 2)) {
    session_unset();
    session_destroy();
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        if ($usuario1['id_rol'] == 10 ) {
            ...
            <a href="../../template/menu_patologia.php" class="logo">
...
?>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <?php 
            if ($usuario1['id_rol'] == 4 || $usuario1['id_rol'] == 5 || $usuario1['id_rol'] == 6 || $usuario1['id_rol'] == 13) {
            ?>
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="../Patologia/resultados_pato.php">
 ...
 <?php
        } else if ($usuario1['id_rol'] == 2 || $usuario1['id_rol'] == 12) {

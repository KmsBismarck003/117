...
<div class="container-fluid">
    ...
    if ($usuario1['id_rol'] == 4) {
        ...
        <?php
    } else if ($usuario1['id_rol'] == 9) {

        ?>
        <a type="submit" class="btn btn-primary" href="../../template/menu_imagenologia.php">Regresar</a>
        ...
        <div class="col  col-12">
            <h2>
                <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"
                                                                                              id="side"></i></a>
                <center><font id="letra"><i class="fa fa-plus-square"></i> Editar Resultados de Imagenologia</font>
            </h2>
            </center>
            <hr>
    ...
    <div class="container box">
        <div class="content">
            <div class="col-md-10">
                ...
                $id = $_GET['not_id'];
                //  echo $id;
                $file_doc = "SELECT not_id, interpretacion FROM `notificaciones_imagen` WHERE not_id = $id";
              // echo $file_doc;
...
<div class="container">
  <div class="row">
    <div class="col-sm">
   <iframe src="resultados6/<?php echo $row['interpretacion'] ?>" width="450px" height="400px"></iframe>
    </div>
    <div class="col-sm">
...
<center>
          <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <a href="../Imagenologia/resultados_imagen.php" class="btn btn-danger">Cancelar</a>
...
//imagen1.jpg
    ...
    if($extension6=='jpg' || $extension6=='png' || $extension6=='dcm' ||$extension6=='jpeg' || $extension6=='pdf'){
        ...
        if(move_uploaded_file($_FILES['resultado']['tmp_name'], $carpeta6.$img6)){
            $fila6=$conexion->query("select interpetacion from notificaciones_imagen where not_id = $id");
            $idd6=mysqli_fetch_row($fila6);
            if(file_exists('./resultados6/'.$idd6[0])){
            unlink('./resultados6/'.$idd6[0]);
                }
            $conexion->query("UPDATE notificaciones_imagen SET interpretacion='$img6' where not_id = $id");
                }
            }//llave tipo archivo
        }    //llave si no esta vacio


                echo '<script type="text/javascript">window.location ="../Imagenologia/resultados_imagen.php"</script>';

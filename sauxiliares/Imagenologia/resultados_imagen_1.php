        ...
        <div class="col  col-12">
            <h2>
                <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"
                                                                                              id="side"></i></a>
                <center><font id="letra"><i class="fa fa-plus-square"></i> RESULTADO DE ESTUDIOS DE IMAGENOLOGÍA</font>
            </h2>
            </center>
            <hr>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    <tr>
                        ...
                        <th>Paciente</th>
                        <th>Habitaciónn</th>
                        <th>Fecha y hora de orden solicitado</th>
                        <th>Médico que solicita</th>
                        <th>Tipo</th>
                        <th>Realizado</th>
                    ...
                    $query = "SELECT * FROM notificaciones_imagen n, reg_usuarios u ,cat_servicios c where n.realizado = 'SI' and n.id_usua = u.id_usua and  c.id_serv= n.sol_estudios ";
                    ...
                    while ($row_pac = $result_pac->fetch_assoc()) {
                        ...
                        echo '<td class="fondo" style="color:white;"><center>'
                            . ' <a href="../Imagenologia/verpdf.php?not_id=' . $row['not_id'] . '" title="Ver resultado" class="btn btn-danger "><span class="fa fa-eye" aria-hidden="true"></span></a>';
                        echo '</center></td>';
                        $no++;

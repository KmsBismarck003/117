        ...
        <div class="col  col-12">
            <h2>
                <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"
                                                                                              id="side"></i></a>
                <center><font id="letra"><i class="fa fa-plus-square"></i> Resultados de Imagenología</font>
            </h2>
            </center>
            <hr>
    ...
    <div class="container box">
        <div class="content">
            <div class="col-md-10">
                ...
                $id = $_GET['not_id'];
                //  echo $id;
                $file_doc = "SELECT not_id, resultado FROM `notificaciones_imagen` WHERE not_id = $id";
              // echo $file_doc;

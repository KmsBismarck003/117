...
$filename = 'existencias_almacen_' . date('Ymd_His') . '.xls';
...
echo "<table>";
echo "<tr>";
echo "<td colspan='8' style='text-align: center; font-size: 20px; font-weight: bold;'>Existencias Almacen Central</td>";
echo "</tr>";
echo "</table>";

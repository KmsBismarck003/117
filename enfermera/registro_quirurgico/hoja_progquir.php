...
<div class="col-sm"><hr><p></p>
      <strong><p><center>TIPO DE ANESTESIA:</center></p></strong>
      
      <div class="row">
          <div class="col-sm-5">
              <div class="form-check">
        <input class="form-check-input" type="radio" id="LOCAL" value="Local" name="tipo_ane" required="">
        <label class="form-check-label" for="LOCAL">LOCAL</label>
      </div>
          </div>
           <div class="col-sm-5">
               <div class="form-check">
        <input class="form-check-input" type="radio" id="REGIONAL" value="Regional" name="tipo_ane">
        <label class="form-check-label" for="REGIONAL">REGIONAL</label>
      </div>
          </div>
           <div class="col-sm">
               <div class="form-check">
        <input class="form-check-input" type="radio" id="GENERAL" value="General" name="tipo_ane">

...
$resultado3 = "SELECT * from textiles WHERE id_atencion='$id_atencion' and mat='$mat' and cirugia=2 ORDER BY id Desc";
...
$sql = "INSERT INTO `textiles` (id_atencion,mat,inicio,dentro,fuera,total,text_fecha,id_usua,fechare,iniciototal,cirugia) values ('$id_atencion','$mat','$inicio','$dentro','$fuera','$inicio','$fr','$id_us','$fechat','$inicio',2)";
...
$sqli = "INSERT INTO `textiles` (id_atencion,mat,inicio,dentro,fuera,total,text_fecha,id_usua,fechare,iniciototal,cirugia) values ('$id_atencion','$mat','$inicio','$dentro','$fuera','$totali','$fecha_actual','$id_up','$fechat','$inicio',2)";

...
$sql2eg = "UPDATE egresos_quir SET id_usua = '$id_usua', fecha = '$fecha',soluciones = '$soluciones',hora = '$hora',volumen='$volumen' WHERE id_equir=$id";
  
  echo mysqli_query($conexion,$sql2eg);

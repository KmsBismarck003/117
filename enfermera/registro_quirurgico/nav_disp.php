      ...
      <div class="container">
        <div class="content">
           ...
           <div class="thead" style="background-color: #0c675e; color: white; font-size: 25px;">
                 <tr><strong><center>REGISTRO CLÍNICO DE ENFERMERÍA QUIRÚRGICO<br>DISPOSITIVOS INVASIVOS, INGRESOS</center></strong>
        </div>
         <hr>
 <font size="2">
         <div class="container">
...
<hr>
<div class="container">
    <a href="vista_enf_quirurgico.php" class="btn btn-outline-success">NOTA</a>
    <a href="nav_med.php" class="btn btn-outline-success">MEDICAMENTOS Y EQUIPOS</a>
    <a href="nav_disp.php" class="btn btn-outline-success">DISPOSITIVOS INVASIVOS, INGRESOS</a>
    <a href="nav_ins.php" class="btn btn-outline-success" >INSULINOTERAPIA, GLICEMIA, CISTOCLISIS</a>
...
<div class="container">
  ...
  <div class="row">
    ...
    <tr class="table-active">
      ...
      <th scope="col"><center>QUIEN LO INSTALA</center></th>
      <th scope="col"><center>FECHA</center></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><input type="text" name="disp" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></td>
      <td><input type="text" name="cal" class="form-control col-sm-12" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></td>
      <td><input type="text" name="nom" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></td>
      <td><input type="date" name="fecha" class="form-control"></td>
    </tr>
  </tbody>
</table>
OBSERVACIONES:<br><textarea rows="3" name="observ" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea> 
     </div>
     <div class="row"><input type="submit" name="btndisp" class="btn btn-block btn-success" value="AGREGAR"></div>
</form>
 ...
 <div class="container">
  ...
  <tbody>
    <tr>
      ...
      <td><input type="text" name="par" class="form-control col-sm-12" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></td>
      <td><input type="text" name="hemo" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" ></td>
...
<div>
    ...
    include "../../conexionbd.php";
            ...
            $id_atencion = $_SESSION['pac'];
            $disp =  mysqli_real_escape_string($conexion, (strip_tags($_POST["disp"], ENT_QUOTES)));
...
$fecha_actual = date("d-m-Y H:i:s");
            $ingresar2 = mysqli_query($conexion, 'INSERT INTO disp_enf_quir (id_atencion,id_usua,disp,cal,nom,fecha,observ,fecha_disp) values ('.$id_atencion.',' . $id_usua . ',"' . $disp .'","' . $cal . '","'.$nom.'","' . $fecha .'","' . $observ .'","'.$fecha_actual.'") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
              ...
              echo '<script type="text/javascript">window.location.href = "nav_disp.php";</script>';
    }

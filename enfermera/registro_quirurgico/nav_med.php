...
<div class="container">
  <div class="row">
    ...
    <div>
        &nbsp;
      <a href="nav_med.php" class="btn btn-outline-primary  btn-sm active">MEDICAMENTOS/EQUIPOS</a>
    </div>
      ...
      <div class="row">
       ...
       <thead class="thead">
         <tr class="table-primary">
            <th colspan="7"><center><h5><strong>MEDICAMENTOS Y MATERIALES UTILIZADOS EN QUIRÓFANO</strong></h5></center></th>
         </tr>
...
<form action="" method="POST" id="medicamentos">
  ...
  <tbody>
    <tr>
      <td><select data-live-search="true" name="serv" id="mibuscador2" style="width : 100%; heigth : 100%">
      ...
      <td><input type="cm-number" name="qty_serv" class="form-control" required></td>
...
<?php
    ...
    ?>
    <h4>MEDICAMENTOS Y MATERIALES</h4>
    <div class="container">
       <div class="table-responsive">
        ...
        <tbody>
            ...
            <div class="col-md-2">
              <center>
                <?php
                echo '<a type="submit" class="btn btn-success btn-block" href="manipula_carrito.php?q=comf_cart&paciente=' . $id_exp. '&id_atencion=' . $id_atencion. '&id_usua=' . $usuario['id_usua'] . '&id_cart=' . $row['cart_id'] . '"><span>Confirmar</span></a>';
                ?>
              </center>
            </div>
            </center>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                ...
                where di.id_atencion = c.paciente and p.Id_exp = di.Id_exp and i.id_serv = c.servicio_id AND c.paciente=$id_atencion ORDER BY c.cart_id ASC") or die($conexion->error);
            ...
            <div class="col-md-3">
                <?php
                echo '<a type="submit" class="btn btn-success btn-block" href="manipula_carrito.php?q=comf_cartserv&paciente=' . $id_exp. '&id_atencion=' . $id_atencion. '&id_usua=' . $usuario['id_usua'] . '"><span>Confirmar</span></a>';
                ?>
            </div>
            </center>
         </div> 

                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    <tr>
                        <th><font color="white">Expediente</th>
                          <th><font color="white">Habitacion</th>
...
while($fila = mysqli_fetch_array($resultado)){
        $visita = $fila['id_atencion'];
         $fecing = date_create($fila['fecha']);
        $cama=' ';
        $queryc = "SELECT num_cama FROM cat_camas WHERE id_atencion = $visita";
 ...
 echo '<tr>'
                            ...
                            . '<td>' . $cama . '</td>'
                            . '<td>' . $fila['nom_pac'] . " " . $fila['papell'] . " " . $fila['sapell'] . '</td>'

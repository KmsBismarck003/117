  ...
  <div class="row">
    ...
    <div class="col-sm-2">
      <div class="form-group">
              ...
              <option value="<?php echo $row_datos['niv_dolor']; ?>"><?php echo $row_datos['niv_dolor']; ?></option>
                 <option value="" disabled>Seleccionar nivel de dolor</option>
...
<br>
      ...
      if (isset($_POST['edit'])) {
        ...
        $sql2 = "UPDATE signos_vitales SET p_sistol = '$p_sistol', p_diastol = '$p_diastol',fcard = '$fcard',fresp = '$fresp', temper = '$temper',satoxi = '$satoxi',niv_dolor = '$niv_dolor',hora = '$hora', tam = '$tam' WHERE id_sig = $id";
        $result = $conexion->query($sql2);

        echo "<p class='alert alert-success' id='mensaje'> <i class=' fa fa-check'></i> Dato insertado correctamente...</p>";
        echo '<script type="text/javascript">window.location.href = "../registro_terapeutico/reg_terapeutico.php";</script>';
      }
      ?>
    </div>
  </section>

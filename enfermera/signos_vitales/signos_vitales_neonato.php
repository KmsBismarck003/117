...
$resultado = $conexion->query("SELECT * from signos_vitales WHERE id_atencion=$id_atencion and fecha='$fecha' and neonato='Si' ORDER BY id_sig DESC") or die($conexion->error);
$usuario = $_SESSION['login'];
...
$resultado_usua = $conexion->query("SELECT * FROM reg_usuarios WHERE id_usua=$id_usua") or die($conexion->error);
 ...
 <td><a href="edit_signos_hosp.php?id_sig=<?php echo $f['id_sig'];?>&id_atencion=<?php echo $f['id_atencion'];?>"><button type="button" class="btn btn-warning"><i class="fas fa-edit"></i></button></td>

                        <td><a href="el_signos_hosp.php?id_sig=<?php echo $f['id_sig'];?>&id_atencion=<?php echo $f['id_atencion'];?>"><button type="button" class="btn btn-danger">X </button></td>
                       <?php $no++; ?>
                    </tr>
                    <?php
                }
...
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where   id_atencion=$id_atencion AND fecha='$fecha' and hora=15") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where   id_atencion=$id_atencion AND fecha='$fecha' and hora=16") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where   id_atencion=$id_atencion AND fecha='$fecha' and hora=17") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) { 

echo $resp_r['p_sistol'];

 } ?>,<?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where   id_atencion=$id_atencion AND fecha='$fecha' and hora=18") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=19") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=20") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=21") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=22") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>,<?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=23") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=24") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=1") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=2") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=3") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>,<?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=4") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=5") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=6") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

echo $resp_r['p_sistol'];

 } ?>, <?php 
$resp = $conexion->query("select p_sistol,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=7") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {
...
$resp = $conexion->query("select fcard,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=17") or die($conexion->error); 
while ($resp_r = mysqli_fetch_array($resp)) {
...
$resp = $conexion->query("select fcard,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=22") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) { 
...
$resp = $conexion->query("select fcard,tipo from signos_vitales where  id_atencion=$id_atencion AND fecha='$fecha' and hora=7") or die($conexion->error);
while ($resp_r = mysqli_fetch_array($resp)) {

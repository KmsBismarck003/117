...
//echo "<br>Tu edad es: $anos años con $meses meses y $dias días";
 ...
 <font size="2">
  ...
  <div class="row">
   ...
   ?>
      <div class="col-sm">
      Fecha de ingresa: <strong><?php echo date_format($date, "d-m-Y") ?></strong>
    </div>
  </div>
</div></font>
...
?></strong>
    ...
    <div class="col-sm-3">
      Peso: <strong><?php 
      $sql_vit = "SELECT peso from dat_hclinica where Id_exp=$id_exp ORDER by peso ASC LIMIT 1";
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from dat_cir_seg WHERE id_atencion=$id_atencion ORDER BY id_cir_seg DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_cir_seg=$f['id_cir_seg'];

                    ?>

                    <tr>
                        <td><a href="../registro_quirurgico/pdf_cirugia_segura.php?id_cir_seg=<?php echo $id_cir_seg; ?>&id_exp=<?php echo $id_exp ?>&id=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha']); echo date_format($date,"d/m/Y");?></strong></td>
                        <!--<td><strong><?php $date=date_create($f['hora_solicitud']); echo date_format($date,"h:i");?></strong></td>-->
                    </tr>
                    <?php
                }
                ?>

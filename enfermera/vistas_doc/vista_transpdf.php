...
-->
  ...
  <title>DATOS VISTA REGISTRO TRANSFUCIONES SANGUÍNEAS</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA REGISTRO TRANSFUCIONES SANGUÍNEAS</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from dat_trans_sangre d WHERE d.id_atencion=$id_atencion ORDER BY id_atencion DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                <tr>
                    <th scope="col">PDF</th>
                    <th scope="col">Fecha hoja <br>de transfución</th>
                ...
                while($f = mysqli_fetch_array($resultado)){
                  ...
                  while ($row_enfermera = $result_enfermera->fetch_assoc()) {
                    ...
                    <tr>
                        <td><a href="../transfucion_de_sangre/pdf_transf.php?id_atencion=<?php echo $id_atencion?>&id_exp=<?php echo $id_exp?>&fecha=<?php echo $fecha?>" target="_blank"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php $fecre=date_create($f['fecha_act']); echo date_format($fecre,"d-m-Y");?></strong></td>
                        ...
                        <td><a href="edit_trans.php?id_tras=<?php echo $f['id_tras'];?>&id_atencion=<?php echo $f['id_atencion'];?>&id_sangre=<?php echo $f['id_sangre'];?>"><button type="button" class="btn btn-warning"><i class="fas fa-edit"></i></button></td>
                    </tr>
                    <?php
                }

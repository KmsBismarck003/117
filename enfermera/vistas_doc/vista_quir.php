    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA REGISTRO QUIRÚRGICO - ENFERMERÍA</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
$result_hab = $conexion->query($sql_hab);                                                                                    while ($row_hab = $result_hab->fetch_assoc()) {
  echo $row_hab['num_cama'];
    ...
    <div class="col-sm">
      Tiempo estacia: <strong><?php echo $estancia ?> Dias</strong>
    </div>
  </div>
</div>
</font>
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_quir=$f['id_quir'];
                   $fecha=$f['fecha'];
                    ...
                    <tr>
                        <td><a href="../registro_quirurgico/pdf_reg_areaquir.php?id_quir=<?php echo $id_quir; ?>&id_atencion=<?php echo $id_atencion; ?>&id_exp=<?php echo $id_exp; ?>&fec=<?php echo $fecha; ?>"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>

            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  ...
                  while ($row_enfermera = $result_enfermera->fetch_assoc()) {
                    ...
                    <tr>
                        <td><a href="../pdf/pdf_reg_urg_enf.php?id_enf_urg=<?php echo $id_enf_urg?>&id_atencion=<?php echo $id_atencion?>&id_exp=<?php echo $id_exp?>&fechar=<?php echo $datet?>&hor=<?php echo $hor?>"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>

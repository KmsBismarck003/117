  ...
  <section class="content container-fluid">
    <?php
     ...
     if ($activo === 'SI') {
        ...
        ?>
       <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>IMPRESIÓN DE NOTA DE TRANSLADO  </center> </strong></div>              
      <div class="row">
        <div class="col-sm-2">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from dat_traslado WHERE id_atencion=$id_atencion ORDER BY id_traslado DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_traslado=$f['id_traslado'];

                    ?>
                    <tr>
                        <td><a href="../../gestion_medica/pdf/pdf_traslados.php?id_in=<?php echo $id_traslado; ?>&id_exp=<?php echo $id_exp?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        <td><strong><?php $date=date_create($f['horenv']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date2=date_create($f['horenv']); echo date_format($date2,"H:i a");?></strong></td>
                    </tr>
                    <?php
                }
                ?>

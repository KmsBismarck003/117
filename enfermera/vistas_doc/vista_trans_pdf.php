...
-->
  ...
  <title>NOTA TRANS-ANESTESICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from dat_trans_anest WHERE id_atencion=$id_atencion ORDER BY id_trans_anest DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_trans_anest=$f['id_trans_anest'];


                    ?>

                    <tr>
                        <td><a href="../../gestion_medica/pdf/pdf_des_transanestesico.php?id_trans_anest=<?php echo $id_trans_anest; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>&fecha=<?php echo $f['fecha_reporte']?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['hora']); echo date_format($date,"h:i");?></strong></td>
                    </tr>
                    <?php
                }
                ?>

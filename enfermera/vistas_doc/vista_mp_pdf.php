  ...
  <section class="content container-fluid">
    <div class="container">
     <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;">
              <strong><center>NOTIFICACIÓN MINISTERIO PÚBLICO</center></strong>
            </div><br>
...
<div class="container-fluid">
 ...
 <div class="form-group">
     ...
     <a href="../vistas_doc/edit_pdf_ministerio.php">
 <input type="button" class="form-control pull-left btn-primary btn-sm" style="width:17.5%" value="Nueva notificación"></a>
 </div>
            <div class="form-group">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from mp WHERE id_atencion=$id_atencion ORDER BY id_mp DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  ...
                  $persona=$f['persona'];
                    ...
                    ?>
                    <tr>
                        <td><a href="../../gestion_medica/cartas_consentimientos/pdf_consent_ministerio.php?id_mp=<?php echo $id_mp; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>&acto=<?php echo $acto ?>&reporte=<?php echo $reporte ?>&agencia=<?php echo $agencia ?>&persona=<?php echo $persona ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        <td><strong><?php $date=date_create($f['fecha_mp']); echo date_format($date,"d/m/Y H:i");?></strong></td>
                        <td><strong><?php echo $f['reporte']?></strong></td>
                    </tr>
                    <?php
                }
                ?>

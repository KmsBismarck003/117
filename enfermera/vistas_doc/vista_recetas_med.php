...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from receta r,reg_usuarios reg WHERE r.id_atencion=$id_atencion and r.id_usua=reg.id_usua ORDER BY r.id_rec DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        ...
                        <td><a href="../../gestion_medica/hospitalizacion/pdf_recetario_medico_hospitalizacion.php?id_med=<?php echo $f['id_usua'];?>&id=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>&id_exp=<?php echo $row['Id_exp'] ?>&id_rec=<?php echo $f['id_rec'] ?>" target="_blank"><button type="button" class="btn btn-danger"> <i class="fa fa-file-pdf-o" style="font-size:28px"  aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                         <td><strong><?php echo $f['sapell']. ' ' .$f['papell']. ' '.$f['nombre'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_r_hosp']); echo date_format($date,"d/m/Y H:i");?></strong></td>

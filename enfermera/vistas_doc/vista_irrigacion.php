...
-->
  ...
  <title>REGISTRO PARA HOJA DE IRRIGACIÓN - ENFERMERÍA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>REGISTRO PARA DIÁLISIS PERITONEAL - ENFERMERÍA</h2>
         <hr>
  <font size="2">
         <div class="container">
  <div class="row">
...
$result_hab = $conexion->query($sql_hab);                                                                                    while ($row_hab = $result_hab->fetch_assoc()) {
  echo $row_hab['num_cama'];
    ...
    <div class="col-sm">
      Tiepo estancia: <strong><?php echo $estancia ?> Dias</strong>
    </div>
  </div>
</div>
</font>
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from irrigacion WHERE id_atencion=$id_atencion GROUP BY fecha_reporte ORDER BY id_irrigacion DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_irrigacion=$f['id_irrigacion'];
                  $id_atencion=$f['id_atencion'];
                  $fecham=$f['fecha_reporte'];
                  ...
                  while ($row_enfermera = $result_enfermera->fetch_assoc()) {
                    ...
                    <tr>
                        <td><a href="../pdf/pdf_irrigacion.php?id_irrigacion=<?php echo $id_irrigacion?>&id_atencion=<?php echo $id_atencion?>&id_exp=<?php echo $id_exp?>&fechar=<?php echo $fecham?>"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php $fecre=date_create($f['fecha_reporte']); echo date_format($fecre,"d-m-Y");?></strong></td>
                        <td><strong><?php $feccha_registro=date_create($f['fecha_registro']); echo date_format($feccha_registro,"d-m-Y H:i a");?></strong></td>

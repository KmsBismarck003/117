...
-->
  ...
  <title>Vista Notificación ministerio público</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
  ...
  <section class="content container-fluid">
    <div class="container">
     <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;">
              <strong><center>RESPONSIVA DE INCINERACIÓN</center></strong>
            </div><br>
...
<div class="container-fluid">
 ...
 <div class="form-group">
     ...
     <a href="edit_pdf_inci.php">
 <input type="button" class="form-control pull-left btn-primary btn-sm" style="width:17.5%" value="Nueva responsiva"></a>
 </div>
            <div class="form-group">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from incineracion WHERE id_atencion=$id_atencion ORDER BY id_in DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                <tr>
                    <th scope="col">PDF</th>
                    <th scope="col">Fecha de responsiva</th>
                    <th scope="col">Fecha de incineración</th>
                ...
                while($f = mysqli_fetch_array($resultado)){
                  ...
                  $vobo=$f['vobo'];
                    ...
                    ?>
                    <tr>
                        <td><a href="../cartas_consentimientos/pdf_consent_incinera.php?id_in=<?php echo $id_in; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>&amp=<?php echo $amp ?>&fechade=<?php echo $fechade ?>&aceptan=<?php echo $aceptan ?>&tesuno=<?php echo $tesuno ?>&tesdos=<?php echo $tesdos ?>&vobo=<?php echo $vobo ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        <td><strong><?php $date=date_create($f['fecha_inc']); echo date_format($date,"d/m/Y H:i");?></strong></td>
                        <td><strong><?php $datea=date_create($f['fechade']); echo date_format($datea,"d/m/Y")?></strong></td>
                    </tr>
                    <?php
                }
                ?>

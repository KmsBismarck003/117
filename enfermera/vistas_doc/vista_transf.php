...
<body>
  <section class="content container-fluid">
    ...
    if (isset($_SESSION['hospital'])) {
      ...
      $sql_pac = "SELECT p.Id_exp,p.sapell, p.papell, p.nom_pac, p.dir, p.id_edo, p.id_mun, p.Id_exp, p.tel, p.fecnac,p.tip_san, di.fecha, di.area, di.alta_med, p.sexo, di.alergias FROM paciente p, dat_ingreso di WHERE p.Id_exp=di.Id_exp and di.id_atencion =$id_atencion";
...
<div class="container ">
        ...
        <div class="thead" style="background-color: #2b2d7f ; color: white; font-size: 20px;">
                 <tr><strong><center>CONSULTAR NOTAS DE TRASFUSIÓN</center></strong>
            </div>
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from dat_trasfucion  WHERE id_atencion=$id_atencion ORDER BY id_tras DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        <td><a href="pdf_transf.php?id_sang=<?php echo $f['id_tras'];?>&id_exp= <?php echo $Id_exp; ?>&id_atencion= <?php echo $id_atencion; ?>" target="_blank"><button type="button" class="btn btn-danger"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_act']); echo date_format($date,"d/m/Y");?></strong></td>
                    </tr>
                  <?php 
                  } ?>
                </tbody>

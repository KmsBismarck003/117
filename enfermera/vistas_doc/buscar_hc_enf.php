...
<head>
  ...
  <title>Menú Historia Clínica </title>
   ...
   <?php
        ...
        if (isset($_SESSION['pac'])) {
          ...
          while ($row_pac = $result_pac->fetch_assoc()) {
            ...
            $fecha = date_create($row_pac['fecha']);
            $fec_egreso = date_create($row_pac['fec_egreso']);
     ...
     if ($activo === 'SI') {
        ...
        ?>
      <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>IMPRESIÓN DE HISTORIA CLÍNICA</center> </strong></div>       
      <div class="row">
        <div class="col-sm-2">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                ...
                <?php
              $sql_pachis = "SELECT * FROM  dat_hclinica WHERE Id_exp=$id_exp ORDER BY id_hc desc " ;

          $result_pachis = $conexion->query($sql_pachis);

          while ($f = $result_pachis->fetch_assoc()) {
                ?>
                <tr>
                  <td><strong> <a type="submit" class="btn btn-danger btn-sm" href="../../gestion_medica/historia_clinica/pdf_hclinica.php?id_hc=<?php echo $f['id_hc']; ?>&id_exp=<?php echo $id_exp; ?>" target="_blank"><span class="fa fa-file-pdf-o" style="font-size:28px"></span></a></strong></td>
                   <!-- <td><strong><?php echo $f['Id_exp']; ?></strong></td>-->
                 
<td><a href="edit_hclinica.php?id_hc=<?php echo $f['id_hc']; ?>&id_exp=<?php echo $f['Id_exp']; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                      

                    <td><strong><?php $date = date_create($f['fec_hc']);
                                echo date_format($date, "d/m/Y"); ?></strong></td>
                     <td><strong><?php $date2 = date_create($f['fec_hc']);
                                echo date_format($date2, "H:i a"); ?></strong></td>

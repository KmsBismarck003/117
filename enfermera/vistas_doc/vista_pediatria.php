...
-->
  ...
  <title>DATOS VISTA REGISTRO PEDIÁTRICO/NEONATAL</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA REGISTRO PEDIÁTRICO/NEONATAL</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT DISTINCT(fechab) as fechab,id_rec_nac,fechasistb, id_atencion,horab,id_usua from iden_recnac WHERE id_atencion=$id_atencion ORDER BY id_rec_nac DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                <tr>
                    <th scope="col">PDF</th>
                    <th scope="col">Fecha hoja <br>de pediatría/neonatal</th>
                    <th scope="col">Hora hoja <br>de pediatría/neonatal</th>
                ...
                while($f = mysqli_fetch_array($resultado)){
                  ...
                  while ($row_enfermera = $result_enfermera->fetch_assoc()) {
                    ...
                    <tr>
                        <td><a href="../registro_clinico_neonatal/pdf_neonatal.php?id_rec_nac=<?php echo $id_rec_nac?>&id_atencion=<?php echo $id_atencion?>&id_exp=<?php echo $id_exp?>&fechar=<?php echo $fechab?>&hor=<?php echo $horab?>" target="_blank"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>
                        
                        <td><strong><?php $fecre=date_create($f['fechab']); echo date_format($fecre,"d-m-Y");?></strong></td>
                        <td><strong><?php echo $f['horab'];?></strong></td>
                        
                        <td><strong><?php $fecregm=date_create($f['fechasistb']); echo date_format($fecregm,"d-m-Y H:i:s");?></strong></td>
                        <td><strong><?php echo $user_papelld.' '.$user_sapelld ?> </strong></td>
                    </tr>
                    <?php
                }

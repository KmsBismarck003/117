...
$resultado=$conexion->query("select paciente.*, dat_ingreso.especialidad, dat_ingreso.area, dat_ingreso.motivo_recepcion, dat_ingreso.fecha, dat_ingreso.id_atencion
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp WHERE dat_ingreso.area='TRIAGE' and activo ='SI'") or die($conexion->error);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="row">
        ...
        <div class="col col-12">
                ...
                <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;">
                           <tr><strong><center>PACIENTES EN ESPERA DE TRIAGE</center></strong>
                </div>
                <hr>
            <div class="row">
                <div class="col-6"><a href="buscar_triage.php"><button type="button" class="btn btn-primary btn-sm"  data-target="#exampleModal">
                            <i class="fa fa-plus"></i><font id="letra"> Buscar triage registrado </font></button></div>
            </div>
           ...
           <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars" id="side"></i></a>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    $existe = "NO";
                    $resultado2=$conexion->query("select * from triage where id_atencion=$id_atencion") or die($conexion->error);
                    ...
                    <tr>
                        ...
                        <td scope="row" id="letra" align="center">
                            <a href="triage.php?id_atencion=<?php echo $f['id_atencion'];?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button><strong></strong></td>
                        ...
                        <td><strong><center><?php echo $f['motivo_recepcion'];?></center></strong></td>

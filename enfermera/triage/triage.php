...
include "../header_enfermera.php";
 ...
 if (isset($_SESSION['pac'])) {
  ...
  if(mysqli_num_rows($resultado) > 0 ){ //se mostrara si existe mas de 1
    ...
    header("Location:triage.php"); //te regresa a la página principal
  }
}else{
  header("Location:triage.php"); //te regresa a la página principal
}
...
<table class="table" align="center">
  ...
  <tbody>
    <tr>
      <th scope="row"></th>
      <td><img src="../../imagenes/rojo.png" width="550" high="400" align="right"></td>
  ...
  <label for="rojo"></label></center>
    ...
    <tr>
      <th scope="row"></th>
      <td><img src="../../imagenes/amarillo.png" width="550" high="400" align="right"></td>
 ...
 <label for="amarillo"></label></center>
    ...
    <tr>
      <th scope="row"></th>
      <td><img src="../../imagenes/verde.png" width="550" high="400" align="right"></td>
      <td><div class="form-check">
        <br><br><center>
...
function leerTexto(talla){
  ...
  <div class="col-sm-8">
        <div class="form-group">
            <strong>Destino delpaciente:</strong>
...
<div class="col-sm-12">
<label for="otro"><strong>Otros antecedentes:</strong></label>
<div class="botones">
...
<textarea class="form-control" rows="3" name="otro" id="txtu"></textarea>
...
function leerTexto(txtu){
 ...
 <h6><strong><hr><button type="button" class="btn btn-success btn-sm" id="play9"><i class="fas fa-play"></button></i> Escala Glasgow:</h6></strong>
<!--
<script type="text/javascript">
...
<div class="form-group">
        <select class="form-control" name="val_total" id="val_total" style="width : 100%; heigth : 100%" required>
...
<select class="form-control" name="imp_diag" id="txtimp_diag" required>
   <option value="">Seleccionar</option>
  ...
  <option value="Inconsiente">Inconsiente</option>
    ...
    <div class="col-sm">
     <img src="../../img/avdi.jpg" width="300">
    </div>
    <script type="text/javascript">
...
<script>
        function habilitar(value)
        {
            if(value=="Cubiculo" || value==true)
            {
                // habilitamos
                document.getElementById("cama").disabled=false;
            }else if(value=="Consulta" || value==false){
                // deshabilitamos
                document.getElementById("cama").disabled=true;
            }
        }
...
<div class="row">
    <div class="col-sm-4">
       ...
       <select name="destino" class="form-control" id="txtdestttt" required onclick="habilitar(this.value);" required>
         <option value="">Seleccionar</option>
         <option  value="Consulta">Egreso</option>
         <option  value="Cubiculo">Asignar habitación</option>
       </select>
    ...
    <div class="col-sm-4">
        ...
        <select id="cama" name="habitacion" class="form-control" disabled>
          <option value="">Seleccionar</option>
        <?php
        ...
        <?php foreach ($resultado1 as $opciones):?>
         <option value="<?php echo $opciones['tipo']?>"><?php echo $opciones['num_cama']?> <?php echo $opciones ['estatus']?> <?php echo $opciones['tipo']?></option>
        <?php endforeach?>
...
<!-- *******************************************AQUI ESTABA LA PESTAÑA DE NOTA ********************************************
    <hr>

...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
<td><a type="submit" class="btn btn-danger btn-sm" href="pdf_triage.php?tri=<?php echo $f['id_triage']?>&id=<?php echo $f['id_atencion'];?>&id_med=<?php echo $id_usua ?>&rec=<?php echo $id_rec_urgen ?>"target="_blank"><span class="fa fa-file-pdf-o"style="font-size:28px"></span></a></td>

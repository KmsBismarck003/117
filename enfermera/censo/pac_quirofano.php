...
<div class="container ">
        ...
        <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
                     <tr><strong><center>ENVIAR PACIENTE A QUIROFANO</center></strong>
                </div>
...
<?php if($area=="HOSPITALIZACION" || $area=="HOSPITALIZACIÓN" || $area=="TERAPIA INTENSIVA"|| $area=="OBSERVACIÓN" || $area=="OBSERVACION") {?>
...
<div class="container">
  <div class="row">
    ...
    <strong> Enviar paciente a quirofano</strong>
    </div>
    <div class="col-sm">
    <button class="btn btn-success btn-sm col-4" name="quir">Enviar</button>
    </div>
  </div>
</div>
</form>
<?php }else{ ?>
 ...
 <strong>El paciente: <?php echo $pac_papell . ' ' . $pac_sapell . ' ' . $pac_nom_pac ?> ya se encuentra en QUIROFANO</strong>
</div>
...
if(isset($_POST['quir'])){
$sql2 = "UPDATE dat_ingreso SET area = 'QUIROFANO' WHERE id_atencion = $id_atencion";
        $result = $conexion->query($sql2);
 echo '<script type="text/javascript">window.location.href = "pac_quirofano.php";</script>';
}
?>

    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-12">
                ...
                <div class="row">
                    <div class="col-6"><a href="dispo_camas_enf.php"><button type="button" class="btn btn-primary col-md-5" data-target="#exampleModal">
                ...
                <table class="table table-responsive table-hover">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                <td scope="row" id="letra" align="center"><a href="../censo/dispo_camas_asigna.php?id_atencion=<?php echo $f['id_atencion']; ?>"><strong> <button type="button" class="btn btn-danger"> <i class="fa fa-bed" aria-hidden="true"></i> </button></td>
                                <td><?php echo $f['Id_exp']; ?></td>
                                <td><?php echo $f['nom_pac'].' '.$f['papell'].' '.$f['sapell']; ?></td>

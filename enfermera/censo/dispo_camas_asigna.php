...
<head>
 ...
 <div>
<center><a href="../censo/vista_habitacion.php" class="btn btn-danger">Regresar...</a><hr>  
</div>  
<h3><strong>ELEGIR HABITACIÓN LIBRE PARA ASIGNAR PACIENTE</strong></h3>

  <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
         <tr><strong><center>HOSPITALIZACIÓN</center></strong>
  </div>
        ...
        ?>
            <div class="col-lg-1.9 col-xs-4">
              <div class="alert alert-success" role="alert">
                <h7><font size="2">HABITACIÓN: <?php echo $num_cama ?></font></h7>
                <br>
                <h7><font size="2"><?php echo $estaus ?></font></h7><br>
                <a href="asig_cama.php?id_atencion=<?php echo $id_atencion ?>&&id_cam=<?php echo $row['id'] ?>&&id_usua= <?php echo $id_usua; ?>" class="small-box-footer">ASIGNAR<i class="fa  fa-check"></i></a>
                <br/>
              </div>
            </div>
          <?php
          ...
          ?>
            <div class="col-lg-1.9 col-xs-4">
              <div class="alert alert-danger" role="alert">
                <h8><font size="2">HABITACIÓN: <?php echo $num_cama ?></font></h8><br>
              <!--  <h7>Estatus: OCUPADA</h7>-->
                <?php
                $sql_pac = "SELECT p.nom_pac, p.papell,p.sapell, di.Id_exp from dat_ingreso di, paciente p, cat_camas cc where $id_atencion_cam = di.id_atencion and di.Id_exp = p.Id_exp";
                ...
                <br/>
                <a href="../../gestion_medica/hospitalizacion/select_pac.php?id_atencion=<?php echo $id_atencion ?>" class="small-box-footer"><i style="font-size:15px;" class="fa fa-bed"></i></a>
              </div>
            </div>
        <?php
          }
    ...
    <div class="container box col-12">
        ...
        ?>
          ...
          ?>
            <div class="col-lg-1.5 col-xs-1">
              <div class="alert alert-danger" role="alert">
                <h7><font size="2">HABITACIÓN: <?php echo $num_cama ?></font></h7><br>
              <!--  <h7>Estatus: OCUPADA</h7>-->
                <?php
                $sql_pac = "SELECT p.nom_pac, p.papell,p.sapell, di.Id_exp from dat_ingreso di, paciente p, cat_camas cc where $id_atencion_cam = di.id_atencion and di.Id_exp = p.Id_exp";
                $result_pac = $conexion->query($sql_pac);
...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
         <tr><strong><center>TERAPIA INTENSIVA</center></strong>
   </div>
 <div class="container box col-12">
        <div class= "row">
...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
         <tr><strong><center>OBSERVACIÓN</center></strong>
   </div>
 <div class="container box col-12">
        <div class= "row">

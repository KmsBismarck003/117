...
<div class="container box">
  <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
            ...
            <table class="table table-bordered table-striped" id="mytable">
              <thead class="thead">
                <tr>
                  ...
                  <th scope="col">
                    <center>Motivo de atención</center>
                  </th>
                  <th scope="col">
    ...
    <div class="container box">
      <div class="container-fluid">
        <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 18px;">
                     <tr><center><strong>TERAPIA INTENSIVA</strong></center><p>
        </div>
        ...
        <div class="row">
          ...
          <!--<div class="col-md-5">
            <a href="../../gestion_administrativa/censo/pdf_censo_ter.php" class="btn btn-md btn-md btn-block btn-success" target="_blank">IMPRIMIR CENSO DE TERAPIA INTENSIVA Y UCIN </a>
          </div>-->
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                <tr>
                  <?php
                  $sql = "SELECT * from cat_camas where TIPO ='TERAPIA INTENSIVA' ORDER BY num_cama ASC ";
                  $result = $conexion->query($sql);
                  while ($row = $result->fetch_assoc()) {
                    $id_at_cam = $row['id_atencion'];
                    $estatus = $row['estatus'];
    ...
    <div class="container box">
      <div class="container-fluid">
        <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 18px;">
                     <tr><center><strong>OBSERVACIÓN</strong></center><p>
        </div>
        ...
        <!--  <div class="col-md-4">
            <a href="../../gestion_administrativa/censo/pdf_censo_urg.php" class="btn btn-md btn-md btn-block btn-success" target="_blank">IMPRIMIR CENSO DE OBSERVACIÓN</a>
          </div>-->
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                <tr>
                  <?php
                  $sql = "SELECT * from cat_camas where TIPO ='OBSERVACION' AND SECCION = 1 ORDER BY num_cama ASC ";
                  $result = $conexion->query($sql);
                  while ($row = $result->fetch_assoc()) {
                    $id_at_cam = $row['id_atencion'];
                    $estatus = $row['estatus'];
      ...
      <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 18px;">
                     <tr><center><strong>SALA DE CHOQUE</strong></center><p>
        </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="mytable">
              ...
              <tbody>
                <tr>
                  <?php
                  $sql = "SELECT * from cat_camas where TIPO ='OBSERVACION' AND SECCION = 2 ORDER BY num_cama ASC ";
                  $result = $conexion->query($sql);
                  while ($row = $result->fetch_assoc()) {
                    $id_at_cam = $row['id_atencion'];
                    $estatus = $row['estatus'];

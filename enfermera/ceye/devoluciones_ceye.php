...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
    <tr><strong><center>DEVOLUCIÓNES QUIRÓFANO PENDIENTES</center></strong>
    </div><br>
            </center>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    $resultado2 = $conexion->query("SELECT * FROM material_ceye i, devolucion_ceye d, item_type it WHERE i.material_id = d.dev_producto and d.dev_estatus = 'SI' and it.item_type_id=i.material_tipo") or die($conexion->error);
                    while ($row = $resultado2->fetch_assoc()) {
                        $id_dev = $row['id_dev_ceye'];
                        ...
                        echo '<tr>'
                            ...
                            . '<td> <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#exampleModal'.$row['id_dev_ceye'].'">
  <span class = "fa fa-check"></span>
</button></td>'
. '<td><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalLong'.$row['id_dev_ceye'].'">
  <span class = "fa fa-check"></span>
</button> </td>'
      .' </td>
                            <!-- Modal -->
<div class="modal fade" id="exampleModal'.$row['id_dev_ceye'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <input type="text" name="id_dev" value="'.$row['id_dev_ceye'].'">
...
<div class="modal fade" id="exampleModalLong'.$row['id_dev_ceye'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">

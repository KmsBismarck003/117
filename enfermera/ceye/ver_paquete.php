    ...
    <div class="row">
        ...
        <div class="col  col-12">
            <h2>
                ...
                <center><font id="letra"><i class="fa fa-plus-square"></i>Información del  Paquete: <?php echo  $nombre_paq ?></font></center>
            </h2>
            <hr>
        ...
        //    $resultado2 = $conexion->query("SELECT id_serv, serv_cve, serv_costo, serv_umed,serv_activo FROM cat_servicios") or die($conexion->error);
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    <tbody>
                    <?php
                    $sql = 'SELECT  material_nombre, cantidad FROM paquetes_ceye p, material_ceye m where m.material_id=p.material_id and p.nombre = "'.$nombre_paq.'"';

...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col  col-12">
            <h2>
                <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none">
                <i class="fa fa-bars" id="side"></i></a>
                <center><font id="letra"><i class="fa fa-plus-square"></i> Paquetes de Material Qx</font></center>
            </h2>
            <hr>
            <center><a type="submit" class="btn btn-primary" href="insert_paquete_ceye.php">Nuevo paquete</a></center>
        </div>
    </div>
</div>

...
<section class="content container-fluid">
        ...
        <div class="content">
          <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
            <strong><center>EXISTENCIAS DE QUIRÓFANO</center></strong>
          </div>
      <p>
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <tbody>
             ...
             $resultado2 = $conexion->query("SELECT * FROM material_ceye, stock_ceye, item_type where  item_type.item_type_id=material_ceye.material_tipo and material_ceye.material_id = stock_ceye.item_id and stock_ceye.stock_qty > 0 ORDER BY material_ceye.material_nombre ASC") or die($conexion->error);
                $no = 1;

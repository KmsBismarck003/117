         ...
         <strong><center>PACIENTES CON MEDICAMENTOS PENDIENTES DE SURTIR</center></strong>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="mytable">
                   ...
                   // $query = "SELECT DISTINCTROW di.id_atencion, p.nom_pac, p.papell, p.sapell, p.Id_exp, u.papell as papell_usua,ca.id_atencion,ca.num_cama from cart_ceye c, dat_ingreso di, paciente p, reg_usuarios u, cat_camas ca WHERE c.paciente = di.id_atencion and di.Id_exp = p.Id_exp AND u.id_usua = c.id_usua and ca.id_atencion=di.id_atencion ";
                    
                    $resultado = $conexion->query("SELECT DISTINCTROW di.id_atencion, p.nom_pac, p.papell, p.sapell, p.Id_exp, u.papell as papell_usua,ca.id_atencion,ca.num_cama from cart_ceye c, dat_ingreso di, paciente p, reg_usuarios u, cat_camas ca WHERE c.paciente = di.id_atencion and di.Id_exp = p.Id_exp AND u.id_usua = c.id_usua and ca.id_atencion=di.id_atencion") or die($conexion->error);

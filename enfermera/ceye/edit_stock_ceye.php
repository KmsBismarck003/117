  ...
  <section class="content container-fluid">
    <div class="container box">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            $sql = "SELECT * FROM material_ceye, stock_ceye where material_ceye.material_id = stock_ceye.material_id and stock_ceye.stock_qty != 0 and stock_id = $id";
            ...
            ?>
              <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input disabled value="<?php echo $row_datos['material_nombre'] ?>">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-3 col-sm-9">
                      <a href="../Ceye/perfilmaterial_ceye.php" class="btn btn-danger">Cancelar</a>
      ...
      if (isset($_POST['edit'])) {
        ...
        $sql2 = "SELECT * FROM stock_ceye where stock_id = $id";
        $result = $conexion->query($sql2);

        while ($row_stock = $result->fetch_assoc()) {
          $stock = $row_stock['stock_qty'];
          $material_id = $row_stock['material_id'];
          $stock_max = $row_stock['stock_min'];

        }

        $stock_final = $stock + $stock_cantidad;

      if ($stock_final <= $stock_max) {


        $sql3 = "UPDATE stock_ceye set stock_qty=$stock_final where stock_id = $id";

        $result3 = $conexion->query($sql3);

        $sql4 = 'insert into entradas_ceye (entrada_material,entrada_qty,entrada_expiry,entrada_purchased,fecha)values(' . $material_id . ',' . $stock_cantidad . ',"' . $stock_caducidad . '","' . $stock_lote . '","' . $fecha_actual . '")';
       //  echo $sql4;
        $result4 = $conexion->query($sql4);
       echo '<script type="text/javascript">window.location ="perfilmaterial_ceye.php"</script>';

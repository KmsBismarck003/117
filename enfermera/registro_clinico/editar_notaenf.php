  ...
  <section class="content container-fluid">
    <div class="container box">
      <div class="container-fluid">
            ...
            $sql = "SELECT * from nota_enf_hosp where id_nota_enf  = $id";
  ...
  <option value="8">8:00 A.M.</option>
    ...
    <div class="col-sm-7">
      <div class="form-group">
                  ...
                  <textarea name="notaenf" class="form-control" rows="7"><?php echo $row_datos['notaenf']; ?></textarea>
...
$turno="MATUTINO";
  ...
  $turno="VESPERTINO";
    ...
    $turno="NOCTURNO";
        ...
        $sql2 = "UPDATE nota_enf_hosp SET fecha = '$fecha',hora = '$hora',turno = '$turno',notaenf = '$notaenf' WHERE id_nota_enf = $id";

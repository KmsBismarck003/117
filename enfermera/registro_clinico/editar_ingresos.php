      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            $sql = "SELECT * from ing_enf_quir where id_ing = $id";
...
<div class="container">
  ...
  <option value="7">7:00 A.M.</option>
   ...
   <div class="form-group">
    ...
    <select class="form-control" name="des" style="width : 100%; heigth : 100%" required="">
        <option value="<?php echo $row_datos['des']; ?>"><?php echo $row_datos['des']; ?></option>
  ...
  <option value="INFUSIONES">INFUSION 1</option>
  <option value="INFUSION 2">INFUSION 2</option>
  <option value="INFUSION 3">INFUSION 3</option>
  <option value="INFUSION 4">INFUSION 4</option>
  <option value="INFUSION 5">INFUSION 5</option>
...
<br>
 ...
 $fecha    = mysqli_real_escape_string($conexion, (strip_tags($_POST["fecha"], ENT_QUOTES)));
        ...
        $des    = mysqli_real_escape_string($conexion, (strip_tags($_POST["des"], ENT_QUOTES))); 
        $cantidad    = mysqli_real_escape_string($conexion, (strip_tags($_POST["cantidad"], ENT_QUOTES))); 

        $sql2 = "UPDATE ing_enf_quir SET hora = '$hora', des = '$des',cantidad = '$cantidad',fecha = '$fecha' WHERE id_ing = $id";

      ...
      <div class="container-fluid">
          ...
          <div>
            <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
                <tr><strong><center>EDITAR MONITOREO</center></strong>
            </div>
            <br>
            <?php
            $id = $_GET['id_mon_s'];

            $sql = "SELECT * from monitoreo_sust where id_mon_s = $id";
  ...
  <option value="7">7:00 A.M.</option>
   ...
   <div class="form-group">
                  <label for="cantidad">Cantidad:</label>
                   <input type="text" size="30" name="cantidad"  id="cantidad" class="form-control" 
...
<div class="col-sm-6">
      <div class="form-group">
                  ...
                  <textarea name="obs" rows="1" id="obs" class="form-control" required><?php echo $row_datos['obs']; ?></textarea>
                </div>
    </div>
...
$obs    = mysqli_real_escape_string($conexion, (strip_tags($_POST["obs"], ENT_QUOTES))); 
        ...
        $sql2 = "UPDATE monitoreo_sust SET hora='$hora', tipo = '$tipo',cantidad = '$cantidad',obs = '$obs' WHERE id_mon_s = $id";

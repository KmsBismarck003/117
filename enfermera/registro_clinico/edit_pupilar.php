      ...
      <div class="container-fluid">
          ...
          <div>
            <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
                <tr><strong><center>EDITAR DIÁMETRO PUPILAR</center></strong>
            </div>
            <br>
            <?php
            $id = $_GET['id_mon_s'];

            $sql = "SELECT * from d_pupilar where id_pupilar = $id";
...
<div class="container">
  <div class="row">
      ...
      <input type="date" name="fecha" class="form-control" value="<?php echo $row_datos['fecha_reporte']; ?>">
    </div>
<div class="col-sm-2">
  <label>Hora:</label>
  ...
  <option value="7">7:00 A.M.</option>
    ...
    <div class="col-sm-4">
     <div class="form-group">
                  <label for="tipo">Lado:</label>
                <select name="lado" id="tipo" class="form-control" required>
         <option value="<?php echo $row_datos['tipo']; ?>"><?php echo $row_datos['lado']; ?></option>
   ...
   <div class="form-group">
                  <label for="cantidad">Tamaño:</label>
                   <input type="text" size="30" name="tamano"  id="cantidad" class="form-control" 
                  value="<?php echo $row_datos['tamano']; ?>" required>
                </div>
    </div>
...
$fecha    = mysqli_real_escape_string($conexion, (strip_tags($_POST["fecha"], ENT_QUOTES))); 
        ...
        $sql2 = "UPDATE d_pupilar SET hora='$hora', lado = '$lado',tamano = '$tamano',fecha_reporte = '$fecha' WHERE id_pupilar = $id";

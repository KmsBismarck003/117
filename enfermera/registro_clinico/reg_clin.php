...
#n{
 position: relative;
top: -450px; left: 940px;
     
}

 #a{
 position: relative;
top: -330px; left: 855px;
     
}

#m{
 position: relative;
top: -220px; left: 771px;
     
}

#i{
 position: relative;
top: -100px; left: 685px;
...
border:1px solid steelblue;
 ...
 .es{
       background:url(../../imagenes/0.png) no-repeat;
       }
    ...
    ?>
      <div class="container">
        ...
        <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 25px;">
                 <tr><strong><center>REGISTRO DE HOSPITALIZACIÓN - ENFERMERÍA</center></strong>
        </div>
         <hr>
 <font size="2">
         <div class="container">
...
<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-diurno" role="tab" aria-controls="nav-contact" aria-selected="false"><h6>SIGNOS<p>VITALES</h6></a>
    <a class="nav-item nav-link" id="nav-home2-tab" data-toggle="tab" href="#nav-home2" role="tab" aria-controls="nav-home2" aria-selected="true"><h6>INGRESOS</h6></a>
    <a class="nav-item nav-link" id="nav-profile-tab2" data-toggle="tab" href="#nav-profile2" role="tab" aria-controls="nav-profile" aria-selected="false"><h6>EGRESOS</h6></a>
    <a class="nav-item nav-link" id="nav-cate-tab" data-toggle="tab" href="#cate" role="tab" aria-controls="cate" aria-selected="true"><h6>CONTROL<p>CATÉTERES</h6></a> 

 <a class="nav-item nav-link" id="nav-cate-mon" data-toggle="tab" href="#mon" role="tab" aria-controls="mon" aria-selected="true"><h6>VALORACIÓN<p>PARA CUIDADOS ESPECIFICOS DE<br> SEGURIDAD Y PROTECCIÓN</h6></a>

    <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><h6>VALORACIONES<br>Y ESCALAS</h6></a>
    
    <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false"><h6>NOTAS DE ENFERMERIA</h6></a>
...
<div class="tab-pane fade" id="mon" role="tabpanel" aria-labelledby="nav-cate-tab">
  <form action="" method="POST">
<div class="table-responsive">
<table class="table table-bordered">
  <thead>
     <tr class="table-warning">
      <th colspan="18"><center><h5><strong>VALORACIÓN PARA CUIDADOS ESPECIFICOS DE SEGURIDAD Y PROTECCIÓN</strong></h5></center></th>
    </tr>
           ...
           <option value="Glicemia capilar">Glicemia capilar</option>
            ...
            <option value="Dextrosa">Dextrosa al 50%</option>
             <option value="Oxigenoterapia">Oxigenoterapía</option>
               ...
               <option value="Neurologico">Glasgow</option>
...
$fech_a = date("Y-m-d");
   $ingresar4 = mysqli_query($conexion, 'INSERT INTO monitoreo_sust (id_atencion,id_usua,hora,tipo,cantidad,obs,fecha_registro,fecha) values ('.$id_atencion.',' . $id_usua . ',"' . $hora . '","' . $tipo . '","'.$cantidad.'","'.$obs.'","'.$fr.'","'.$fecha.'") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));

      echo '<script type="text/javascript">window.location.href = "reg_clin.php";</script>';
    }
    ?>
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from monitoreo_sust WHERE id_atencion=$id_atencion ORDER BY id_mon_s DESC") or die($conexion->error);
$usuario = $_SESSION['login'];
?>
...
<td><a href="edit_mon_hosp.php?id_mon_s=<?php echo $f['id_mon_s'];?>&id_atencion=<?php echo $f['id_atencion'];?>"><button type="button" class="btn btn-warning"><i class="fas fa-edit"></i></button></td>

<td><a href="el_mon_hosp.php?id_mon_s=<?php echo $f['id_mon_s'];?>&id_atencion=<?php echo $f['id_atencion'];?>"><button type="button" class="btn btn-danger">X </button></td>
...
$fecha_registro = date("Y-m-d H:i");
   ...
   $ingresar4 = mysqli_query($conexion, 'INSERT INTO d_pupilar (id_atencion,id_usua,hora,lado,tamano,fecha_registro,fecha_reporte) values ('.$id_atencion.',' . $id_usua . ',"' . $hora . '","' . $lado . '","'.$tamano.'","'.$fecha_registro.'","'.$fecha.'") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from d_pupilar WHERE id_atencion=$id_atencion ORDER BY id_pupilar DESC") or die($conexion->error);
$usuario = $_SESSION['login'];
?>
...
<table class="table table-bordered">
  <thead>
    ...
    <tr class="table-active">
      ...
      <th scope="col" colspan="9">Fecha de instalación</th>
       <th scope="col" colspan="2">Instalo</th>
  ...
  <tbody>
    <tr>
      <th scope="row" colspan="1">  <select name="dispositivos" class="form-control" required>
        <option value="">Seleccionar dispositivo</option>
...
<td colspan="1"><textarea name="cultivo" class="form-control">
    </textarea></td></tr>
</tbody>
</table>
</div>
...
$fr = date("Y-m-d H:i");
   $ingresar4 = mysqli_query($conexion, 'INSERT INTO cate_enf_hosp (id_atencion,id_usua,dispositivos,tipo,fecha_inst,instalo,dias_inst,fecha_cambio,cultivo,fecha_registro) values ('.$id_atencion.',' . $id_usua . ',"' . $dispositivos .'","' . $tipo . '","'.$fecha_inst.'","'.$instalo.'","'.$dias_inst.'","'.$fecha_cambio.'","'.$cultivo.'","'.$fr.'") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from cate_enf_hosp WHERE id_atencion=$id_atencion ORDER BY id_cateh DESC") or die($conexion->error);
$usuario = $_SESSION['login'];
?>
...
<table class="table table-bordered table-striped" id="mytable3">
    ...
    <tr class="table-success">
      ...
      <th scope="col">Fecha de instalación</th>
       <th scope="col">Instalo</th>
      <th scope="col">Dias instalado</th>
...
<td><a href="edit_cate_hosp.php?id_cateh=<?php echo $f['id_cateh'];?>&id_atencion=<?php echo $f['id_atencion'];?>"><button type="button" class="btn btn-warning"><i class="fas fa-edit"></i></button></td>

<td><a href="el_cate_hosp.php?id_cateh=<?php echo $f['id_cateh'];?>&id_atencion=<?php echo $f['id_atencion'];?>"><button type="button" class="btn btn-danger">X </button></td>
...
<form action="" method="POST">
 <div class="container">
  ...
  <option value="INFUSIONES">INFUSIONES 1</option>
  <option value="INFUSION 2">INFUSIONES 2</option>
  <option value="INFUSION 3">INFUSIONES 3</option>
  <option value="INFUSION 4">INFUSIONES 4</option>
  <option value="INFUSION 5">INFUSIONES 5</option>
...
$fe = date("Y-m-d");
   $ingresar2 = mysqli_query($conexion, 'INSERT INTO ing_enf_quir (id_atencion,id_usua,hora,des,cantidad,fecha,fecha_registro) values ('.$id_atencion.',' . $id_usua . ',"' . $hora_med .'","' . $desc . '","'.$cantidad.'","'.$fecha.'","'.$yesterday.'") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
...
<?php
$resultado3 = $conexion->query("SELECT SUM(cantidad) as can from ing_enf_quir WHERE id_atencion=$id_atencion and neonato!='Si' ORDER BY id_ing DESC") or die($conexion->error);
?>
...
<table class="table table-bordered table-striped" id="mytable3">
    ...
    <tr class="table-danger">
      ...
      <th scope="col" colspan="4"><center><strong><?php echo $f3['can'] . " ML "?></strong></center></th>
...
?> 
  ...
  <!--INICIO egresos-->
  <div class="tab-pane fade" id="nav-profile2" role="tabpanel" aria-labelledby="nav-home2-tab">  
<!--EGRESOS-->
<form action="" method="POST">
 <div class="container">
    <div class="row">
  ...
  <option value="PENROSE">PENROSE IZQUIERDO</option>
...
if ($hora_eg == '1' || $hora_eg == '2' || $hora_eg == '3' || $hora_eg == '4' || $hora_eg == '5' || $hora_eg == '6' || $hora_eg == '7') {
   ...
   $ingresar2 = mysqli_query($conexion, 'INSERT INTO eg_enf_quir (id_atencion,id_usua,hora_eg,des_eg,cant_eg,carac,fecha_eg,fecha_registro) values ('.$id_atencion.',' . $id_usua . ',"' . $hora_eg .'","' . $des_eg . '","'.$cant_eg.'","'.$carac.'","'.$fecha.'","'.$yesterday.'") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
...
<table class="table table-bordered table-striped" id="mytable4">
       <thead class="thead">
         <tr class="table-primary">
            <th colspan="8"><center><h5><strong>EGRESOS</strong></h5></center></th>
         </tr>
    <tr class="table-success">
      <th scope="col"><center>Fecha de registro</center></th>
       <th scope="col"><center>Fecha reporte</center></th>
...
<?php
$resultado3 = $conexion->query("SELECT SUM(cant_eg) as canteg from eg_enf_quir WHERE id_atencion=$id_atencion ORDER BY id_eg DESC") or die($conexion->error);
?>
...
<table class="table table-bordered table-striped" id="mytable3">
    ...
    <tr class="table-danger">
      ...
      <th scope="col" colspan="1"><center>Subtotal:</center></th>
      <th scope="col" colspan="4"><center><strong><?php echo $f3['canteg'] . " ML "?></strong></center></th>
...
<form action="insertar_enf_regclin.php" method="POST">
<br>
  <?php
     // date_default_timezone_set('America/Guatemala');
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      <input type="date" value="<?php echo $fecha_actual = date("Y-m-d") ?>" name="fechareporte" class="form-control" required>
    </div>
  </div>
</div>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-3">
      <strong>Hora:</strong>
      <select class="form-control" aria-label="Default select example" name="hora_mat" required="">
  <option value="">Seleccionar hora</option>
  <option value="8">8:00 A.M.</option>
  <option value="9">9:00 A.M.</option>
  <option value="10">10:00 A.M.</option>
...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
    ...
    <div class="col-sm-6">
         <label for="sol_estudios"><strong><button type="button" class="btn btn-success btn-sm" id="playdi"><i class="fas fa-play"></button></i> Dieta:</strong></label>
      <?php 
  $sql_d = "SELECT dieta FROM dat_ordenes_med WHERE id_atencion='$id_atencion' order by id_ord_med DESC limit 1";
                            ...
                            ?>
                            <input type="text" class="form-control" name="tipodieta_mat" id="txtdta" value="<?php echo $row_d['dieta']; ?>" disabled>
<?php 
...
const txtdta = document.getElementById('txtdta');
const btntipd = document.getElementById('playdi');
btntipd.addEventListener('click', () => {
        leerTexto(txtdta.value);
});
function leerTexto(txtdta){
...
<table class="table table-bordered">
  <thead>
     <tr class="table-warning">
      <th colspan="5"><center><h5><strong>VALORACIÓN NEUROLÓGICA</strong></h5></center></th>
    </tr>
  ...
  <tbody>
    <tr>
      ...
      <td class="col-sm-5">Espontáneamente <br>
        A una orden verbal<br>
        Al dolor<br>
      Sin respuesta</td>

      <td><center>4<br> 3<br>2<br> 1</center></td>
   <td><br><center><div class="losInputn"><input type="text" name="apecular_mat" class="form-control" maxlength="1" onkeypress='return event.charCode >= 49 && event.charCode <= 52'></div></center></td>
     
   
    </tr>
    <tr>
      <th scope="row"><center><br><br>Mejor respuesta motora</center></th>
      <td>A una orden verbal obedece<br>
        Localiza el dolor<br>
        Retirada y flexión al dolor<br>
        Flexión anormal (rigidez de descorticación)<br>
      Extensión (rigidez de descerebración)<br>
    No responde</td>
      <td><center>6<br>5<br>4<br>3<br>2<br>1</center></td>
        <td><br><br><center><div class="losInputn"><input type="text" name="respmot_mat" class="form-control" maxlength="1" onkeypress='return event.charCode >= 49 && event.charCode <= 54'></center></div></td>
      
    </tr>
    <tr>
      <th scope="row"><center><br><br>Mejor respuesta verbal</center></th>
      <td>Orientado y conversado<br>
        Desorientado y hablando<br>
        Palabras inapropiadas<br>
        Sonidos incomprensibles<br>
      Ninguna respuesta</td>
      <td><center>5<br>4<br>3<br>2<br>1</center></td>
         <td><br><center><div class="losInputn"><input type="text" name=" respver_mat" class="form-control" maxlength="1" onkeypress='return event.charCode >= 49 && event.charCode <= 53'></div></center></td>
      
    </tr>
     <th colspan="2"></th>
      <th colspan="1"><center><h5><strong>Total:</strong></h5></center></th>
 <th colspan="1"><center> <div class="inputTotaln"><input type="text" class="form-control" disabled></div>
  </tbody>
</table>
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      ...
      <td class="col-sm-1"><div class="losInput"><input type="text" name="caidprev_mat" class="form-control" maxlength="1"onkeypress='return event.charCode >= 48 && event.charCode <= 49' max="1"></div></td>
       
    </tr>
    <tr>
      <th scope="row"><center><br><br><br>Medicamentos</center></th>
      <td>Ninguno<br>Tranquilizantes-Sedantes<br>Diuréticos<br>Hipotensores(no diuréticos)<br>Antiparksonianos<br>Antidepresivos<br>Otros medicamentos</td>
      <td><center>0<br>1<br>1<br>1<br>1<br>1<br>1</center></td>
     <td><br><br><br><div class="losInput"><input type="text" name="medcaidas_mat" class="form-control" maxlength="1"onkeypress='return event.charCode >= 48 && event.charCode <= 54' max="21" min="0"></div></td>
    </tr>
    <tr>
      ...
      <td><center>0<br>1<br>1<br>1</center></td>
        <td><br><div class="losInput"><input type="text" name="defsens_mat" class="form-control" maxlength="1"onkeypress='return event.charCode >= 48 && event.charCode <= 51'></div></td>
    </tr>
    <tr>
      <th scope="row"><center>Estado mental</center></th>
      <td>Orientado<br>Confuso</td>
      <td><center>0<br>1</center></td>
        <td><div class="losInput"><input type="text" name="edomental_mat" class="form-control" maxlength="1"onkeypress='return event.charCode >= 48 && event.charCode <= 49'></div></td>
    </tr>
    <tr>
      ...
      <td><center>0<br>1<br>1<br>1</center></td>
        <td><br><div class="losInput"><input type="text" name="deambula_mat" class="form-control" maxlength="1"onkeypress='return event.charCode >= 48 && event.charCode <= 51'></div></td>
    </tr>
     <tr>
      <th colspan="2"></th>
      <th colspan="1"><center><h5><strong>Total:</strong></h5></center></th>
      <th colspan="1"><center> <div class="inputTotal"><input type="text" name="totalcaidas_mat" class="form-control" disabled></div></center></th>
    </tr>


     <tr>
      <th colspan="2"><center><button type="button" class="btn btn-success btn-sm" id="plaen"><i class="fas fa-play"></button></i>
 Nombre de enfermera (o) que valora</center></th>
      <th colspan="3"><center><input type="text" name="nomenfermera_mat" id="txtnomm" class="form-control"></center></th>
    </tr>
<script type="text/javascript">
const txtnomm = document.getElementById('txtnomm');
const btnPlaymm = document.getElementById('plaen');
btnPlaymm.addEventListener('click', () => {
        leerTexto(txtnomm.value);
});
function leerTexto(txtnomm){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtnomm;
    speech.volume=1;
    speech.rate=1;
    ...
    window.speechSynthesis.speak(speech);
     ...
     <tr>
    <th colspan="1">Intervenciones / recomendaciones para prevención de riesgo de caída</th>
    <th colspan="3"><div class="botones">
...
<button type="button" class="btn btn-success btn-sm" id="playrec"><i class="fas fa-play"></button></i>
</div><center><textarea class="form-control" rows="2" name="riesgcaida_mat" id="texto"></textarea>
<script type="text/javascript">
const btnStartRecord = document.getElementById('btnStartRecord');
const btnStopRecord = document.getElementById('btnStopRecord');
const texto = document.getElementById('texto');

const btnPlayrecc = document.getElementById('playrec');
btnPlayrecc.addEventListener('click', () => {
...
<table class="table table-bordered">
  <thead>
    <tr class="table-warning">
   <th colspan="5"><center><h5><strong>ESCALA DE RIESGOS DE ULCERAS POR PRESIÓN (NORTON)</strong></h5></center></th>
 </tr>
</thead>
</table>
  <div class="row">
    <div class="col-sm-11">
      <img src="../../imagenes/escala_norton.jpg" width="900">
    </div><hr>
    <div class="col-sm-1"><br><p>
     <div class="losInput2"><input type="text" name="edofisico_mat" class="form-control" maxlength="1" onkeypress='return event.charCode >= 49 && event.charCode <= 52'></div>
    </div>
<div class="col-sm-1">
   <div class="losInput2"><input type="text" name="edomentalnor_mat" class="form-control" maxlength="1" onkeypress='return event.charCode >= 49 && event.charCode <= 52' id="n"></div>
  </div>
  <div class="col-sm-1">
<div class="losInput2"><input type="text" name="actividad_mat" class="form-control" maxlength="1" onkeypress='return event.charCode >= 49 && event.charCode <= 52' id="a"></div>
   </div>

 <div class="col-sm-1">
<div class="losInput2"><input type="text" name="movilidad_mat" class="form-control" maxlength="1" onkeypress='return event.charCode >= 49 && event.charCode <= 52' id="m"></div>
</div>
 <div class="col-sm-1">
<div class="losInput2"><input type="text" name="incont_mat" class="form-control" maxlength="1" onkeypress='return event.charCode >= 49 && event.charCode <= 52' id="i"></div>
</div>

 <div class="col-sm-1">
<div class="inputTotal2"><input type="text" name="totnorton_mat" class="form-control" disabled id="t"></div>
</div>
<br>
...
<div class="container">
  <div class="row">
    <div class="col-sm-4"><button type="button" class="btn btn-success btn-sm" id="playenf2"><i class="fas fa-play"></button></i>

     Nombre de enfermera (o) que valora
    </div>
    <div class="col-sm">
    
      <center><input type="text" name="nomenfnorton_mat" class="form-control" id="txt2n"></center>
    </div>
    
  </div>
</div>
<script type="text/javascript">
const txt2n = document.getElementById('txt2n');
const btnPlayenfer = document.getElementById('playenf2');
btnPlayenfer.addEventListener('click', () => {
        leerTexto(txt2n.value);
});
function leerTexto(txt2n){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txt2n;
    speech.volume=1;
    speech.rate=1;
  ...
  <div class="row">
    <div class="col-sm-4">
    <button type="button" class="btn btn-success btn-sm" id="playries"><i class="fas fa-play"></button></i>     Intervenciones de acuerdo al riesgo
    </div>
    <div class="col-sm">
    
    <center><input type="text" name="acriesg_mat" class="form-control" id="txtinar"></center>
    </div>
   <script type="text/javascript">
const txtinar = document.getElementById('txtinar');
const btnPlayrai = document.getElementById('playries');
btnPlayrai.addEventListener('click', () => {
        leerTexto(txtinar.value);
});
function leerTexto(txtinar){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtinar;
    speech.volume=1;
    speech.rate=1;
    ...
    <center><font size="2">Interpretación: <strong>5-11 puntos: Muy alto riesgo | 12-14 puntos: Riesgo evidente | mayor de 14 puntos: Riesgo minimo</strong></font></center>
</div>
</div>
</p>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
¿Que tipos de laboratorios se tomaron?
</div>
 <div class="col-sm-8">
     <input type="text" class="form-control" name="tiposlabo">
     </div>
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultadon = $conexion->query("SELECT * from nota_enf_hosp WHERE id_atencion=$id_atencion ORDER BY id_nota_enf DESC") or die($conexion->error);
$usuario = $_SESSION['login'];
?>
<table class="table table-bordered table-striped" id="mytable3">
       <thead class="thead">
...
<td><center><strong> <?php $fechr=date_create($f['fecha']); echo date_format($fechr,"d-m-Y");?></center></strong></td>
 ...
 <td><center><a href="editar_notaenf.php?id=<?php echo $f['id_nota_enf'];?>" title="Editar datos" class="btn btn-warning btn-sm "><span class="fa fa-edit" aria-hidden="true"></span></a></td></center>

 <td><center><a href="el_notanef.php?id=<?php echo $f['id_nota_enf'];?>" title="Eliminar dato" class="btn btn-danger btn-sm "><span class="fa fa-trash" aria-hidden="true"></span></a></td>
...
$ingresarnot = mysqli_query($conexion, 'INSERT INTO nota_enf_hosp (
  id_atencion,fecha,hora,turno,notaenf,id_usua,fecha_registro) values (' . $id_atencion . ' , "' . $fecha . '" , "' . $hora . '" , "' . $turno . '" , "' . $notaenf . '" ,' . $id_usua . ', "' . $yesterday . '") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
...
<!--INICIO signos viales (diurno antes)-->
...
$ingresarsignos = mysqli_query($conexion, 'INSERT INTO signos_vitales (
  id_atencion,id_usua,fecha,p_sistol,p_diastol,fcard,fresp,temper,satoxi,niv_dolor,hora,tipo,fecha_registro,tam) values (' . $id_atencion . ' , ' . $id_usua . ' ,"' . $fecha. '", "' . $sist_mat . '" , "' . $diast_mat . '" , "' . $freccard_mat . '" , "' . $frecresp_mat . '" , "' . $temper_mat . '", "' . $satoxi_mat . '","' . $niv_dolor . '",' . $hora_med . ',"' . $area . '","' . $fecha_actual . '","' .$tam . '") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
...
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT fecha,id_atencion,id_usua,hora,id_sig,p_sistol,p_diastol,fcard,fresp,temper,satoxi,niv_dolor, tipo,fecha_registro from signos_vitales s WHERE s.id_atencion=$id_atencion AND s.tipo='HOSPITALIZACION' group by fecha ORDER BY id_sig DESC") or die($conexion->error);
while($f = mysqli_fetch_array($resultado)){
       $id_usua=$f['id_usua'];
...
?>          
                    <tr>
<td class="fondo"><a href="../signos_vitales/signos_vitales_hosp.php?id_ord=<?php echo $f['id_sig'];?>&id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usua?>&fecha=<?php echo $f['fecha']?>&idexp=<?php echo $row_pac['Id_exp']?>"><button type="button" class="btn btn-danger"> <i class="fa fa-file-pdf-o" style="font-size:28px"  aria-hidden="true"></i> </button></td>
...
<!--TERMINO signos vitales (antes diurno)-->
...
$('.losInputTAMV input').on('change', function(){
  var total = 0;
  var sist, diast, tam;
  var string = "mmHG";
   sist=document.getElementById("sist").value;
   diast=document.getElementById("diast").value;
   $('.losInputTAMV input').each(function() {
    if($( this ).val() != "")
    {
   //parseInt(total= (sist+diast)); 
   total = total + parseInt($( this ).val()) /2;
  ...
  $('.inputTotalTAMV input').val(total.toFixed(0)+ " " +string );

});

$('.losInputTAMN input').on('change', function(){
  var total = 0;
  var sist, diast, tam;
  var string = "mmHG";
   sist=document.getElementById("sist").value;
   diast=document.getElementById("diast").value;
   $('.losInputTAMN input').each(function() {
    if($( this ).val() != "")
    {
   //parseInt(total= (sist+diast)); 
   total = total + parseInt($( this ).val()) /2;
  ...
  $('.inputTotalTAMN input').val(total.toFixed(0)+ " " +string );
  ...
  $('.inputTotal12 input').val(total.toFixed());
   ...
   $('.losInputn input').on('change', function(){
  var total = 0;
  $('.losInputn input').each(function() {
    if($( this ).val() != "")
    {
      total = total + parseFloat($( this ).val());
    }
  });
  $('.inputTotaln input').val(total.toFixed());
});
...
$('.losInputn3 input').on('change', function(){
  var total = 0;
  $('.losInputn3 input').each(function() {
    if($( this ).val() != "")
    {
      total = total + parseFloat($( this ).val());
    }
  });
  $('.inputTotaln3 input').val(total.toFixed());
});
    </script>
</body>
</html>
...
<body>
 ...
 <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
        ...
        <div class="row">
            ...
            $sql = "SELECT * from eg_enf_quir where id_eg = $id";
  ...
  <option value="ESTOMAS">ILEOSTOMIAS</option>
    ...
    <div class="col-sm">
      <div class="form-group">
                  ...
                  <textarea name="carac" class="form-control" required><?php echo $row_datos['carac']; ?></textarea>
                </div>
    </div>
  </div>
</div>
...
$carac    = mysqli_real_escape_string($conexion, (strip_tags($_POST["carac"], ENT_QUOTES)));
        ...
        $sql2 = "UPDATE eg_enf_quir SET hora_eg = '$hora_eg', des_eg = '$des_eg',cant_eg = '$cant_eg',carac='$carac',fecha_eg='$fecha' WHERE id_eg = $id";

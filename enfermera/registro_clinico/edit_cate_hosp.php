      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div>
            ...
            $sql = "SELECT * from cate_enf_hosp where id_cateh = $id";
...
$cultivo    = mysqli_real_escape_string($conexion, (strip_tags($_POST["cultivo"], ENT_QUOTES))); 
        ...
        $sql2 = "UPDATE cate_enf_hosp SET dispositivos = '$dispositivos', tipo = '$tipo',fecha_inst = '$fecha_inst',instalo = '$instalo',dias_inst = '$dias_inst',fecha_cambio = '$fecha_cambio',cultivo = '$cultivo' WHERE id_cateh = $id";

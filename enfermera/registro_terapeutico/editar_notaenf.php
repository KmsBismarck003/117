  ...
  <section class="content container-fluid">
    <div class="container box">
      <div class="container-fluid">
            ...
            $sql = "SELECT * from nota_enf_ter where id_nota_ter  = $id";
  ...
  <option value="8">8:00 A.M.</option>
    ...
    <div class="col-sm-7">
      <div class="form-group">
                  ...
                  <textarea name="notaenf" class="form-control" rows="7"><?php echo $row_datos['nota']; ?></textarea>
...
$turno="MATUTINO";
  ...
  $turno="VESPERTINO";
    ...
    $turno="NOCTURNO";
        ...
        $sql2 = "UPDATE nota_enf_ter SET fecha = '$fecha',hora = '$hora',turno = '$turno',nota = '$notaenf' WHERE id_nota_ter = $id";

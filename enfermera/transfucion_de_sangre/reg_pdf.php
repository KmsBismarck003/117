        ...
        <div class="row">
                ...
                <center>
                    <h5>
                        <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"
                                                                                                      id="side"></i></a>
                       <strong><font id="letra">Datos de Transfusiones</font></h5></strong> 
                    <hr>
                </center>
                ...
                <div class="table-responsive">
                    ...
                    while ($f = mysqli_fetch_array($resultado)) {
                        ...
                        <tr> 
   <td scope="row" id="letra" align="center"><a href="../transfucion_de_sangre/pdf_transf.php?Id_exp=<?php echo $f['Id_exp']; ?>&id_atencion=<?php echo $f['id_atencion']; ?>"><button type="button" class="btn-danger "><i class="fa fa-file-pdf-o"

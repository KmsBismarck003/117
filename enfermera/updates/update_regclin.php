...
-->
  ...
  <style type="text/css">
    ...
    #n{
 position: relative;
top: -470px; left: 990px;
     
}

 #a{
 position: relative;
top: -355px; left: 900px;
     
}

#m{
 position: relative;
top: -240px; left: 810px;
     
}

#i{
 position: relative;
top: -115px; left: 720px;
    ...
    ?>
      <div class="container">
        ...
        <div class="thead" style="background-color: #0c675e; color: white; font-size: 25px;">
                 <tr><strong><center>REGISTRO CLÍNICO DE ENFERMERÍA</center></strong>
        </div>
         <hr>
 <font size="2">
         <div class="container">
...
$result_hab = $conexion->query($sql_hab);                                                                                    while ($row_hab = $result_hab->fetch_assoc()) {
 ...
 <font size="2">
  ...
  <?php  $edad = calculaedad($pac_fecnac); ?> 
  <div class="container">
  <div class="row">
    <div class="col-sm-3">
...
$result_mot = $conexion->query($sql_mot);                                                                                    while ($row_mot = $result_mot->fetch_assoc()) {
 ...
 <font size="2">
  ...
  <div class="row">
    ...
    <div class="col-sm">
      EDO DE CONCIENCIA: <strong><?php $sql_edo = "SELECT edo_salud from dat_ingreso where id_atencion=$id_atencion ORDER by edo_salud DESC LIMIT 1";
...
<?php 
$id_clinreg=$_GET['id_clinreg'];
$select="SELECT * FROM enf_reg_clin where id_clinreg=$id_clinreg";
...
<th><h5><strong>NOTAS DE ENFERMERIA</strong></h5></th>
<textarea rows="3" class="form-control" name="notenferm_mat" rows="20"><?php echo $row['notenferm_mat'] ?></textarea>
<br>
...
<?php } ?>
 <?php 
  if (isset($_POST['guardar'])) {
        ...
        $notenferm_mat    = mysqli_real_escape_string($conexion, (strip_tags($_POST["notenferm_mat"], ENT_QUOTES)));
...
$sql2 = "UPDATE enf_reg_clin SET notenferm_mat='$notenferm_mat' WHERE id_clinreg=$id_clinreg";

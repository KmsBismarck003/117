...
<div class="container ">
        ...
        <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
                 <tr><strong><center>HOJA DE IRRIGACIÓN</center></strong>
            </div>
...
<form action="" method="POST">
 <div class="container">
    <div class="row">
       ...
       <thead class="thead">
         <tr class="table-primary">
            <th colspan="8"><center><h5><strong>HOJA DE IRRIGACIÓN</strong></h5></center></th>
         </tr>
    <tr class="table-active">
        <th scope="col-1"><center>Fecha reporte</center></th>
      <th scope="col-1"><center>No. Bolsa</center></th>
      <th scope="col"><center>Solución</center></th>
      <th scope="col"><center>Hora entrada</center></th>
       <th scope="col"><center>Hora salida</center></th>
        <th scope="col"><center>Volumen entrada</center></th>
         <th scope="col"><center>Volumen salida</center></th>
  ...
  <tbody>
    <tr>
           <td><input type="date" value="<?php echo $fecha_actual = date("Y-m-d") ?>" name="fecha" class="form-control" required></td>
      <td class="col-1"><input type="text" name="bolsa" class="form-control"></td>
      <td><select class="form-control" name="solucion" style="width : 100%; heigth : 100%" required="">
 ...
 <option value="NUTRICION PARENTERAL">NUTRICIÓN PARENTERAL</option>
  <option value="CARGAS">CARGAS</option>
      ...
      <td><input type="time" name="hora_entrada" class="form-control"></td>
      <td><input type="time" name="hora_salida" class="form-control"></td>
      <td><input type="text" name="vol_entrada" class="form-control"></td>
      <td><input type="text" name="vol_salida" class="form-control"></td>
      <td><input type="submit" name="btnirr" class="btn btn-block btn-success btn-sm" value="Agregar"></td>
    </tr>
...
<?php
if(isset($_POST['btnirr'])){
     include "../../conexionbd.php";
            $usuario = $_SESSION['login'];
            $id_usua= $usuario['id_usua'];
            $id_atencion = $_SESSION['pac'];
            
            $fecha_reporte =  mysqli_real_escape_string($conexion, (strip_tags($_POST["fecha"], ENT_QUOTES)));
...
$fecha_registro = date("Y-m-d H:i");
   $ingresar2 = mysqli_query($conexion, 'INSERT INTO irrigacion (id_atencion,id_usua,fecha_registro,fecha_reporte,bolsa,solucion,hora_entrada,hora_salida,vol_entrada,vol_salida,balance) values ('.$id_atencion.',' . $id_usua . ',"' . $fecha_registro .'","' . $fecha_reporte . '","'.$bolsa.'","'.$solucion.'","'.$hora_entrada.'","'.$hora_salida.'","'.$vol_entrada.'","'.$vol_salida.'","'.$balance.'") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from irrigacion WHERE id_atencion=$id_atencion") or die($conexion->error);
$usuario = $_SESSION['login'];
...
<table class="table table-bordered table-responsive" id="mytable">
       <thead class="thead">
         <tr class="table-primary">
            <th colspan="12"><center><h5><strong>HOJA DE IRRIGACIÓN</strong></h5></center></th>
         </tr>

    <tr class="table-success">
      <th scope="col"><center>Fecha de registro</center></th>
      <th scope="col"><center>Fecha reporte</center></th>
      <th scope="col"><center>Bolsa</center></th>
      <th scope="col"><center>Solución</center></th>
      <th scope="col"><center>Hora entrada</center></th>
      <th scope="col"><center>Hora salida</center></th>
      <th scope="col"><center>Volumen entrada</center></th>
...
<td><center><strong> <?php $fechr=date_create($f['fecha_reporte']); echo date_format($fechr,"d-m-Y");?></center></strong></td>
      <td><center><strong> <?php echo $f['bolsa'];?> </strong></center></td>
      <td><center><strong>
        <?php echo $f['solucion'];?></strong></center>
       </td>
      <td><center><strong><?php echo $f['hora_entrada'];?></strong></center></td>
      <td><center><strong><?php echo $f['hora_salida'];?></strong></center></td>
      <td><center><strong><?php echo $f['vol_entrada'];?></strong></center></td>
      <td><center><strong><?php echo $f['vol_salida'];?></strong></center></td>
      
       <td><center><strong><?php echo $f['balance']?></strong></center></td>
 ...
 <td><center><a href="editar_irr.php?id=<?php echo $f['id_irrigacion'];?>" title="Editar datos" class="btn btn-warning btn-sm "><span class="fa fa-edit" aria-hidden="true"></span></a></td></center>

 <td><center><a href="el_irr.php?id=<?php echo $f['id_irrigacion'];?>" title="Eliminar dato" class="btn btn-danger btn-sm "><span class="fa fa-trash" aria-hidden="true"></span></a></td>

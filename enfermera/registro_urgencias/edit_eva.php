      ...
      <div class="container-fluid">
          ...
          <div>
            <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 20px;">
                <tr><strong><center>EDITAR VALORACIÓN DEL DOLOR - ESCALA VISUAL ANÁLOGA (EVA)</center></strong>
            </div>
            <br>
            <?php
            $id = $_GET['id_mon_s'];

            $sql = "SELECT * from eva where id_eva = $id";
...
<div class="col-sm-2">
  <label>Hora:</label>
<input type="time" class="form-control" name="hora_eva" style="width : 100%; heigth : 100%" value="<?php echo $row_datos['hora_eva']; ?>" required="">
</div>
    <div class="col-sm-3">
   <div class="form-group">
                  <label for="cantidad">Valor:</label>
                  <select name="eseva" class="form-control">
                      <option value"<?php echo $row_datos['eseva']; ?>"><?php echo $row_datos['eseva']; ?></option>
...
$fecha_reporte    = mysqli_real_escape_string($conexion, (strip_tags($_POST["fecha_reporte"], ENT_QUOTES))); 
        ...
        $sql2 = "UPDATE eva SET fecha_reporte = '$fecha_reporte',hora_eva='$hora_eva', eseva = '$eseva' WHERE id_eva = $id";

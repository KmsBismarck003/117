                                                    ...
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                <?php echo $stats['presion_sistolica']['ultimo']; ?> <span
                                                                    class="text-xs">mmHg</span></div>
                                                            <small class="text-muted">Rango:
                                                                <?php echo $stats['presion_sistolica']['min']; ?> -
                                                                <?php echo $stats['presion_sistolica']['max']; ?>
                                                                mmHg</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                <?php echo $stats['presion_diastolica']['ultimo']; ?> <span
                                                                    class="text-xs">mmHg</span></div>
                                                            <small class="text-muted">Rango:
                                                                <?php echo $stats['presion_diastolica']['min']; ?> -
                                                                <?php echo $stats['presion_diastolica']['max']; ?>
                                                                mmHg</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                <?php echo $stats['frecuencia_cardiaca']['ultimo']; ?> <span
                                                                    class="text-xs">lpm</span></div>
                                                            <small class="text-muted">Rango:
                                                                <?php echo $stats['frecuencia_cardiaca']['min']; ?> -
                                                                <?php echo $stats['frecuencia_cardiaca']['max']; ?>
                                                                lpm</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                <?php echo $stats['frecuencia_respiratoria']['ultimo']; ?>
                                                                <span class="text-xs">rpm</span></div>
                                                            <small class="text-muted">Rango:
                                                                <?php echo $stats['frecuencia_respiratoria']['min']; ?> -
                                                                <?php echo $stats['frecuencia_respiratoria']['max']; ?>
                                                                rpm</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            <div
                                                                ...
                                                                SATURACIÓN DE O₂</div>
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                <?php echo $stats['saturacion']['ultimo']; ?> <span
                                                                    class="text-xs">%</span></div>
                                                            <small class="text-muted">Rango:
                                                                <?php echo $stats['saturacion']['min']; ?> -
                                                                <?php echo $stats['saturacion']['max']; ?>%</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            <div
                                                                ...
                                                                TEMPERATURA</div>
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                <?php echo $stats['temperatura']['ultimo']; ?> <span
                                                                    class="text-xs">°C</span></div>
                                                            <small class="text-muted">Rango:
                                                                <?php echo $stats['temperatura']['min']; ?> -
                                                                <?php echo $stats['temperatura']['max']; ?>°C</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

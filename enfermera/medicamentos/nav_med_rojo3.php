    ...
    ?>
      <div class="container">
        ...
        <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 25px;">
                 <tr><strong><center>REGISTRO DE MEDICAMENTOS CARRO ROJO QUIRÓFANO</center></strong>
        </div>
         <hr>
 <font size="2">
         <div class="container">
...
<?php
    ...
    if (isset($_POST['btnagregar'])) {
                ...
                echo '<script>
                      $(document).ready(function() {
                          swal({
                              ...
                              if (isConfirm) {
                                window.location.href = "nav_med_rojo3.php";
                              }
                          });
                      });
                </script>';   
        ...
        $ingresar2 = mysqli_query($conexion, 'INSERT INTO medicamentos_rojo3 (cart_id,id_atencion,id_usua,dosis,material_id,mat_nom,via,frecuencia,cantidad,fecha) values ('.$cart_id.',' . $id_atencion . ',' . $id_usua .',"' . $dosis . '",' . $item_id . ',"' . $mat_nom . '","' . $via . '","' . $frec . '",' . $qty .',"'.$fecha_actual.'") ') or die('<p>Error al registrar</p><br>' . mysqli_error($conexion));
           ...
           echo '<script type="text/javascript">window.location.href = "nav_med_rojo3.php";</script>';
        }
    }

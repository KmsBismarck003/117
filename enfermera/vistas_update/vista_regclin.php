...
-->
  ...
  <title>VISTA ENFERMERIA REGISTRO QUIRURGICO</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA ENFERMERIA REGISTRO QUIRURGICO</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from enf_reg_clin WHERE id_atencion=$id_atencion ORDER BY id_clinreg DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_clinreg=$f['id_clinreg'];
                    ...
                    <tr>
                        <td><a href="../updates/update_regclin.php?id_clinreg=<?php echo $id_clinreg; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_mat']); echo date_format($date,"d/m/Y");?></strong></td>

...
-->
  ...
  <title>VISTA ENFERMERIA AREA QUIRÚRGICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA ENFERMERIA AREA QUIRÚRGICA</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_sangre=$f['id_sangre'];

                    ?>

                    <tr>
                        <td><a href="../updates/update_sangre.php?id_sangre=<?php echo $id_sangre; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecht']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['hor_in']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

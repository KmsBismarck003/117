...
-->
  ...
  <title>VISTA ENFERMERIA AREA NEONATOLOGICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA ENFERMERIA AREA NEONATOLOGICA</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['pac'];
$resultado = $conexion->query("SELECT * from iden_recnac WHERE id_atencion=$id_atencion ORDER BY id_rec_nac DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_rec_nac=$f['id_rec_nac'];
                    ...
                    <tr>
                        <td><a href="../updates/update_neonatal.php?id_rec_nac=<?php echo $id_rec_nac; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fechab']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['horab']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

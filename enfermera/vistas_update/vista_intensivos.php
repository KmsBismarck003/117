...
-->
  ...
  <title>VISTA ENFERMERIA AREA CUIDADOS INTENSIVOS</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA ENFERMERIA AREA DE CUIDADOS INTENSIVOS</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_enf_mat=$f['id_enf_mat'];
                    ...
                    <tr>
                        <td><a href="../updates/update_terapia.php?id_enf_mat=<?php echo $id_enf_mat; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_m']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_m']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

...
<br>
 ...
 $tipo    = mysqli_real_escape_string($conexion, (strip_tags($_POST["tipo"], ENT_QUOTES)));
        ...
        $sql2 = "UPDATE medica_enf SET fecha_mat = '$fecha_mat',hora_mat = '$hora_mat', medicam_mat = '$medicam_mat',dosis_mat = '$dosis_mat',unimed = '$unimed', via_mat = '$via_mat',tipo = '$tipo',otro = '$otro' WHERE id_med_reg = $id";

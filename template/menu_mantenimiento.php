...
if (!($usuario['id_rol'] == 5 || $usuario['id_rol'] == 14)) {
    session_unset();
    session_destroy();
...
?>
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                  ...
                  <div class="pull-left">
                    <a href="../mantenimiento/editar_perfil.php?id_usua=<?php echo $usuario['id_usua'];?>" class="btn btn-default btn-flat">MIS DATOS</a>
                  </div>
...
<div class="container box col-12">
        ...
        ?>
            <div class="col-lg-1.9 col-xs-1">
              ...
              <a href="../mantenimiento/edita_camad.php?id=<?php echo $row['id']?>" class="small-box-footer"><i style="font-size:23px;" class="fa fa-bed"></i></a>
          ...
          ?>
            <div class="col-lg-1.9 col-xs-1">
              <div class="alert alert-danger" role="alert">
                <a href="../mantenimiento/edita_cama.php?id=<?php echo $row['id']?>" class="small-box-footer"><i style="font-size:23px;" class="fa fa-bed"></i></a>
                <h7><font size="3"><?php echo $num_cama ?></font></h7>
                <br>
...
?>
<div class="col-lg-1.9 col-xs-1">
              <div class="alert" role="alert" style="background-color: #563618; color:white;">
                <a href="../mantenimiento/liberacion_camas.php?num_cama=<?php echo $num_cama ?>" class="small-box-footer"><i style="font-size:24px;" class="fa fa-bed"></i></a>
                <h7><font size="3"><?php echo $num_cama ?></font></h7>
            <p>
        ...
        ?>
         <div class="col-lg-1.9 col-xs-1">
          ...
          ?>
            <div class="col-lg-1.9 col-xs-1">
              <div class="alert alert-danger" role="alert">
                <a href="../mantenimiento/edita_cama.php?id=<?php echo $row['id']?>" class="small-box-footer"><i style="font-size:20px;" class="fa fa-bed"></i></a>
                <h7><font size="3"><?php echo $num_cama ?></font></h7>
                <br>
                <h7><font size="2" class="nod"><?php echo $esta ?></font></h7>
                <br>
...
<div class="col-lg-1.9 col-xs-1">
              <div class="alert alert-warning" role="alert">
                ...
                <h7><font size="3"><?php echo $num_cama ?></font></h7>
            <p>
              <!--  <img src="../img/biomedica.png" width="10" class="img-fluid" title="Biomedica">--><img src="../img/intendencia.png" width="19" class="img-fluid" title="Intendencia">
             <br>
                <!--<img src="../img/manten.jpg" width="10" class="img-fluid" title="Mantenimiento">--><br>
              </div>
            </div>

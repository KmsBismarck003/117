        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
               ...
               <!-- <li class="active treeview">
                    <a href="../sauxiliares/Laboratorio/lista_paquetes_labo.php">
                         <i class="fa fa-folder"></i> <span>PERFILES</span>
                ...
                <li class="treeview">
                    <a href="../sauxiliares/Laboratorio/sol_laboratorio.php">
                        <i class="fa fa-folder"></i> <span>SOLICITUD DE ESTUDIOS <br>DE LABORATORIO</span>
                ...
                <li class="treeview">
                    <a href="../sauxiliares/Laboratorio/trans_sangre.php">
                         <i class="fa fa-folder"></i> <span>SOLICITUD DE BANCO <br>DE SANGRE</span>
                ...
                <li class="treeview">
                    <a href="../sauxiliares/Laboratorio/resultados_labo.php">
                        <i class="fa fa-folder"></i> <span>CONSULTAR RESULTADOS <br>ESTUDIOS DE LABORATORIO</span>

                    </a>

                </li>
                <li class="treeview">
                    <a href="../sauxiliares/Laboratorio/resultados_sangre.php">
                        <i class="fa fa-folder"></i> <span>CONSULTAR ATENCIÓN<br>DE BANCO DE SANGRE</span>
...
if ($usuario['id_usua'] == 516 || $usuario['id_usua'] == 266 || $usuario['id_usua'] == 1) {
?>
                 <li class="treeview">
                    <a href="../sauxiliares/Laboratorio/cat_servicios.php">
                        <i class="fa fa-folder"></i> <span>CATALOGO DE LABORATORIO</span>

      ...
      <section class="sidebar">
        ...
        <!-- NOTAS ANESTÉSICAS-->
                 <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                       <li><a href="../gestion_medica/nota_anestesica/nota_anestesica.php"><i class="fa fa-bed"></i> PRE-ANESTÉSICA</a></li>
            ...
            <li class="treeview">
              ...
              if (isset($_SESSION['hospital'])) {
              ?>
                <li><a href="../gestion_medica/hospitalizacion/recetario_medico.php"><i class="fa fa-files-o" aria-hidden="true"></i> RECETA HOSPITALIZACIÓN</a></li>
              <?php
              } else {
              ?>
                <li><a href="select_pac_hosp.php"><i class="fa fa-files-o" aria-hidden="true"></i> RECETA HOSPITALIZACIÓN</a></li>
              <?php
              }
              ?>
...
<div class="col-lg-1.5 col-xs-1">
        ...
        ?>
                <div class="col-lg-1.5 col-xs-1">
        <center><strong><div class="thead" style="background-color: white; color: BLACK; font-size: 20px;"><br>ENDOSCOPÍA</p></div></strong>
        </center>
</div>
        <?php

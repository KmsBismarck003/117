...
<title>Menu Gestion Administrativa </title>
    ...
    <div class="row">
        <div class="col-2 collapse show d-md-flex pt-10 pl-0 min-vh-100" id="sidebar">
            ...
            <ul class="nav flex-column flex-nowrap overflow-hidden">
              <li class="nav-item"><a href="registro_pac.php"><button class="btn btn-outline-light my-2 my-sm-12 col-12" id="letra"><i class="fa fa-plus-square" aria-hidden="true"></i> Gestión de pacientes</button></a></li>
                              
                </li>
            <li class="nav-item"><a href=""><button class="btn btn-outline-light my-2 my-sm-12 col-12" id="letra"><i class="fa fa-id-card" aria-hidden="true"></i> Cuenta del paciente</button></a></li>

                            <li class="nav-item"><a href="dat_financieros.php"><button class="btn btn-outline-light my-2 my-sm-12 col-12"id="letra"><i class="fa fa-usd"></i> Datos financieros</button></a></li>
                            <li class="nav-item"><a href=""><button class="btn btn-outline-light my-2 my-sm-12 col-12"id="letra"><i class="fa fa-shipping-fast"></i> Egreso del paciente</button></a></li> 
                             <hr><hr><hr><hr><hr><hr>

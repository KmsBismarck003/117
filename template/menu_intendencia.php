...
if (!($usuario['id_rol'] == 5 || $usuario['id_rol'] == 16)) {
    session_unset();
    session_destroy();
          ...
          ?>
            <div class="col-lg-1.9 col-xs-1">
              <div class="alert alert-danger" role="alert">
                <a href="../intendencia/edita_cama.php?id=<?php echo $row['id']?>" class="small-box-footer"><i style="font-size:23px;" class="fa fa-bed"></i></a>
                <h7><font size="3"><?php echo $num_cama ?></font></h7>
                <br>
...
?>
<div class="col-lg-1.9 col-xs-1">
              <div class="alert" role="alert" style="background-color: #00CDFF; color:white;">
                <a href="../intendencia/liberacion_camas.php?num_cama=<?php echo $num_cama ?>" class="small-box-footer"><i style="font-size:24px;" class="fa fa-bed"></i></a>
                <h7><font size="3"><?php echo $num_cama ?></font></h7>
            <p>
...
<div class="col-lg-1.9 col-xs-1">
              <div class="alert alert-warning" role="alert">
                <a href="../intendencia/liberacion_camas.php?num_cama=<?php echo $num_cama ?>" class="small-box-footer">
        ...
        ?>
         <div class="col-lg-1.9 col-xs-1">
          ...
          ?>
            <div class="col-lg-1.9 col-xs-1">
              <div class="alert alert-danger" role="alert">
                <a href="../intendencia/edita_cama.php?id=<?php echo $row['id']?>" class="small-box-footer"><i style="font-size:20px;" class="fa fa-bed"></i></a>
                <h7><font size="3"><?php echo $num_cama ?></font></h7>
                <br>
                <h7><font size="2" class="nod"><?php echo $esta ?></font></h7>
                <br>

                ...
                <div class="col col-12">
                     ...
                     <button type="button" class="btn btn-danger btn-sm" onclick="history.back()">REGRESAR</button>
                        ...
                        <center><p>
                            ...
                            <font id="letra"><strong>CONSULTAR CONSULTA DE URGENCIAS</strong></font>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="mytable">
                            ...
                            <tr>
                                <center>
                                    <th scope="col"> FECHA DE LA CONSULTA DE URGENCIAS</th>
                                </center>
                            ...
                            <?php
                            $resultado = $conexion->query("select paciente.*, dat_ingreso.id_atencion, dat_c_urgen.*
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp
inner join dat_c_urgen on dat_ingreso.id_atencion=dat_c_urgen.id_atencion
") or die($conexion->error);
                            while ($f = mysqli_fetch_array($resultado)) {
                                ...
                                <tr>
                                   <td><center><strong><?php $date = date_create($f['fecha_urgen']);
                                            echo date_format($date, "d/m/Y H:i"); ?></strong></center></td>
                                    ...
                                    <td><strong>
                                            <a type="submit" class="btn btn-danger btn-sm"
                                               href="pdf_consulta_urgencias.php?nur= <?php echo $f['id_c_urgen'];  ?> &id=<?php echo $f['id_atencion']; ?>&id_med=<?php echo $usuario['id_usua'] ?>"
                                               target="_blank"><span class="fa fa-file-pdf-o"
                                                                     style="font-size:28px"></span></a>
                                        </strong></td>
                                    <td><a type="submit" class="btn btn-warning btn-sm" href="../updates_urgencias/update_curgen.php?id_atencion=<?php echo $f['id_atencion']; ?>&id_c_urgen=<?php echo $f['id_c_urgen'] ?>"><span class="fa fa-pencil-square-o"style="font-size:28px"></span></a></td>
                                </tr>
                                <?php
                            }

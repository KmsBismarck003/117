      ...
      <div class="row">
        <div class="col col-12">
          ...
          while ($f = $result_pachis->fetch_assoc()) {
                ?>
                <tr>
                  <td><strong> <a type="submit" class="btn btn-danger btn-sm" href="pdf_hclinica.php?id_hc=<?php echo $f['id_hc']; ?>&id_exp=<?php echo $id_exp; ?>" target="_blank"><span class="fa fa-file-pdf-o" style="font-size:28px"></span></a></strong></td>

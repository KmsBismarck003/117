    ...
    <div class="row">
        ...
        <div class="col col-12">
            <h2>
                ...
                <center><font id="letra">NOTA DE URGENCIAS</font></h2> </center>
            ...
            <div class="form-group">
                <a href="buscar_not_evob.php"><button type="button" class="btn btn-success btn-sm col-md-5"  data-target="#exampleModal">
...
<a href="./nota_observacion.php?id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>"<strong><?php echo $f['id_atencion'];?></strong></td>

...
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp WHERE dat_ingreso.area='CONSULTA DE URGENCIAS'|| dat_ingreso.area='OBSERVACION' || dat_ingreso.area='YESOS' || dat_ingreso.area='CHOQUE'") or die($conexion->error);
?>   
<!DOCTYPE html>
<html>
    ...
    <div class="row">
        ...
        <div class="col col-12">
            <h2>
                ...
                <center><font id="letra"> VISTA ÓRDENES DEL MÉDICO</font></h2> </center>
            ...
            <div class="form-group">
                   <a href="buscar_ordenes_medico.php"><button type="button" class="btn btn-success btn-sm col-md-5"  data-target="#exampleModal">
                            <i class="fa fa-plus"></i> <font id="letra"> BUSCAR ÓRDENES DEL MÉDICO</font></button></a>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        <td><a href="./ordenes_medico_form.php?id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button></td>

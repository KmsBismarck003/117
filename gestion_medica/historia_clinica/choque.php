...
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp WHERE dat_ingreso.area='CHOQUE'") or die($conexion->error);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="row">
        ...
        <div class="col col-12">
            <h2>
                ...
                <center><font id="letra">Pacientes Choque</font></h2> </center>
            ...
            <div class="form-group">
                 <a href="buscar_not_choque.php"><button type="button" class="btn btn-success btn-sm col-md-5"  data-target="#exampleModal">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        <td scope="row" id="letra" align="center">
                            <a href="./nota_choque.php?id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>"><button type="button" class="btn btn-info btn-sm"><i class="fa fa-indent"></i></button></a></td>

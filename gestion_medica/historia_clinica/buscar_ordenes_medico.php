...
$resultado = $conexion->query("select paciente.*, dat_ingreso.id_atencion, dat_ordenes_med.*
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp
inner join dat_ordenes_med on dat_ingreso.id_atencion=dat_ordenes_med.id_atencion
            ...
            <div class="row">
                <div class="col col-12">
                    ...
                    <h2>
                        ...
                        <center>
                            <font id="letra">CONSULTAR ÓRDENES MÉDICAS</font>
                    </h2>
                    </center>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="mytable">
                            ...
                            <tr>
                                <center>
                                    <th scope="col"> Fecha de órdenes del Médico</th>
                                </center>
                            ...
                            while ($f = mysqli_fetch_array($resultado)) {
                                ...
                                <tr>
                                   <td><center><strong><?php $date = date_create($f['fecha_ord']);
                                    ...
                                    <td><strong>
                                            <a type="submit" class="btn btn-danger btn-sm"
                                               href="pdf_ordenes_medico.php?id=<?php echo $f['id_atencion']; ?>&id_med=<?php echo $usuario['id_usua'] ?>"

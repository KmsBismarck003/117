...
$pdf->SETX(33);
$pdf->MultiCell(150, 6, utf8_decode('ÓRDENES DEL MÉDICO'), 1, 'C');
$pdf->Ln(3);

$pdf->SetFont('Arial', '', 10);
$pdf->Cell(190, 6, utf8_decode('NOMBRE DEL PACIENTE: ' . $papell . ' ' . $sapell . ' ' . $nom_pac), 1,1, 'L');
...
$pdf->Cell(45, 6, utf8_decode('FECHA: ' . ' ' . $fecha_ord), 1,0, 'C');
$pdf->Cell(45, 6, utf8_decode('HORA: ' . ' ' . $hora_ord), 1,1, 'C');

$pdf->SetFont('Arial', 'B', 10);
$pdf->MultiCell(190, 6, utf8_decode('PRESCRIPCIÓN Y ÓRDENES: PREPARACIÓN DE CASOS QUIRÚRGICOS, DIETAS, ETC.
  INDICACIONES MEDICAS'), 1, 'C');


$pdf->SetFont('Arial', '', 10);
$pdf->MultiCell(190, 6, utf8_decode('1.- DIETA: ' . ' ' . $dieta ), 1, 'L');

$pdf->SetFont('Arial', '', 10);
$pdf->MultiCell(190, 6, utf8_decode('2.- CUIDADOS GENERALES: ' . ' ' . $cuid_gen ), 1, 'L');

$pdf->SetFont('Arial', '', 10);
$pdf->MultiCell(190, 6, utf8_decode('3.- MEDICAMENTOS: ' . ' ' . $med_med ), 1, 'L');


$pdf->SetFont('Arial', '', 10);
$pdf->MultiCell(190, 6, utf8_decode('4.- SOLUCIONES: ' . ' ' . $soluciones ), 1, 'L');


$pdf->SetFont('Arial', '', 10);
$pdf->MultiCell(190, 6, utf8_decode('5.- SOLICITUD DE ESTUDIOS: ' . ' ' . $sol_estudios ), 1, 'L');
$pdf->Ln(3);

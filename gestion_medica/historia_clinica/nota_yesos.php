...
<div class="col-sm-12">
    <div class="container">
        <div class="row">
            <div class="col">
                <hr>
                <h2><strong>NOTAS DE YESOS</strong></h2>
                <hr>
<?php
...
<div class="tab-pane fade show active" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
    ...
    <?php $id_cli = $_GET['id_atencion']; ?>
     ...
     <?php $id_usua = $_GET['id_usua']; ?>
          ...
          <form action="insertar_nota_yesos.php?id_atencion=<?php echo $_GET['id_atencion']; ?>&id_usua=<?php echo $_GET['id_usua']; ?>" method="POST">
<br>
...
<div class="container">
  ...
  <input class="form-check-input" type="radio" name="tip_ey" id="ingre" value="NOTA DE INGRESO HOSPITALIZACION">
...
<font color="#407959"><strong><u>NOTA DE INGRESO HOSPITALIZACIÓN</u></strong></font>
    ...
    <div class="col-sm">
     <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="alta" value="NOTA DE ALTA DE HOSPITALIZACION">
  ...
  <font color="#407959"><strong><u>NOTA DE EGRESO</u></strong></font>
    ...
    <div class="col-sm">
    <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="parto" value="NOTA POST-PARTO">
 ...
 <font color="#407959"><strong><u>NOTA POST_PARTO</u></strong></font>
    ...
    <div class="col-sm">
      <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="neon" value="NOTA NEONATOLOGICA">
  <label class="form-check-label" for="neon">
   <font color="#407959"><strong><u>NOTA NEONATOLÓGICA</u></strong></font>
     ...
     <div class="col-sm">
      <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="valor" value="NOTA DE VALORACION CIRUGIA GENERAL">
...
<font color="#407959"><strong><u>NOTA DE VALORACIÓN CIRUGÍA GENERAL</u></strong></font>
     ...
     <div class="col-sm">
      <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="notevol" value="NOTA DE EVOLUCION">
...
<div class="container">
  <div class="row">
    <div class="col-sm">
      <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="resumen" value="NOTA RESUMEN DE EVOLUCION Y ESTADO ACTUAL">
  <label class="form-check-label" for="resumen">
    ...
    <div class="col-sm">
     <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="notpre" value="NOTA PREOPERATORIA">
...
<font color="#407959"><strong><u>NOTA PREOPERATORIA</u></strong></font>
    ...
    <div class="col-sm">
    <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="notpost" value="NOTA POSTOPERATORIA">
...
<font color="#407959"><strong><u>NOTA POSTOPERATORIA</u></strong></font>
    ...
    <div class="col-sm">
      <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="pretrans" value="NOTA PRE-TRANSFUSION SANGUINEA">
 ...
 <font color="#407959"><strong><u>NOTA PRE-TRANSFUSIÓN SANGUÍNEA</u></strong></font>
     ...
     <div class="col-sm">
      <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="ptrans" value="NOTA POST-TRANSFUSION SANGUINEA">
 ...
 <font color="#407959"><strong><u>NOTA POST-TRANSFUSIÓN SANGUÍNEA</u></strong></font>
     ...
     <div class="col-sm">
      <div class="form-check">
  <input class="form-check-input" type="radio" name="tip_ey" id="transs" value="NOTA TRANSFUSION SANGUINEA">
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5" color="#407959">P</font></label></strong></center>
    ...
    <div class=" col-10">
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" name="problemay" rows="3" placeholder="PACIENTE: DESCRIBIR AL PACIENTE (EDAD,GÉNERO, DIAGNÓSTICOS Y TRATAMIENTOS PREVIOS)"style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
 <div class="row">
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5" color="#407959">S</font></label></strong></center>
    ...
    <div class=" col-10">
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="subjetivoy" placeholder="ss="form-control" id="exampleFormControlTextarea1" rows="3" name="subjetivoch" placeholder="SUBJETIVO: DESCRIBIR LA SINTOMATOLOGÍA DEL PACIENTE, HÁBITOS, A QUE ATRIBUYE EL PADECIMIENTO ACTUAL, ETC."style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5"color="#407959">O</font></label></strong></center>
    ...
    <div class=" col-10">
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="objetivoy" placeholder="OBJETIVO: DESCRIBIR LA EXPLORACIÓN FÍSICA"style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5"color="#407959">P</font></label></strong></center>
    ...
    <div class=" col-10">
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="plany" placeholder="PLAN: DESCRIBIR TRATAMIENTO Y RECOMENDACIONES INDICADAS AL PACIENTE, ANOTAR LOS MEDICAMENTOS CON SU DOSIS DE MANERA DETALLADA."style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5"color="#407959">PX</font></label></strong></center>
    ...
    <div class=" col-10">
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="pxy" placeholder="PRONÓSTICO: PARA LA VIDA Y PARA LA FUNCIÓN"style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
...
<div class="form-group">
 <label for="id_cie_10"><strong>DESTINO: </strong></label>
    <select name="dest_cu_yesos" class="form-control" id="mibuscador" style="width : 50%; heigth : 50%;" onchange="mostrar(this.value);">

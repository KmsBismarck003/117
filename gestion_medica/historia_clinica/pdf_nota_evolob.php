...
$sql_obs = "SELECT obse.fecha_ob,obse.tip_evo,obse.problemao,obse.subjetivob,obse.objetivob,obse.analisiso,obse.plano,obse.pxo,obse.dest_cu_ob FROM dat_ob obse, dat_ingreso din where din.id_atencion = $id_atencion";
...
$pdf->Cell(50, 6, utf8_decode('FECHA: ' . ' ' . $fecha_ob), 1,1, 'C');


$pdf->SetFont('Arial', 'B', 10);
$pdf->MultiCell(190, 6, utf8_decode('NOTAS'), 1, 'C');
$pdf->MultiCell(190, 6, utf8_decode($tip_evo), 1, 'C');


$pdf->SetFont('Arial', '', 10);
$pdf->MultiCell(190, 6, utf8_decode($problemao), 1, 'L');
$pdf->MultiCell(190, 6, utf8_decode($subjetivob), 1, 'L');
$pdf->MultiCell(190, 6, utf8_decode($objetivob), 1, 'L');
$pdf->MultiCell(190, 6, utf8_decode($analisiso), 1, 'L');

$pdf->MultiCell(190, 6, utf8_decode($plano), 1, 'L');

$pdf->MultiCell(190, 6, utf8_decode($pxo), 1, 'L');
$pdf->Ln(3);

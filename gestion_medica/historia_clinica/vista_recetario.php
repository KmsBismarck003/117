...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col col-12">
            ...
            <div class="thead col col-12" style="background-color: #2b2d7f; color: white; font-size: 24px; align-content: center;">    <center><font id="letra"> <strong>RECETA MÉDICA DE URGENCIAS</strong></font> </center>
</div>
            <div class="row">
            ...
            <div class="form-group">
                   <a href="buscar_recetario_medico.php"><button type="button" class="btn btn-success btn-sm col-md-5"  data-target="#exampleModal">
                            <i class="fa fa-plus"></i> <font id="letra"> BUSCAR RECETARIO MÉDICO</font></button></a>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        <td><a href="./recetario_medico_urgencias.php?id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button></td>

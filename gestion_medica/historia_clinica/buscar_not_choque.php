...
$resultado = $conexion->query("select paciente.*, dat_ingreso.id_atencion, dat_choque.*
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp
inner join dat_choque on dat_ingreso.id_atencion=dat_choque.id_atencion
            ...
            <div class="row">
                <div class="col col-12">
                    ...
                    <h2>
                        ...
                        <center>
                            <font id="letra">CONSULTAR NOTA DE EVOLUCIÓN DE OBSERVACIÓN</font>
                    </h2>
                    </center>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="mytable">
                            ...
                            <tr>
                                <center>
                                    <th scope="col"> Fecha de Nota de Evolución</th>
                                </center>
                            ...
                            while ($f = mysqli_fetch_array($resultado)) {
                                ...
                                <tr>
                                   <td><center><strong><?php $date = date_create($f['fecha_ch']);
                                    ...
                                    <td><strong>
                                            <a type="submit" class="btn btn-danger btn-sm"
                                               href="pdf_nota_evochoq.php?id=<?php echo $f['id_atencion']; ?>&id_med=<?php echo $usuario['id_usua'] ?>"

...
while($f = mysqli_fetch_array($resultado)){
                    ?>
                    <tr>
                        <td><a href="./consent_medico.php?id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button></td>

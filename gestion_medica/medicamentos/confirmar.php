...
$usuario = $_SESSION['login'];
  ...
  <center><strong>INSUMOS QUIRÚRGICOS CEYE</strong></center><p>
</div> 
            </center>
      ...
      while ($row_pac = $result_pac->fetch_assoc()) {
        $id_exp = $row_pac['Id_exp'];
              ...
              $resultado3 = $conexion->query("SELECT * from paciente p, dat_ingreso di, cart_serv c, cat_servicios i 
                where di.Id_exp = c.paciente and p.Id_exp = di.Id_exp and i.id_serv = c.servicio_id AND c.paciente=$id_exp ORDER BY c.cart_id ASC") or die($conexion->error);

        ...
        <div class="row">
            ...
            <div class="col col-12">
                <h2>
                    ...
                    <center>
                        <font id="letra"> VISTA NOTA DE EVOLUCIÓN</font>
                </h2>
                </center>
                    ...
                    <table class="table table-bordered table-striped" id="mytable">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><a href="./nota_de_evolucion.php?id_atencion=<?php echo $f['id_atencion']; ?>&id_usua=<?php echo $usuario['id_usua'] ?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button></td>
                                    ...
                                    <td><strong>
                                            <center><?php echo $f['especialidad']; ?></center>
                                        </strong></td>
                                    <td><strong>
                                            <center><?php echo $f['destino']; ?></center>
                                        </strong></td>
                                    <td><strong>
                                            <center><?php echo $f['motivo_atn']; ?></center>
                                        </strong></td>
                                    <td><strong>
                                            <center><?php $date = date_create($f['fecha']);
                                                    echo date_format($date, "d/m/Y h:i"); ?></center>
                                        </strong></td>

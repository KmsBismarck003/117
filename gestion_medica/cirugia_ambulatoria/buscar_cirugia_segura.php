...
$resultado = $conexion->query("select paciente.*, dat_ingreso.id_atencion, dat_cir_seg.*
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp
inner join dat_cir_seg on dat_ingreso.id_atencion=dat_cir_seg.id_atencion
...
<div>
  ...
  <center><strong> CONSULTAR CIRUGÍA SEGURA (LISTADO DE VERIFICACIÓN DE SEGURIDAD QUIRÚRGICA)</strong></center><p>
</div>                             
...
<a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"                                                             id="side"></i></a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="mytable">
                            ...
                            <tr>
                                <center>
                                    <th scope="col"> FECHA CIRUGÍA SEGURA</th>
                                </center>
                            ...
                            while ($f = mysqli_fetch_array($resultado)) {
                                ...
                                <tr>
                                   <td><center><strong><?php $date = date_create($f['fecha']);
                                            echo date_format($date, "d/m/Y"); ?></strong></center>
                                        </td>
                                    ...
                                    <td><strong>
                                            <a type="submit" class="btn btn-danger btn-sm"
                                               href="pdf_cirugia_segura.php?id=<?php echo $f['id_atencion']; ?>&id_med=<?php echo $usuario['id_usua'] ?>"

...
$resultado = $conexion->query("select paciente.*, dat_ingreso.id_atencion, dat_not_preop.*
from paciente 
...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 24px;">
  <center><strong>CONSULTAR NOTA PREOPERATORIA</strong></center><p>
</div> 
...
<a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"                                                             id="side"></i></a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="mytable">
                            ...
                            <tr>
                                <center>
                                    <th scope="col"> FECHA NOTA PREOPERATORIA</th>
                                </center>
                            ...
                            while ($f = mysqli_fetch_array($resultado)) {
                                ...
                                <tr>
                                   <td><center><strong><?php $date = date_create($f['fecha_preop']);
                                    ...
                                    <td><strong>
                                            <a type="submit" class="btn btn-danger btn-sm"
                                               href="pdf_nota_preoperatoria.php?id=<?php echo $f['id_atencion']; ?>&id_med=<?php echo $usuario['id_usua'] ?>"

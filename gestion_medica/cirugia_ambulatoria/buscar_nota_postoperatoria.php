...
$resultado = $conexion->query("select paciente.*, dat_ingreso.id_atencion, dat_not_postop.*
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp
inner join dat_not_postop on dat_ingreso.id_atencion=dat_not_postop.id_atencion
...
<div>
  ...
  <center><strong> CONSULTAR NOTA POSTOPERATORIA</strong></center><p>
</div>  
...
<a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"                                                             id="side"></i></a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="mytable">
                            ...
                            <tr>
                                <center>
                                    <th scope="col"> FECHA NOTA POSTOPERATORIA</th>
                                </center>
                                <th scope="col">N° DE EXPEIDNETE</th>
                            ...
                            while ($f = mysqli_fetch_array($resultado)) {
                                ...
                                <tr>
                                   <td><center><strong><?php $date = date_create($f['fecha_post']);
                                            echo date_format($date, "d/m/Y H:i"); ?></strong></center>
                                        </td>
                                    ...
                                    <td><strong>
                                            <a type="submit" class="btn btn-danger btn-sm"
                                               href="pdf_nota_postoperatoria.php?id=<?php echo $f['id_atencion']; ?>&id_med=<?php echo $usuario['id_usua'] ?>"

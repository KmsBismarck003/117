...
<strong><center>PROGRAMACIÓN QUIRÚRGICA</center></strong>
</div>
                <hr>
<?php
...
<form action="insertar_preoperatoria.php" method="POST" name="insertar_preoperatoria" onsubmit="return ValidarFechas()">

  <div class="row">
    <div class="col-sm">
      <strong><p>Tipo de cirugía:</p></strong>
      <div class="form-check">
        <input class="form-check-input" type="radio" id="URGENCIA" value="URGENCIA" name="tipo_cirugia_preop" required="">
        <label class="form-check-label" for="URGENCIAS">Urgencia</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="radio" id="ELECTIVA" value="ELECTIVA" name="tipo_cirugia_preop">
        <label class="form-check-label" for="ELECTIVA">Programada</label>
      </div>
    </div>
    <div class="col-sm">
       <strong><p><button type="button" class="btn btn-success btn-sm" id="playa"><i class="fas fa-play"></button></i> Hemoglobina:</p></strong>
       <input type="text" name="hb" class="form-control" id="txtpa">
...
function leerTexto(txtpa){
    ...
    <div class="col-sm">
       <strong><p><button type="button" class="btn btn-success btn-sm" id="playhemato"><i class="fas fa-play"></button></i> Hematocrito:</p></strong>
      <input type="text" name="ht" class="form-control" id="txthtto">
      <script type="text/javascript">
...
function leerTexto(txthtto){
    ...
    window.speechSynthesis.speak(speech);
     ...
     <div class="col-sm">
        <strong><p><button type="button" class="btn btn-success btn-sm" id="playrh"><i class="fas fa-play"></button></i> Grupo sanguineo y R.H.:</p></strong>
        <input type="text" name="rh" id="txtrhg" class="form-control" value="<?php echo $pac_tip_sang ?>" disabled>
<script type="text/javascript">
...
<div class="container"> 
  <div class="row">   
    ...
    <div class="col-sm-3"><center><br><button type="button" class="btn btn-success btn-sm" id="playpresart"><i class="fas fa-play"></button></i> Presión arterial:</center>
     <div class="row">
  <div class="col"><input type="text" class="form-control" id="txtpsistol" value="<?php echo $f5['p_sistol'];?>" disabled></div> /
  <div class="col"><input type="text" class="form-control" id="txtpdiast" value="<?php echo $f5['p_diastol'];?>" disabled></div>
 <script type="text/javascript">
const txtpsistol = document.getElementById('txtpsistol');
const btnPlaysisp = document.getElementById('playpresart');

btnPlaysisp.addEventListener('click', () => {
        leerTexto(txtpsistol.value);
});

function leerTexto(txtpsistol){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtpsistol;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
...
const txtpdiast = document.getElementById('txtpdiast');
const btnPlaydiasp = document.getElementById('playpresart');

btnPlaydiasp.addEventListener('click', () => {
        leerTexto(txtpdiast.value);
});

function leerTexto(txtpdiast){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtpdiast;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
    ...
    <div class="col-sm-2">
     <button type="button" class="btn btn-success btn-sm" id="playcarfre"><i class="fas fa-play"></button></i> Frecuencia cardiaca:<input type="text" class="form-control" id="txtfreca" value="<?php echo $f5['fcard'];?>" disabled>
<script type="text/javascript">
const txtfreca = document.getElementById('txtfreca');
const btnPlayacafrec = document.getElementById('playcarfre');

btnPlayacafrec.addEventListener('click', () => {
        leerTexto(txtfreca.value);
});

function leerTexto(txtfreca){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtfreca;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
    ...
    <div class="col-sm-2">
     <button type="button" class="btn btn-success btn-sm" id="playrespfrec"><i class="fas fa-play"></button></i> Frecuencia <br>respiratoria:<input type="text" id="txtfrresria" class="form-control" value="<?php echo $f5['fresp'];?>" disabled>
     <script type="text/javascript">
const txtfrresria = document.getElementById('txtfrresria');
const btnPlaycuenres = document.getElementById('playrespfrec');

btnPlaycuenres.addEventListener('click', () => {
        leerTexto(txtfrresria.value);
});

function leerTexto(txtfrresria){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtfrresria;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
    ...
    <div class="col-sm-2">
     <br><button type="button" class="btn btn-success btn-sm" id="playtemperatura"><i class="fas fa-play"></button></i> Temperatura:<input type="text" id="txtturaa" class="form-control" value="<?php echo $f5['temper'];?>" disabled>
     <script type="text/javascript">
const txtturaa = document.getElementById('txtturaa');
const btnPlaytemperas = document.getElementById('playtemperatura');

btnPlaytemperas.addEventListener('click', () => {
        leerTexto(txtturaa.value);
});

function leerTexto(txtturaa){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtturaa;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
    ...
    <div class="col-sm-2">
    <button type="button" class="btn btn-success btn-sm" id="playsatoxii"><i class="fas fa-play"></button></i> Saturación oxígeno:<input type="text" id="txtoxicion" class="form-control" value="<?php echo $f5['satoxi'];?>" disabled>
     <script type="text/javascript">
const txtoxicion = document.getElementById('txtoxicion');
const btnPlayoxiaa = document.getElementById('playsatoxii');

btnPlayoxiaa.addEventListener('click', () => {
        leerTexto(txtoxicion.value);
});

function leerTexto(txtoxicion){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtoxicion;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
...
<div class="container"> 
  <div class="row">
    <div class="col-sm-2"><center>PRESIÓN <br> ARTERIAL:</center>
     <div class="row">
    ...
    <div class="col-sm-2">
      FRECUENCIA <br>CARDIACA:<input type="text" class="form-control" name="frec_card">
    </div>
    <div class="col-sm-2">
      FRECUENCIA <br> RESPIRATORIA:<input type="text" class="form-control" name="frec_resp">
    </div>
    <div class="col-sm-2">
     <br>TEMPERATURA:<input type="text" class="form-control"  name="preop_temp">
    </div>
    <div class="col-sm-2">
     SATURACIÓN <br>OXÍGENO:<input type="text"  class="form-control" name="sat_oxi">
    </div>
...
<hr>
<?php 
$resultado6=$conexion->query("select * from dat_not_ingreso WHERE id_atencion=" . $_SESSION ['hospital'].".ORDER by id_not_ingreso DESC LIMIT 1") or die($conexion->error);
...
<div class="container">
  <div class="row">
    <div class=" col-12">
        <strong><font color="black"><button type="button" class="btn btn-success btn-sm" id="playmoing"><i class="fas fa-play"></button></i> Motivo de ingreso:</font></strong>
        <div class="form-group">
          <textarea class="form-control" id="txtinmot" name="motivo" disabled><?php echo $f6['mot_ingreso'] ?></textarea>
          <script type="text/javascript">
const txtinmot = document.getElementById('txtinmot');
const btnPlayotigg = document.getElementById('playmoing');

btnPlayotigg.addEventListener('click', () => {
        leerTexto(txtinmot.value);
});

function leerTexto(txtinmot){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtinmot;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
    ...
    <div class=" col-12">
        <strong><font color="black"><button type="button" class="btn btn-success btn-sm" id="playresini"><i class="fas fa-play"></button></i> Resumen de interrogatorio (nota de ingreso):</font></strong>
        <div class="form-group">
          <textarea class="form-control" id="txtdindi" rows="3" name="motivo" disabled><?php echo $f6['resinterr_i'] ?></textarea>
        </div>
    </div>
<script type="text/javascript">
const txtdindi = document.getElementById('txtdindi');
const btnPlaymenrio = document.getElementById('playresini');

btnPlaymenrio.addEventListener('click', () => {
        leerTexto(txtdindi.value);
});

function leerTexto(txtdindi){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtdindi;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
     ...
     <div class=" col-12">
        <strong><font color="black"><button type="button" class="btn btn-success btn-sm" id="playexpno"><i class="fas fa-play"></button></i> Exploración física (nota de ingreso):</font></strong>
        <div class="form-group">
          <textarea class="form-control" id="txtfiex" rows="3" name="motivo" disabled><?php echo $f6['expfis_i'] ?></textarea>
        </div>
    </div>
  </div>
 <script type="text/javascript">
const txtfiex = document.getElementById('txtfiex');
const btnPlayoraing = document.getElementById('playexpno');

btnPlayoraing.addEventListener('click', () => {
        leerTexto(txtfiex.value);
});

function leerTexto(txtfiex){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtfiex;
    speech.volume=1;
    speech.rate=1;
  ...
  <div class="row">
    <div class="col-sm-3">
      <div class="form-group">
       ...
       <label for="exampleFormControlInput1"><strong>Fecha de inicio de cirugía:</strong></label>
       <input type="datetime-local" name="fecha_cir" class="form-control" id="exampleFormControlInput1" required="" value="<?php echo $fecha_actual = date("Y-m-d H:i");?>">
      <!-- <input type="time" name="hora_cir" class="form-control" id="exampleFormControlInput1" required="">-->
     </div>
    </div>
    <div class="col-sm-3">
      <div class="form-group">
       <label for="exampleFormControlInput1"><strong><button type="button" class="btn btn-success btn-sm" id="playqx"><i class="fas fa-play"></button></i> Tiempo Qx estimado:</strong></label>
       <input type="text" class="form-control" name="tiempo_estimado" required id="rangeField" list="mydata" autocomplete="off" min="0" max="10" step="1" value="1" onchange="output.value=parseInt(rangeField.value)" oninput="changeVar(rangeField.value,rangeField.min, rangeField.max)">
    ...
    <div class="col-sm-3">
      <div class="form-group">
       ...
       <label for="exampleFormControlInput1"><strong>Fecha de término de cirugía:</strong></label>
       <input type="datetime-local" name="fecha_end" class="form-control" id="exampleFormControlInput12" required="" value="<?php echo $fecha_actual = date("Y-m-d H:i");?>">
      <!-- <input type="time" name="hora_cir" class="form-control" id="exampleFormControlInput1" required="">-->
     </div>
    </div>
    <div class="col-sm-3">
...
<div class="alert alert-danger" role="alert">
  Las Hora final debe ser diferente a la hora de inicio.
</div>
<script>
    document.getElementById("exampleFormControlInput12").focus();
</script>
<?php 
}
?>
...
function leerTexto(txtxq){
 ...
 <div class="col-sm">
      <div class="form-group">
        <label for="txtcirmedn"><strong><button type="button" class="btn btn-success btn-sm" id="playnocir"><i class="fas fa-play"></button></i> Nombre del médico cirujano:</strong></label>
         <input type="text" class="form-control" name="nom_medi_cir" required id="txtcirmedn">
      </div>
    </div>
<script type="text/javascript">
const txtcirmedn = document.getElementById('txtcirmedn');
const btnPlaymedjano = document.getElementById('playnocir');

btnPlaymedjano.addEventListener('click', () => {
        leerTexto(txtcirmedn.value);
});

function leerTexto(txtcirmedn){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtcirmedn;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
...
<div class="container">
  <div class="row">
    <div class="col-sm">
        <label for="id_cie_10"><strong><button type="button" class="btn btn-success btn-sm" id="playperres"><i class="fas fa-play"></button></i> Persona responsable de la programación</strong></label>
        <input type="text" name="res_pro" class="form-control" id="txtproga">
</div>
    </div>
  </div>
  <script type="text/javascript">
const txtproga = document.getElementById('txtproga');
const btnPlaysonade = document.getElementById('playperres');

btnPlaysonade.addEventListener('click', () => {
        leerTexto(txtproga.value);
});

function leerTexto(txtproga){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtproga;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
  ...
  <div class="row">
    <div class="col-sm">
        <label for="id_cie_10"><strong><button type="button" class="btn btn-success btn-sm" id="playmatre"><i class="fas fa-play"></button></i> Material y equipo requerido</strong></label>
        <input type="text" name="material" class="form-control" id="txtridoe">
</div>
    </div>
  </div>
  <script type="text/javascript">
const txtridoe = document.getElementById('txtridoe');
const btnPlayequi = document.getElementById('playmatre');

btnPlayequi.addEventListener('click', () => {
        leerTexto(txtridoe.value);
});

function leerTexto(txtridoe){
    const speech = new SpeechSynthesisUtterance();
    speech.text= txtridoe;
    speech.volume=1;
    speech.rate=1;
    speech.pitch=0;
    window.speechSynthesis.speak(speech);
  ...
  <div class="col-sm">
     ...
     <select name="tipo_inter_plan" class="form-control" data-live-search="true" id="mibuscador9" style="width : 100%; heigth : 100%">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm">
        ...
        <select name="d_postoperatorio" class="form-control" data-live-search="true" id="mibuscador7" style="width : 100%; heigth : 100%">
           <option value="">Seleccionar diagnóstico</option>
            <?php
            include "../../conexionbd.php";
            $sql_diag="SELECT * FROM cat_diag ";

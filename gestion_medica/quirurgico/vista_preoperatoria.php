    ...
    <div class="row">
        ...
        <div class="col col-12">
            <h2>
                ...
                <center><font id="letra">PACIENTES NOTA PREOPERATORIA</font></h2> </center>
            ...
            <div class="form-group">
                  <a href="buscar_nota_preoperatoria.php"><button type="button" class="btn btn-success btn-sm col-md-5"  data-target="#exampleModal">
                            <i class="fa fa-plus"></i> <font id="letra"> BUSCAR NOTA PREOPERATORIA</font></button></a>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        <td> <a href="./nota_preoperatoria.php?id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button></td>
                        <td scope="row" id="letra" align="center">
                            <strong><?php echo $f['id_atencion'];?></strong></td>

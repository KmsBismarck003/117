...
-->
  ...
  <title>DATOS VISTA REGISTRO CLÍNICO DE OBSERVACIÓN</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA REGISTRO CLÍNICO DE OBSERVACIÓN</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from enf_reg_urg WHERE id_atencion=$id_atencion ORDER BY id_enf_urg DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_enf_urg=$f['id_enf_urg'];
                  $id_atencion=$f['id_atencion'];
                  $fecham=$f['enfur_fecha'];
                  $hor=$f['hor'];
                  $datet=$f['datet'];
                  ...
                  while ($row_enfermera = $result_enfermera->fetch_assoc()) {
                    ...
                    <tr>
                        <td><a href="../../enfermera/pdf/pdf_reg_urg_enf.php?id_enf_urg=<?php echo $id_enf_urg?>&id_atencion=<?php echo $id_atencion?>&id_exp=<?php echo $id_exp?>&fechar=<?php echo $datet?>&hor=<?php echo $hor?>"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>
                        
                        <td><strong><?php $fecre=date_create($datet); echo date_format($fecre,"d/m/Y");?></strong></td>
                        <td><strong><?php echo $f['hor'];?></strong></td>
                        
                        <td><strong><?php $fecreg=date_create($fecham); echo date_format($fecreg,"d/m/Y H:i:s");?></strong></td>

...
include '../../conexionbd.php';
  ...
  function Footer()
  {
    ...
    $this->Cell(0, 10, utf8_decode('CMSI-12.06'), 0, 1, 'R');
  }
}
...
$pdf->MultiCell(165, 9.5, utf8_decode('RESPONSIVA DE ALOJAMIENTOCONJUNTO MAMÁ-RÉCIEN NACIDO'), 0, 'C');
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(97, 5.5, utf8_decode($papell . ' ' . $sapell . ' ' . $nom_pac) , 'B', 'C');
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(11, 5.5, utf8_decode($folio), 'B', 1, 'C');
...
$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(17, 6, utf8_decode('Domicilio (calle, número, colonia, localidad, municipio, estado: '), 0,1, 'L');
$pdf->SetFont('Arial', '', 8);
...
$pdf->MultiCell(190, 6, utf8_decode('Una vez que he sido debidamente informado del significado, creiterios de viabilidad, beneficios y compromiso de que mi parte implica el alojamiento conjunto mamá-recién nacido con el conocmiento que el contacto piel a piel entre la madre y el récien nacido permite mejores resultados en la duración de la lactancia materna, aumento en la regulación de la temperatura del recién nacido, reduce el llanto del bebé y promueve un mayor apego con su madre:'), 0, 'J');
$pdf->SetFont('Arial', 'B', 8);
$pdf->MultiCell(190, 6, utf8_decode('solicito y aceto el alojamiento conjunto mamá-recién nacido en la misma habitación en que permanezca durante mi internamiento hospitalizado'), 0, 'J');
$pdf->SetFont('Arial', '', 8);


$pdf->MultiCell(190, 6, utf8_decode('Entiendo que el alojamiento conjunto es la herramientaque permite tener a mi bebé conmigo 24 hrs, para amamantarlo a demanda de éstey desarrollar el apego tan necesariopara e éxito en la lactancia.'), 0, 'J');

$pdf->MultiCell(190, 6, utf8_decode('Acepto que durante el alojamiento conjunto mi bebé estará bajo mi resgardo, en el entendido que contaré con el apoyo del hospital para atender cualquier eventualidad que se presente, previa solicitud oportuna de la asistencia que necesite.'), 0, 'J');

$pdf->MultiCell(190, 6, utf8_decode('También acepto que de no sentirme capaz de responder a las necesidades de mi bebé, en cualquier momento podré solicitar la asistencia del hospital para garantizar la seguridad y bienestar de mi recién nacido.'), 0, 'J');

$pdf->MultiCell(190, 6, utf8_decode('Finalmente reconozco que he contado con el apoyo del hospital para la lactancia materna desde las primeras horas y días de vida de mi recién nacido, lo que sin duda influirá significativamente en sus alimentaciones futuras.'), 0, 'J');

$pdf->Ln(2);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(190, 6, utf8_decode('DATOS DEL RECIÉN NACIDO'), 0,0, 'C');
$pdf->Ln(6);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(10, 6, utf8_decode('Sexo:'), 0, 'L');
$pdf->Cell(30, 5.5, utf8_decode(''), 'B', 'L');

$pdf->Cell(29, 6, utf8_decode('Fecha de nacimiento:'), 0, 'J');
$pdf->Cell(46, 5.5, utf8_decode(''), 'B', 'L');
$pdf->Ln(7);

$pdf->Cell(41, 6, utf8_decode('Nombre completo de la madre:'), 0, 'J');
$pdf->Cell(151, 5.5, utf8_decode($actos), 'B', 'L');
$pdf->Ln(7);
$pdf->Cell(10, 6, utf8_decode('Firma:'), 0, 'J');
$pdf->Cell(182, 5.5, utf8_decode(''), 'B', 'L');
$pdf->Ln(7);

$pdf->Cell(56, 6, utf8_decode('Nombre completo del familiar responsable:'), 0, 'J');
$pdf->Cell(136, 5.5, utf8_decode(''), 'B', 'L');
$pdf->Ln(7);
...
$pdf->Cell(67, 6, utf8_decode('Nombre completo del personal que entrega al bebé:'), 0, 'J');
$pdf->Cell(125, 5.5, utf8_decode(''), 'B', 'L');
$pdf->Ln(7);


$pdf->Cell(10, 6, utf8_decode('Firma:'), 0, 'J');
$pdf->Cell(35, 5.5, utf8_decode(''), 'B', 'L');
$pdf->Cell(10, 6, utf8_decode('Cargo:'), 0, 'J');
$pdf->Cell(35, 5.5, utf8_decode(''), 'B', 'L');
$pdf->Ln(7);

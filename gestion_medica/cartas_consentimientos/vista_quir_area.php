...
<div class="container">
  ...
  <div class="col">
            ...
            <div class="table-responsive">
              <center><strong>NOTA GENERAL</strong></center>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                $fecha=$f['fecha'];
                    ...
                    <tr>
                        <td><a href="../../enfermera/registro_quirurgico/pdf_reg_areaquir.php?id_quir=<?php echo $id_quir; ?>&id_atencion=<?php echo $id_atencion; ?>&id_exp=<?php echo $id_exp; ?>&fechar=<?php echo $f['fecha']; ?>&horar=<?php echo $f['hora']; ?>"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>

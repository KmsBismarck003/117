...
<div class="container-fluid">
 <center>
         <a href="consent_lista.php" class="btn-sm btn-danger">Regresar...</a>
     </center>
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT DISTINCT(fechasistb) as fecham,id_rec_nac, id_atencion,horab,id_usua from iden_recnac WHERE id_atencion=$id_atencion ORDER BY id_rec_nac DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  ...
                  while ($row_enfermera = $result_enfermera->fetch_assoc()) {
                    ...
                    <tr>
                        <td><a href="../../enfermera/registro_clinico_neonatal/pdf_neonatal.php?id_rec_nac=<?php echo $id_rec_nac?>&id_atencion=<?php echo $id_atencion?>&id_exp=<?php echo $id_exp?>&fechar=<?php echo $fecham?>&hor=<?php echo $horab?>" target="_blank"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>
                        
                        <td><strong><?php $fecre=date_create($f['fecham']); echo date_format($fecre,"d-m-Y");?></strong></td>
                        <td><strong><?php echo $f['horab'];?></strong></td>
                        
                        <td><strong><?php $fecreg=date_create($f['fecham']); echo date_format($fecreg,"d-m-Y H:i:s");?></strong></td>
                        <td><strong><?php echo $user_papelld.' '.$user_sapelld.' '.$user_nombred ?> </strong></td>
                    </tr>
                    <?php
                }

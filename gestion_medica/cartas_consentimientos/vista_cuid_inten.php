...
-->
  ...
  <title>NOTA DE CUIDADOS INTENSIVOS</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>NOTA DE CUIDADOS INTENSIVOS </h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
?>
 ...
 $fecha_m=$f['fecha_m'];
                    ...
                    <tr>
                        <td><a href="../../enfermera/registro_terapeutico/pdf_reg_unid_cuid.php?id_enf_mat=<?php echo $id_enf_mat; ?>&id_atencion=<?php echo $id_atencion; ?>&id_exp=<?php echo $id_exp; ?>&fechar=<?php echo  $fecha_m; ?>&hora_m=<?php echo  $f['hora_m'] ?>"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>

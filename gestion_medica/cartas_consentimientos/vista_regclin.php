    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VISTA REGISTRO DE HOSPITALIZACIÓN - ENFERMERÍA</h2>
         <hr>
  <font size="2">
         <div class="container">
  <div class="row">
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  ...
                  while ($row_enfermera = $result_enfermera->fetch_assoc()) {
                    ...
                    <tr>
                        <td><a href="../../enfermera/pdf/pdf_reg_clin_enf.php?id_clinreg=<?php echo $id_clinreg?>&id_atencion=<?php echo $id_atencion?>&id_exp=<?php echo $id_exp?>&fechar=<?php echo $fecham?>&hora_mat=<?php echo $hora_mat?>"><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>

            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_cir_seg_amb=$f['id_cir_seg_amb'];
                    ...
                    <tr>
                        <td><a href="../cirugia_ambulatoria/pdf_cirugia_segura.php?id_cir_seg_amb=<?php echo $id_cir_seg_amb; ?>&id_exp=<?php echo $id_exp ?>&id=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

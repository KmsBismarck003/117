            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_preop_amb=$f['id_not_preop_amb'];
                    ...
                    <tr>
                        <td><a href="../cirugia_ambulatoria/pdf_nota_preoperatoria.php?id_not_preop_amb=<?php echo $id_not_preop_amb; ?>&id_exp=<?php echo $id_exp ?>&id=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

...
$resultado = $conexion->query("SELECT * from dat_not_postop_amb WHERE id_atencion=$id_atencion ORDER BY id_not_postp_amb DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_postp_amb=$f['id_not_postp_amb'];

                    ?>

                    <tr>
                        <td><a href="../quirurgico/pdf_nota_postoperatoria.php?id_not_postp_amb=<?php echo $id_not_postp_amb; ?>&id_exp=<?php echo $id_exp ?>&id=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

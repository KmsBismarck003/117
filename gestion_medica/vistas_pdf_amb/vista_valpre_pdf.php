    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>VALORACIÓN PRE-ANESTESICA</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
$resultado = $conexion->query("SELECT * from dat_peri_anest_amb WHERE id_atencion=$id_atencion ORDER BY id_peranest_amb DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_peranest_amb=$f['id_peranest_amb'];

                    ?>

                    <tr>
                        <td><a href="../pdf_amb/pdf_pre_anestesica.php?id_peranest_amb=<?php echo $id_peranest_amb; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

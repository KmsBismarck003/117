...
-->
  ...
  <title>EVALUACIÓN, INMEDIATAMENTE ANTES DEL PROCEDIMIENTO ANESTÉSICO</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>EVALUACIÓN, INMEDIATAMENTE ANTES DEL PROCEDIMIENTO ANESTÉSICO</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
...
$resultado = $conexion->query("SELECT * from dat_seg_evol_amb WHERE id_atencion=$id_atencion ORDER BY id_seg_evol_amb DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_seg_evol_amb=$f['id_seg_evol_amb'];

                    ?>

                    <tr>
                        <td><a href="../pdf_amb/pdf_2da_evaluacion.php?id_seg_evol_amb=<?php echo $id_seg_evol_amb; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha2']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['hora2']); echo date_format($date,"h:i");?></strong></td>
                    </tr>
                    <?php
                }
                ?>

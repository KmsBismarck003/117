...
include "../../conexionbd.php";
$resultado = $conexion->query("SELECT * from dat_trans_anest_amb WHERE id_atencion=$id_atencion ORDER BY id_trans_anest_amb DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_trans_anest_amb=$f['id_trans_anest_amb'];

                    ?>

                    <tr>
                        <td><a href="../pdf_amb/pdf_des_transanestesico.php?id_trans_anest_amb=<?php echo $id_trans_anest_amb; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

...
$pdf->Line(8, 45, 205, 45);
$pdf->Line(8, 45, 8, 280);
$pdf->Line(205, 45, 205, 280);
...
$pdf->Cell(13, 6, utf8_decode('PESO: ' .$peso), 1, 'L');
...
$pdf->Line(204, 88, 204, 238);
$pdf->Line(10, 238, 204, 238);

$pdf->SetX(70);
 $pdf->SetFont('Arial', 'B', 9);
 $pdf->MultiCell(75, 6, utf8_decode('TRATAMIENTO CONTROLADO'),0, 'C');
 $pdf->SetFont('Arial', '', 12);
 $pdf->MultiCell(194, 6, utf8_decode($med_cont), 0, 'L');
 $pdf->Ln(1);
...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(35, 6, date_format($date,"d-m-Y") . ' ' . $hor_pcita, 'B', 'L');

...
<?php } ?>
    ...
    <div class="content-search">
       ...
       // $id_amb=$_GET['id'];
        ...
        $select="SELECT * FROM receta_ambulatoria where nombre_rec='$nombre_rec' and papell_rec='$papell_rec' and sapell_rec='$sapell_rec' LIMIT 1";
               ...
               <div class="row">
                   <div class="col-sm">
                       <div class="form-group">
                           ...
                           <input type="text" name="nombre_rec" placeholder="Nombre(s)" value="<?php echo $row['nombre_rec'] ?>" class="form-control" style="text-transform:uppercase;" value=""  onkeyup="javascript:this.value=this.value.toUpperCase();">
                       </div>
                   </div>
                   <div class="col-sm">
                       <div class="form-group">
                           <label><strong>PRIMER APELLIDO :</strong></label><br>
                           <input type="text" name="papell_rec" placeholder="Apellido Paterno" value="<?php echo $row['papell_rec'] ?>" class="form-control" style="text-transform:uppercase;" value=""  onkeyup="javascript:this.value=this.value.toUpperCase();">
                       </div>
                   </div>
                   <div class="col-sm ">
                       <div class="form-group">
                           <label><strong>SEGUNDO APELLIDO :</strong></label><br>
                           <input type="text" name="sapell_rec" placeholder="Apellido Materno" value="<?php echo $row['sapell_rec'] ?>" class="form-control" style="text-transform:uppercase;" value=""  onkeyup="javascript:this.value=this.value.toUpperCase();">
                       </div>
                   </div>
               </div>
               <div class="row">
                   <div class="col-sm">
                       <div class="form-group">
                           ...
                           <input type="date" name="fecnac_rec" class="form-control" value="<?php echo $row['fecnac_rec'] ?>">
                       </div>
                   </div>
                   <div class="col-sm">
                       <div class="form-group">
...
<div class="row">
    ...
    <div class="col">
       <label>DETALLE ESPECIALIDAD (OTROS)</label><br>
        <input type="text" name="detesp" id="esp" placeholder="DETALLE ESPECIALIDAD" value="<?php echo $row['detesp'] ?>" disabled="" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
    </div>
    <div class="col">
        <label><strong>ALERGIA A MEDICAMENTOS:</strong></label>
        <input type="text" name="alergia_rec" placeholder="ALERGIA A MEDICAMENTOS" value="<?php echo $row['alerg_rec'] ?>" class="form-control"  style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
    </div>
</div>
<?php } ?>
<br>

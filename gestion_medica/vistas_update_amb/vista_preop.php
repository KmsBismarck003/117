...
include "../../conexionbd.php";
$id_atencion=$_GET['id_atencion'];
$resultado = $conexion->query("SELECT * from dat_not_preop_amb WHERE id_atencion=$id_atencion ORDER BY id_not_preop_amb DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_preop_amb=$f['id_not_preop_amb'];

                    ?>

                    <tr>
                        <td><a href="../updates_amb/update_preoperatoria.php?id_not_preop_amb=<?php echo $id_not_preop_amb ?>&id_atencion=<?php echo $id_atencion ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>

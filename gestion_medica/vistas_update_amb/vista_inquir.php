    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>NOTA INTERVENCIÓN QUIRÚRGICA</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_inquir_amb=$f['id_not_inquir_amb'];
                    ...
                    <tr>
                        <td><a href="../updates_amb/update_inquir.php?id_not_inquir_amb=<?php echo $id_not_inquir_amb; ?>&id_atencion=<?php echo $id_atencion ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>

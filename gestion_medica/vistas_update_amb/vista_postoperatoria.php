    ...
    ?>
      <div class="container ">
        <div class="content">
            ...
            <h2>NOTA NOTA POST-OPERATORIA</h2>
         <hr>
 <font size="2">
         <div class="container">
  <div class="row">
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_postp_amb=$f['id_not_postp_amb'];
                    ...
                    <tr>
                        <td><a href="../updates/update_postop.php?id_not_postp_amb=<?php echo $id_not_postp_amb; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>

            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_seg_evol_amb=$f['id_seg_evol_amb'];
                    ...
                    <tr>
                        <td><a href="../updates_amb/update_2ev.php?id_seg_evol_amb=<?php echo $id_seg_evol_amb; ?>&id_atencion=<?php echo $id_atencion ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>

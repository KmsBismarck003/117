            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_post_anest_amb=$f['id_post_anest_amb'];
                    ?>
                    <tr>
                        <td><a href="../updates_amb/update_postanest.php?id_post_anest_amb=<?php echo $id_post_anest_amb; ?>&id_atencion=<?php echo $id_atencion ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>

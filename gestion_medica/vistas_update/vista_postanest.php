...
-->
  ...
  <title>EDITAR NOTA POST-ANESTÉSICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from dat_post_anest WHERE id_atencion=$id_atencion ORDER BY id_post_anest DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_post_anest=$f['id_post_anest'];

                    ?>

                    <tr>
                        <td><a href="../updates/update_postanest.php?id_post_anest=<?php echo $id_post_anest; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_pos']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['hora_pos']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

...
-->
  ...
  <title>EDITAR NOTA DE RECUPERACIÓN</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_unid_cuid=$f['id_unid_cuid'];
                    ...
                    <tr>
                        <td><a href="../updates/update_unicuid.php?id_unid_cuid=<?php echo $id_unid_cuid; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>

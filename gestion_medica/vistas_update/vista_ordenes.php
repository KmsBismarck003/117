...
-->
  ...
  <title>VISTA ORDENES MEDICO</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
?>
           ...
           <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                     ...
                     ?>
                    <tr>
                        <td><a href="../updates/update_ordenes.php?id_ord=<?php echo $f['id_ord_med'];?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></td>

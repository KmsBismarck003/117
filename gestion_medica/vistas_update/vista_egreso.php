...
<head>
  ...
  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integXrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
...
-->
  ...
  <title>EDITAR NOTA DE EGRESO </title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
?></strong>
    ...
    <div class="col-sm-3">
      ...
      PESO: <strong><?php $sql_vit = "SELECT peso from dat_hclinica where Id_exp=$id_exp ";
$result_vit = $conexion->query($sql_vit);                                                                                    while ($row_vit = $result_vit->fetch_assoc()) {
  echo $row_vit['peso'];
      ...
      <div class="col-sm">
      TALLA: <strong><?php $sql_vitt = "SELECT talla from dat_hclinica where Id_exp=$id_exp";
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_egreso=$f['id_egreso'];
                    ...
                    <tr>
                        <td><a href="../updates/update_egreso.php?id_egreso=<?php echo $id_egreso; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        ...
                        <td><strong><?php $date=date_create($f['fech_egreso']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

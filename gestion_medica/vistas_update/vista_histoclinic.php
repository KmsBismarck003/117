...
$id_atencion=$_SESSION['hospital'];
$id_exp=$_GET['id_exp'];
$resultado = $conexion->query("SELECT * from dat_hclinica WHERE Id_exp=$id_exp ORDER BY id_hc DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_hc=$f['id_hc'];
                    ...
                    <tr>
                        <td><a href="../updates/histo_clinic.php?id_hc=<?php echo $id_hc; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['Id_exp'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fec_hc']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fec_hc']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

...
-->
  ...
  <title>EDITAR NOTA DE ALTA </title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from alta WHERE id_atencion=$id_atencion ORDER BY id_alta DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_alta=$f['id_alta'];
                    ...
                    <tr>
                        <td><a href="../updates/update_alta.php?id_alta=<?php echo $id_alta; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_altamed']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_altamed']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

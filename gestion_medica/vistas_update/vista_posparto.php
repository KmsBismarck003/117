            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_notpos=$f['id_notpos'];
                    ...
                    <tr>
                        <td><a href="../updates/update_posparto.php?id_notpos=<?php echo $id_notpos; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        ...
                        <td><strong><?php $date=date_create($f['fecha_nu']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_inter=$f['id_inter'];
                    ...
                    <tr>
                        <td><a href="../updates/update_inter.php?id_inter=<?php echo $id_inter; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        ...
                        <td><strong><?php $date=date_create($f['fecha_inter']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

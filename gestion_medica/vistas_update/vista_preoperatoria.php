...
-->
  ...
  <title>EDITAR NOTA PREOPERATORIA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from dat_not_preop WHERE id_atencion=$id_atencion ORDER BY id_not_preop DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_preop=$f['id_not_preop'];

                    ?>

                    <tr>
                        <td><a href="../updates/update_preoperatoria.php?id_not_preop=<?php echo $id_not_preop; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $id_exp;?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_preop']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_preop']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

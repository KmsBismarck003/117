...
-->
  ...
  <title>EDITAR NOTA INTERVENCIÓN QUIRÚRGICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_inquir=$f['id_not_inquir'];
                    ...
                    <tr>
                        <td><a href="../updates/update_inquir.php?id_not_inquir=<?php echo $id_not_inquir; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['hora_solicitud']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

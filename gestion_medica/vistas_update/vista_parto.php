            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_partograma=$f['id_partograma'];
                    ...
                    <tr>
                        <td><a href="../updates/update_parto.php?id_partograma=<?php echo $id_partograma; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>

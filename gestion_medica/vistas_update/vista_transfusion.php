...
-->
  ...
  <title>EDITAR NOTA DE TRASFUCIÓN </title>
  <style type="text/css">
    #contenido{
        display: none;
    }
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_tras=$f['id_tras'];
                    ...
                    <tr>
                        <td><a href="../updates/update_trasfusion.php?id_tras=<?php echo $id_tras; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fec_tras']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['inicio_tras']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

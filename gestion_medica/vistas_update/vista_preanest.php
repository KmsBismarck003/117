...
-->
  ...
  <title>EDITAR NOTA PRE-ANESTESICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from dat_peri_anest WHERE id_atencion=$id_atencion ORDER BY id_peranest DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_peranest=$f['id_peranest'];

                    ?>

                    <tr>
                        <td><a href="../updates/update_preanest.php?id_peranest=<?php echo $id_peranest; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>

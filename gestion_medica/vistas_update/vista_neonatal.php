            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_neona=$f['id_neona'];
                    ...
                    <tr>
                        <td><a href="../updates/update_neona.php?id_neona=<?php echo $id_neona; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td></a>
                        ...
                        <td><strong><?php $date=date_create($f['fecha_neona']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

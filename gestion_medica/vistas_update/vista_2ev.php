...
-->
  ...
  <title>EDITAR EVALUACIÓN, INMEDIATAMENTE ANTES DEL PROCEDIMIENTO ANESTÉSICO</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from dat_seg_evol WHERE id_atencion=$id_atencion ORDER BY id_seg_evol DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_seg_evol=$f['id_seg_evol'];

                    ?>

                    <tr>
                        <td><a href="../updates/update_2ev.php?id_seg_evol=<?php echo $id_seg_evol; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        ...
                        <td><strong><?php $date=date_create($f['fecha_nota']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

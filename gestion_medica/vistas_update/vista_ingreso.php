            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_ingreso=$f['id_not_ingreso'];
                    ...
                    <tr>
                        <td><a href="../updates/update_ingreso.php?id_not_ingreso=<?php echo $id_not_ingreso; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        ...
                        <td><strong><?php $date=date_create($f['fecha_dat_ingreso']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

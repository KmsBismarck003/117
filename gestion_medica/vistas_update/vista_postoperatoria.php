...
-->
  ...
  <title>EDITAR NOTA POST-OPERATORIA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_postp=$f['id_not_postp'];
                    ...
                    <tr>
                        <td><a href="../updates/update_postop.php?id_not_postp=<?php echo $id_not_postp; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        ...
                        <td><strong><?php $date=date_create($f['fecha_post']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_ob=$f['id_ob'];
                    ...
                    <tr>
                        <td><a href="../updates/update_noturgen.php?id_ob=<?php echo $id_ob; ?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
                        ...
                        <td><strong><?php $date=date_create($f['fecha_ob']); echo date_format($date,"H:i A");;?></strong></td>
                    </tr>
                    <?php
                }

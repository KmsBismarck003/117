                        ...
                        <div id="collapseRefraccion" class="collapse" aria-labelledby="headingRefraccion" data-parent="#eyeAccordion">
                            <div class="card-body">
                                <div class="container mt-4">
                                    ...
                                    <!-- Detalles de Refracción -->
                                    <div class="form-group mt-4">
                                        <label for="detalles_refraccion_visual"><strong>Detalles de Refracción:</strong></label>
                                        <div class="mb-2">
                                            <button type="button" class="btn btn-danger btn-sm" id="refraccion_grabar"><i class="fas fa-microphone"></i></button>
                                            <button type="button" class="btn btn-primary btn-sm" id="refraccion_detener"><i class="fas fa-microphone-slash"></i></button>
                                            <button type="button" class="btn btn-success btn-sm" id="play_refraccion"><i class="fas fa-play"></i></button>
                                        </div>
    ...
    <div class="card">
        ...
        <div id="collapseSinCiclo" class="collapse" data-parent="#eyeAccordion">
            <div class="card-body">
                ...
                <div class="form-group mt-4">
                    <label for="detalles_refraccion_visual"><strong>Detalles del Tratamiento:</strong></label>

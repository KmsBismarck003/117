...
<head>
    ...
    <title>Tratamiento Láser - Instituto de Enfermedades Oculares</title>
    <!-- Select2 CSS -->
...
<body>
            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">Paciente:
                        <strong><?php echo $pac_papell . ' ' . $pac_sapell . ' ' . $pac_nom_pac; ?></strong></div>
                    <div class="col-sm-4">Fecha de ingreso:
                        <strong><?php echo date_format(date_create($pac_fecing), "d/m/Y H:i:s"); ?></strong></div>
                </div>
                <div class="row">
                    <div class="col-sm-4">Fecha de nacimiento:
                        <strong><?php echo date_format(date_create($pac_fecnac), "d/m/Y"); ?></strong></div>
    ...
    <br><br>
    <div class="container">
        <div class="thead"><strong><center>TRATAMIENTO LÁSER</center></strong></div>
        <form action="insertar_tratamiento_laser.php" method="POST" onsubmit="return checkSubmit();">
                    ...
                    <div id="collapseRight" class="collapse show" aria-labelledby="headingRight" data-parent="#eyeAccordion">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="botones">
                                    <button type="button" class="btn btn-danger btn-sm" id="det_laser_derecho_grabar"><i class="fas fa-microphone"></i></button>
                                    <button type="button" class="btn btn-primary btn-sm" id="det_laser_derecho_detener"><i class="fas fa-microphone-slash"></i></button>
                                    <button type="button" class="btn btn-success btn-sm" id="play_det_laser_derecho"><i class="fas fa-play"></i></button>
                                </div>
                                <textarea class="form-control" name="detalles_laser_derecho" id="detalles_laser_derecho" rows="4" placeholder="Ej. Aplicación de láser YAG, potencia 2W"></textarea>
                                <script>
                    ...
                    <div id="collapseLeft" class="collapse" aria-labelledby="headingLeft" data-parent="#eyeAccordion">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="botones">
                                    <button type="button" class="btn btn-danger btn-sm" id="det_laser_izquierdo_grabar"><i class="fas fa-microphone"></i></button>
                                    <button type="button" class="btn btn-primary btn-sm" id="det_laser_izquierdo_detener"><i class="fas fa-microphone-slash"></i></button>
                                    <button type="button" class="btn btn-success btn-sm" id="play_det_laser_izquierdo"><i class="fas fa-play"></i></button>
                                </div>
                                <textarea class="form-control" name="detalles_laser_izquierdo" id="detalles_laser_izquierdo" rows="4" placeholder="Ej. Aplicación de láser YAG, potencia 2W"></textarea>
                                <script>
                                const det_laser_izquierdo_grabar = document.getElementById('det_laser_izquierdo_grabar');
                                const det_laser_izquierdo_detener = document.getElementById('det_laser_izquierdo_detener');

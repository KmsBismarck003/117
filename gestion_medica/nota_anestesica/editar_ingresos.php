      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            $sql = "SELECT * from ingresos_anest where id_ing_anest = $id";
...
<br>
      ...
      if (isset($_POST['edit'])) {
        ...
        $sql2 = "UPDATE ingresos_anest SET horaa = '$horaa', descripcion = '$descripcion',cantidad = '$cantidad' WHERE id_ing_anest = $id";

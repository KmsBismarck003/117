      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div>
            ...
            $sql = "SELECT * from medica_trans where id_mtrans= $id";
...
<div class="container">
  <div class="row">
    <div class="col-sm-3">
     <div class="form-group">
                  ...
                  <input type="time" class="form-control" value="<?php echo $row_datos['hora']?>" id="hor" name="hora_mat" required="">
  ...
  <div class="row">
   ...
   <select data-live-search="true" class="form-control" name="medicam_mat" id="pa" style="width : 100%; heigth : 100%" required="">
       <option value="<?php echo $row_datos['medicamento']?>"><?php echo $row_datos['medicamento']?></option>
         <?php
    ...
    <div class="col-sm-2">
      <div class="form-group">
                  ...
                  value="<?php echo $row_datos['dosis']; ?>" required>
                </div>
    </div>
    <div class="col-sm-3">
      <div class="form-group">
    ...
    <div class="col-sm-3">
      <div class="form-group">
                  ...
                  <select name="via_mat" class="form-control">
                       <option value="<?php echo $row_datos['via']; ?>"><?php echo $row_datos['via']; ?></option>
...
<br>
 ...
 $tipo    = mysqli_real_escape_string($conexion, (strip_tags($_POST["tipo"], ENT_QUOTES)));
        ...
        $sql2 = "UPDATE medica_trans SET fecha = '$fecha_mat',hora = '$hora_mat', medicamento = '$medicam_mat',dosis = '$dosis_mat',unimed = '$unimed', via = '$via_mat',otro = '$otro' WHERE id_mtrans  = $id";

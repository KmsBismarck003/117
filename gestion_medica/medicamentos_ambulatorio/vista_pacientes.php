...
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp WHERE dat_ingreso.area='QUIROFANO' && dat_ingreso.alta_med='NO' ") or die($conexion->error);
?>   
<!DOCTYPE html>
<html>
...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size:24px;">
  <center><strong>INSUMOS QUIRÚRGICOS PACIENTES AMBULATORIOS</strong></center><p>
</div>     
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        <td><a href="confirmar.php?id_exp=<?php echo $f['Id_exp'];?>&id_usua=<?php echo $usuario['id_usua'] ?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button></td>

...
if (isset($_SESSION['hospital'])) { //si existe el id mandado por metodo GET, se hara la consulta donde el id debe ser igual al id mandado por el metodo GET
    $resultado = $conexion->query("select paciente.*,dat_ingreso.id_atencion
from paciente 
...
<head>
    ...
    <title>Datos de Transfuciones</title>
    ...
    <div class="container">
 <center>
                    <a href="../hospitalizacion/vista_pac_hosp.php" class="btn btn-danger">REGRESAR...</a>
        ...
        <div class="row">
                ...
                <center>
                    <h5>
                        <a href="" data-target="#sidebar" data-toggle="collapse" class="d-md-none"><i class="fa fa-bars"
                                                                                                      id="side"></i></a>
                       <strong><font id="letra">DOCUMENTACIÓN</font></h5></strong> 
                    <hr>
                </center>
                ...
                <div class="table-responsive">
                    ...
                    while ($f = mysqli_fetch_array($resultado)) {
                        ...
                        <tr> 
   <td scope="row" id="letra" align="center"><a type="submit" href="pdf_ingreso.php?Id_exp=<?php echo $f['Id_exp']; ?>&id_atencion=<?php echo $f['id_atencion']; ?>&id_usua=<?php echo $usuario['id_usua']; ?>"><button type="button" class="btn-danger "><i class="fa fa-file-pdf-o"
                                           style="font-size:28px"></i></button></td>       

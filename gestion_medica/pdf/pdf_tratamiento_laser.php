...
$pdf->Cell(0, 10, utf8_decode('REPORTE DE TRATAMIENTO LÁSER OCULAR'), 0, 1, 'C');
$pdf->Ln(5);
...
// Laser treatment details in two columns
...
$left_eye_fields = [
    'Tipo de láser' => $laser['tipo_laser_izquierdo'] ?? 'Selecciona',
    'Detalles' => $laser['detalles_laser_izquierdo'] ?? 'N/A',
];

$right_eye_fields = [
    'Tipo de láser' => $laser['tipo_laser_derecho'] ?? 'Selecciona',

            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        ...
                        <td><a href="../hospitalizacion/pdf_recetario_medico_hospitalizacion.php?id_med=<?php echo $f['id_usua'];?>&id=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>&id_exp=<?php echo $row['Id_exp'] ?>&id_rec=<?php echo $f['id_rec'] ?>" target="_blank"><button type="button" class="btn btn-danger"> <i class="fa fa-file-pdf-o" style="font-size:28px"  aria-hidden="true"></i> </button></td>

...
$sql_tras = "SELECT * from mediciones_cornea where id_exp=$id_exp";
...
$pdf->Cell(110, 9, utf8_decode('NOTA MEDICIONES DE LA CORNEA'), 1, 0, 'C');
$pdf->SetX(160);
$pdf->SetFont('Arial', '', 6);
...
$sql_cornea = "SELECT * FROM mediciones_cornea WHERE id=$id_in AND id_exp=$id_exp";
$result_cornea = $conexion->query($sql_cornea);

if ($row_cornea = $result_cornea->fetch_assoc()) {
  $od_dcv = $row_cornea['od_dcv'];
  $od_dch = $row_cornea['od_dch'];
  $od_dpf = $row_cornea['od_dpf'];
  $od_dpm = $row_cornea['od_dpm'];
  $od_micro = $row_cornea['od_micro'];
  $od_paq = $row_cornea['od_paq'];

  $oi_dcv = $row_cornea['oi_dcv'];
  $oi_dch = $row_cornea['oi_dch'];
  $oi_dpf = $row_cornea['oi_dpf'];
  $oi_dpm = $row_cornea['oi_dpm'];
  $oi_micro = $row_cornea['oi_micro'];
  $oi_paq = $row_cornea['oi_paq'];
}

// Título OD
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(190, 6, utf8_decode('Mediciones Corneales - Ojo Derecho (OD)'), 1, 1, 'C');

// Contenido OD
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(38, 6, utf8_decode('DCV'), 1, 0, 'L');
$pdf->Cell(57, 6, utf8_decode($od_dcv), 1, 0, 'L');
$pdf->Cell(38, 6, utf8_decode('DCH'), 1, 0, 'L');
$pdf->Cell(57, 6, utf8_decode($od_dch), 1, 1, 'L');

$pdf->Cell(38, 6, utf8_decode('DPF'), 1, 0, 'L');
$pdf->Cell(57, 6, utf8_decode($od_dpf), 1, 0, 'L');
$pdf->Cell(38, 6, utf8_decode('DPM'), 1, 0, 'L');
$pdf->Cell(57, 6, utf8_decode($od_dpm), 1, 1, 'L');

$pdf->Cell(38, 6, utf8_decode('Microscopía Especular'), 1, 0, 'L');
$pdf->Cell(152, 6, utf8_decode($od_micro), 1, 1, 'L');

$pdf->Cell(38, 6, utf8_decode('Paquimetría'), 1, 0, 'L');
$pdf->Cell(152, 6, utf8_decode($od_paq), 1, 1, 'L');

// Título OI
$pdf->Ln(5);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(190, 6, utf8_decode('Mediciones Corneales - Ojo Izquierdo (OI)'), 1, 1, 'C');

// Contenido OI
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(38, 6, utf8_decode('DCV'), 1, 0, 'L');
$pdf->Cell(57, 6, utf8_decode($oi_dcv), 1, 0, 'L');
$pdf->Cell(38, 6, utf8_decode('DCH'), 1, 0, 'L');
$pdf->Cell(57, 6, utf8_decode($oi_dch), 1, 1, 'L');

$pdf->Cell(38, 6, utf8_decode('DPF'), 1, 0, 'L');
$pdf->Cell(57, 6, utf8_decode($oi_dpf), 1, 0, 'L');
$pdf->Cell(38, 6, utf8_decode('DPM'), 1, 0, 'L');
$pdf->Cell(57, 6, utf8_decode($oi_dpm), 1, 1, 'L');

$pdf->Cell(38, 6, utf8_decode('Microscopía Especular'), 1, 0, 'L');
$pdf->Cell(152, 6, utf8_decode($oi_micro), 1, 1, 'L');

$pdf->Cell(38, 6, utf8_decode('Paquimetría'), 1, 0, 'L');
$pdf->Cell(152, 6, utf8_decode($oi_paq), 1, 1, 'L');

$pdf->Ln(5);
$pdf->SetFont('Arial', 'I', 7);
$fecha_registro = $row_cornea['fecha_registro'];

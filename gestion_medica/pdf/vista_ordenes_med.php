...
<body>
  <div class="container">
    ...
    <hr>
    <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>IMPRESIÓN DE INDICACIONES MÉDICAS </center> </strong></div>
...
?>
           ...
           <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                     ...
                     ?>
                    <tr>
                        <td><a href="../pdf/pdf_ordenes_medico.php?id_ord=<?php echo $f['id_ord_med'];?>&id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>&id_exp=<?php echo $row['Id_exp'] ?>" target="_blank"><button type="button" class="btn btn-danger"> <i class="fa fa-file-pdf-o" style="font-size:28px"  aria-hidden="true"></i> </button></a></td>

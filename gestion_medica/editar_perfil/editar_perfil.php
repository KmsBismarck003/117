...
if( isset($_GET['id_usua'])) { //si existe el id mandado por metodo GET, se hara la consulta donde el id debe ser igual al id mandado por el metodo GET
  ...
  if(mysqli_num_rows($resultado) > 0 ){ //se mostrara si existe mas de 1
    ...
    header("location: menu_medico.php"); //te regresa a la página principal
  }
}else{
  header("location: menu_medico.php"); //te regresa a la página principal
}
...
<div class="container-fluid">
    ...
    <div class="row">       
         ...
         <div class="row">
    <div class="col">
       No. USUARIO: <strong><?php echo $f[0];?></strong> <br>
     NOMBRE DEL USUARIO: <strong><?php echo $f[2];?>
      <?php echo $f[3];?>
...
<hr>
    ...
    <center>
            ...
            <a href="../../template/menu_medico.php" class="btn btn-danger">Cancelar</a>
    </center>
...
//firma.jpg
     ...
     // echo $sql2;
      // return 'hbgk';
        ...
        echo '<script type="text/javascript">window.location ="../../template/menu_medico.php"</script>';
      }
?>
 </div>

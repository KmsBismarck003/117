...
<?php 
$id_post_anest_amb=$_GET['id_post_anest_amb'];
$alta="SELECT * FROM dat_post_anest_amb where id_post_anest_amb=$id_post_anest_amb";
...
<div class="form-group">
    ...
    <input type="text" name="con_pos" class="form-control" value="<?php echo $row['con_pos'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
  </div>
  <hr>
<div class="form-group">
    <label for="exampleFormControlTextarea2"><strong>BALANCE HÍDRICO</strong></label>
    <input type="text" name="bal_pos" class="form-control" value="<?php echo $row['bal_pos'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
  </div>
<hr>

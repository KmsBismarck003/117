...
<form action="" method="POST">
        ...
        <?php 
$id_not_inquir_amb=$_GET['id_not_inquir_amb'];
$alta="SELECT * FROM dat_not_inquir_amb where id_not_inquir_amb=$id_not_inquir_amb";
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm">
      ...
      <input type="text" name="medmat_necesario" class="form-control" value="<?php echo $row['medmat_necesario'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
    </div>
  </div>
</div>
<?php } ?>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-5">
      ...
      <input type="text" name="cir_realizada" class="form-control" value="<?php echo $row['cir_realizada'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
    </div>
    <div class="col-2">
      <div class="form-group">
    ...
    <div class="col-sm">
      ...
      <div class="row">
               <div class="col-sm-6">
                ...
                <input type="text" name="trans" class="form-control" value="<?php echo $row['trans'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>POSTOPERATORIOS</label>
                  <input type="text" name="posto" class="form-control" value="<?php echo $row['posto'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                     </div>
                </div>
         </div>
  </div>
...
<div class="form-group">
    ...
    <input type="text" name="nota_preop" class="form-control" value="<?php echo $row['nota_preop'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
  </div>
</div>
...
<div class="form-group">
    ...
    <input type="text" name="comentario_final" class="form-control" value="<?php echo $row['comentario_final'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
  </div>
  <div class="form-group">
    <label for="exampleFormControlTextarea1"><strong>PLAN TEREPEÚTICO (POST OPERATORIO):</strong></label>
    <input type="text" name="plan_tera" class="form-control" value="<?php echo $row['plan_ter'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
  </div>
</div>

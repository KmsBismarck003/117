...
<strong><center>NOTA POSTPARTO</center></strong>
</div>
                <hr>
<?php
...
<div class="tab-pane fade show active" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
          ...
          <form action="insertar_nota_posparto.php" method="POST">
<br>
...
$resultado5=$conexion->query("select * from signos_vitales WHERE id_atencion=" . $_SESSION ['hospital'].".ORDER by id_sig DESC LIMIT 1") or die($conexion->error);
  ...
  <div class="col"><input type="text" class="form-control" value="<?php echo $f5['p_diastol'];?>" disabled></div>
    ...
    <div class="col-sm-2">
      FRECUENCIA <br>CARDIACA:<input type="text" class="form-control" value="<?php echo $f5['fcard'];?>" disabled>
    </div>
    <div class="col-sm-2">
      FRECUENCIA <br>RESPIRATORIA:<input type="text" class="form-control" value="<?php echo $f5['fresp'];?>" disabled>
    </div>
    <div class="col-sm-2">
     <br>TEMPERATURA:<input type="text" class="form-control" value="<?php echo $f5['temper'];?>" disabled>
    </div>
    <div class="col-sm-2">
     SATURACIÓN <br>OXÍGENO:<input type="text"  class="form-control" value="<?php echo $f5['satoxi'];?>" disabled>
    </div>
...
<?php 
  ...
  <div class="col"><input type="text" class="form-control" name="p_diastol"></div>
    ...
    <div class="col-sm-2">
      FRECUENCIA <br> CARDIACA:<input type="text" class="form-control" name="fcard">
    </div>
    <div class="col-sm-2">
      FRECUENCIA <br>RESPIRATORIA:<input type="text" class="form-control" name="fresp">
    </div>
    <div class="col-sm-2">
     <br>TEMPERATURA:<input type="text" class="form-control"  name="temper">
    </div>
    <div class="col-sm-2">
     SATURACIÓN <br>OXÍGENO:<input type="text"  class="form-control" name="satoxi">
    </div>
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5" color="#2b2d7f">S</font></label></strong></center>
 ...
 <strong><font color="black">SUBJETIVO: DESCRIBIR LA SINTOMATOLOGÍA DEL PACIENTE, HÁBITOS, A QUE ATRIBUYE EL PADECIMIENTO ACTUAL, ETC.</font></strong> 
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="subjetivo" placeholder="SUBJETIVO: DESCRIBIR LA SINTOMATOLOGÍA DEL PACIENTE, HÁBITOS, A QUE ATRIBUYE EL PADECIMIENTO ACTUAL, ETC." class="form-control" id="exampleFormControlTextarea1" rows="3" name="subjetivo" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5"color="#2b2d7f">O</font></label></strong></center>
 ...
 <strong><font color="black">OBJETIVO: DESCRIBIR LA EXPLORACIÓN FÍSICA</font></strong> 
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="objetivo" placeholder="OBJETIVO: DESCRIBIR LA EXPLORACIÓN FÍSICA"style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5"color="#2b2d7f">P</font></label></strong></center>
    ...
    <div class=" col-10">
     ...
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="plan" placeholder="PLAN: DESCRIBIR TRATAMIENTO Y RECOMENDACIONES INDICADAS AL PACIENTE, ANOTAR LOS MEDICAMENTOS CON SU DOSIS DE MANERA DETALLADA."style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
...
<center><strong><label for="exampleFormControlTextarea1"><br><font size="5"color="#2b2d7f">PX</font></label></strong></center>
    ...
    <div class=" col-10">
     ...
     <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="px" placeholder="PRONÓSTICO: PARA LA VIDA Y PARA LA FUNCIÓN"style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
  </div>
    </div>
</div>
<div class="row">
<div class=" col"><STRONG>GUIA DE PRÁCTICA CLÍNICA</STRONG>
    <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="guia" placeholder="GUIA DE PRACTICA CLÍNICA" onkeyup="javascript:this.value=this.value.toUpperCase();" style="text-transform:uppercase;"></textarea>
    </div>
</div>
</div>
<hr>
<div class="row">
<div class="col-3">
<center><strong><label for="edosalud"><font size="5"color="#2b2d7f">ESTADO DE SALUD:</font></label></strong></center>
    </div>
<div class=" col-5">

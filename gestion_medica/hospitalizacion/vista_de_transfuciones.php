...
<strong><center>TRANSFUSIONES SANGUINEAS</center></strong>
</div>
                <hr>
<?php
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm">
    <a href="nota_trasfusion_new.php"><button type="button" class="btn btn-danger">NUEVA ORDEN DE TRASFUSIÓN SANGUINEA</button></a>
  </div>
  </div>
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        <td><a href="nota_trasfusion.php?id_sang=<?php echo $f['id_sangre'];?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button></td>

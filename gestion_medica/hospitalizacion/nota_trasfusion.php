...
$id_sang=$_GET['id_sang'];
 ?>
<form action="insert_tras.php?id_sang=<?php echo $id_sang; ?>" method="POST">
  <?php 
  ...
  <div class="row">
    <div class="col-sm">
        <div class="form-group">
           ...
           <input type="text" name="fec_tras" value="<?php echo $fecht; ?>" class="form-control" disabled="">
        </div>
    </div>
    <div class="col-sm">
        <div class="form-group">
    ...
    <div class="col-sm">
        <div class="form-group">
           ...
           <input type="text" name="cont_tras" value=" <?php echo $cont; ?> " placeholder="CONTENIDO (CANTIDAD)" class="form-control" disabled>
        </div>
    </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
             ...
             <input type="text" name="fol_tras" placeholder="FOLIO" value=" <?php echo $folio; ?>" class="form-control" disabled>
          </div>
        </div>
    </div><hr>
    <div class="row">
  ...
  <div class="row">
    <div class="col">
      <div class="form-group">
        ...
        <input type="number" name="hb_tras" placeholder="HB" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
      </div>
    </div>
    <div class="col">
      <div class="form-group">
        <label>HEMATOCRITO:</label>
        <input type="number" name="hto_tras" placeholder="HTO" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
      </div>
    </div>
    <div class="col">
      <div class="form-group">
        <label>GRUPO SANGUINEO:</label>
        <input type="text" name="san_tras" placeholder="GRUPO SANGUINEO" value="<?php echo $sang; ?>" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled>
      </div>
    </div>
  </div><hr>
...
$resultado2=$conexion->query("SELECT * from dat_trans_sangre WHERE id_sangre=$id_sang") or die($conexion->error);
 ...
 <div class="container"> 
  <div class="row">
    ...
    <div class="col-sm-2">
     ...
     <div class="row">
  <div class="col"><input type="text" class="form-control" value="<?php echo $f2['t'];?>" ></div> /
  <div class="col"><input type="text" class="form-control" value="<?php echo $f2['a'];?>" ></div>
 
</div>
    </div>
    <div class="col-sm-2">
      FRECUENCIA CARDIACA:<input type="text" class="form-control" value="<?php echo $f2['fc'];?>" >
    </div>
    <div class="col-sm-2">
     <br>TEMPERATURA:<input type="text" class="form-control" value="<?php echo $f2['temp_t'];?>" >
    </div>
  </div>
</div>
<?php 
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        ...
        <input type="text" name="inicio_tras" value=" <?php echo $hor_in; ?>" class="form-control" disabled>
      </div>
    </div>
  </div>
    <div class="row">
 ...
 <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 19px;">
  ...
  <div class="row">
    ...
    <div class="col-sm-2">
      ...
      <center>PRESIÓN ARTERIAL:</center>
     <div class="row">
  <div class="col"><input type="text" class="form-control" name="sist1" value="<?php echo $f2['td'];?>" ></div> /
  <div class="col"><input type="text" class="form-control" name="diast1" value="<?php echo $f2['ad'];?>" ></div>
 
</div>
    </div>
    <div class="col-sm-2">
      FRECUENCIA CARDIACA:<input type="text" class="form-control" name="frec1" value="<?php echo $f2['fcd'];?>" >
    </div>
    <div class="col-sm-2">
     <br>TEMPERATURA:<input type="text" class="form-control" name="temp1" value="<?php echo $f2['temp_td'];?>" >
    </div>
  </div>
</div>
<?php 
 ...
 <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 19px;">
  ...
  <div class="row">
    ...
    <div class="col-sm-2">
      ...
      <center>PRESIÓN ARTERIAL:</center>
     <div class="row">
  <div class="col"><input type="text" class="form-control" name="sist2" value="<?php echo $f2['tde'];?>" ></div> /
  <div class="col"><input type="text" class="form-control" name="diast2" value="<?php echo $f2['ade'];?>" ></div>
 
</div>
    </div>
    <div class="col-sm-2">
      FRECUENCIA CARDIACA:<input type="text" class="form-control" name="frec2" value="<?php echo $f2['fcde'];?>" >
    </div>
    <div class="col-sm-2">
     <br>TEMPERATURA:<input type="text" class="form-control" name="temp2" value="<?php echo $f2['temp_tde'];?>" >
    </div>
  </div>
</div>
<?php 
...
<hr>
    ...
    <div class="col">
      <div class="form-group">
        <br>VOLUMEN TRANSFUNDIDO:<input type="text" class="form-control" value=" <?php echo $vol; ?>" name="vol_tras" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled>
      </div>
    </div>
    <div class="col">
      <div class="form-group">
        <br>HORA DE TERMINO:<input type="text" class="form-control" value=" <?php echo $hor_t; ?>" name="fin_tras"  disabled>
      </div>
    </div>
  </div> 
  <div class="row">

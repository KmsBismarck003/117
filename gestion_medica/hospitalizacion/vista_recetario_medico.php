    ...
    <div class="row">
        ...
        <div class="col col-12">
            <h2>
                ...
                <center><font id="letra"> VISTA RECETARIO MÉDICO</font></h2> </center>
            ...
            <div class="form-group">
                <a href="buscar_recetario_medico_hos.php"><button type="button" class="btn btn-success btn-sm col-md-5"  data-target="#exampleModal">
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        <td><a href="./recetario_medico.php?id_atencion=<?php echo $f['id_atencion'];?>&id_usua=<?php echo $usuario['id_usua'] ?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button></td>

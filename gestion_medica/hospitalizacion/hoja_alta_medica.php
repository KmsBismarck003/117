...
<hr>
   ...
   <!--INICIO -->
<form action="insertar_alta.php" method="POST">
        ...
        <div class="form-group">
           ...
           <div class="row">
              <div class="col">
                ...
                <input type="radio" name="alta_por" value="MÁXIMO BENEFICIO"> <label>MÁXIMO BENEFICIO</label><br>
                <input type="radio" name="alta_por" value="ALTA VOLUNTARIA"> <label>ALTA VOLUNTARIA</label><br>
                <input type="radio" name="alta_por" value="DEFUNCIÓN"> <label>DEFUNCIÓN</label><br>
                <input type="radio" name="alta_por" value="TRANSLADO A OTRA INSTITUCIÓN"> <label>  TRANSLADO A OTRA INSTITUCIÓN</label>
              </div>
            </div>    
        </div>
    </div>
...
<div class="row">
    <div class="col">
        OBSERVACIONES:<div class="botones">
...
<textarea class="form-control" id="texto" name="obs_med" rows="3"></textarea>

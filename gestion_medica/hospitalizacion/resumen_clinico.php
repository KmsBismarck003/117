...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 24px;">
  <center><strong>RESUMEN CLÍNICO</strong></center><p>
</div> 
...
<hr>
   ...
   <!--INICIO -->
<form action="insertar_resumen.php" method="POST">
...
<textarea class="form-control" id="texto" name="resumen" rows="25"></textarea>
...
<div class="row">
    ...
    <div class=" col-sm-8">
<strong><button type="button" class="btn btn-success btn-sm" id="playacli"><i class="fas fa-play"></button></i>  Guía de práctica clínica:</strong>
...
const btnPlayTgp = document.getElementById('playacli');

btnPlayTgp.addEventListener('click', () => {

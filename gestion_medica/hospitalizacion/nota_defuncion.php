...
<div class="thead" style="background-color: #2b2d7f; color: white; font-size: 24px;">
  <center><strong>NOTA DE DEFUNCIÓN</strong></center><p>
</div> 
...
<hr>
  ...
  <hr>
   <!--INICIO -->
<form action="insertar_defuncion.php" method="POST">
...
<div class="row">
    <div class="col">
        <strong>Nota de defunción :</strong>
        <div class="botones">
...
<button type="button" class="btn btn-success btn-sm" id="playadef"><i class="fas fa-play"></button></i>
</div> 
<textarea class="form-control" id="texto" name="defuncion" rows="10"></textarea>
 <script type="text/javascript">
const btnStartRecord = document.getElementById('btnStartRecord');
const btnStopRecord = document.getElementById('btnStopRecord');
const texto = document.getElementById('texto');

const btnPlayTextdea = document.getElementById('playadef');

        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col col-12">
                    ...
                    <a href="../urgencias/vista_usuario_triage.php" class="btn btn-danger">Regresar...</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="mytable">
                            ...
                            <?php
                            $resultado = $conexion->query("select paciente.*, dat_ingreso.id_atencion, dat_c_obs.id_triage, dat_c_obs.fecha_t
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp
inner join dat_c_obs on dat_ingreso.id_atencion=dat_c_obs.id_atencion where id_triage=id_triage ORDER BY fecha_t DESC
...
?>
                        ...
                        <td><a type="submit" class="btn btn-danger btn-sm" href="pdf_consulta.php?tri= <?php echo $f['id_triage'] ?>&id=<?php echo $f['id_atencion']; ?>&id_med=<?php echo $id_usua ?>&rec=<?php echo $id_rec_urgen ?>"target="_blank"><span class="fa fa-file-pdf-o"style="font-size:28px"></span></a></td>

                        <td><a type="submit" class="btn btn-danger btn-sm" href="pdf_receta_urgen.php?id=<?php  echo $f['id_atencion']; ?>&id_med=<?php echo $usuario['id_usua'] ?>&id_exp=<?php echo $f['Id_exp']; ?>"target="_blank"><span class="fa fa-file-pdf-o"style="font-size:28px"></span></a></td>

...
from paciente 
inner join dat_ingreso on paciente.Id_exp=dat_ingreso.Id_exp WHERE dat_ingreso.area='TRIAGE' AND dat_ingreso.activo='SI' ") or die($conexion->error);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="row">
        ...
        <div class="col col-12">
                ...
                <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;">
                           <tr><strong><center>PACIENTES EN ESPERA DE ATENCIÓN</center></strong>
                </div>
                <hr>
            <div class="row">
                <div class="col-6"><a href="buscar_triage.php"><button type="button" class="btn btn-primary btn-sm"  data-target="#exampleModal">
                            <i class="fa fa-plus"></i><font id="letra"> Buscar notas registradas </font></button></div>
            </div>
                ...
                while($f = mysqli_fetch_array($resultado)){
                    ...
                    <tr>
                        ...
                        <td scope="row" id="letra" align="center">
                            <a href="../urgencias/triage_new.php?id_atencion=<?php echo $f['id_atencion'];?>"><button type="button" class="btn btn-danger"> <i class="fa fa-heartbeat" aria-hidden="true"></i> </button><strong></strong></td>

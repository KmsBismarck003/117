...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from dat_not_postop WHERE id_atencion=$id_atencion ORDER BY id_not_postp DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_postp=$f['id_not_postp'];

                    ?>

                    <tr>
                        <td><a href="../quirurgico/pdf_nota_postoperatoria.php?id_not_postp=<?php echo $id_not_postp; ?>&id_exp=<?php echo $id_exp ?>&id=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_post']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_post']); echo date_format($date,"h:i");?></strong></td>
                    </tr>
                    <?php
                }
                ?>

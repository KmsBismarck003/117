...
<head>
    <meta charset="UTF-8">
    <title>Vista Recomendaciones Oculares</title>
...
<body>
    <div class="container">
        ...
        <div class="thead text-center" style="background-color: #2b2d7f; color: white; font-size: 22px;">
            <strong>IMPRESIÓN DE RECOMENDACIONES OCULARES</strong>
        </div>
        <section class="content container-fluid">
            ...
            <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ¡Recomendaciones registradas correctamente!
            ...
            <?php if (isset($_SESSION['msg'])): ?>
                ...
                <?php unset($_SESSION['msg']); unset($_SESSION['message_type']); ?>
            <?php endif; ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="mytable">
                                ...
                                <tbody>
                                    <?php
                                    $sql_rec = "SELECT id_recomendacion, fecha_registro FROM ocular_recomendaciones WHERE id_atencion = ? ORDER BY fecha_registro DESC";
                                    $stmt_rec = $conexion->prepare($sql_rec);
                                    if (!$stmt_rec) {
                                        die("Error preparando consulta de recomendaciones: " . $conexion->error);
                                    }
                                    ...
                                    while ($row = $result_rec->fetch_assoc()) {
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../pdf/pdf_recomendaciones.php?id_recomendacion=<?php echo (int)$id_recomendacion; ?>&id_exp=<?php echo (int)$id_exp; ?>&id_atencion=<?php echo (int)$id_atencion; ?>" target="_blank">
                                                    <button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button>
                                                </a>
                                            </td>
                                            <td><strong><?php echo date_format(date_create($row['fecha_registro']), "d/m/Y"); ?></strong></td>
                                            <td><strong><?php echo date_format(date_create($row['fecha_registro']), "H:i"); ?> horas</strong></td>
                                        </tr>
                                        <?php
                                    }
                                    $stmt_rec->close();

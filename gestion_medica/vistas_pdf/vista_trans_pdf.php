            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_trans_anest=$f['id_trans_anest'];
                    ...
                    <tr>
                        <td><a href="../pdf/pdf_des_transanestesico.php?id_trans_anest=<?php echo $id_trans_anest; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>&fecha=<?php echo $f['fecha_reporte']?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

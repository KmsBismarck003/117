...
<head>
    <meta charset="UTF-8">
    <title>Vista Nota Post Anestésica</title>
    <link rel="stylesheet" type="text/html" href="css/select2.css">
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"
        integrity="sha384-OgVRvuATP1z7JjHLkuOU7eXw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script>
    <script src="../../js/jquery-ui.js"></script>
    <script src="js/jquery.magnific-popup.min.js"></script>
    <script src="js/aos.js"></script>    <script src="js/main.js"></script>
    <style>
...
<body>
    <div class="container-fluid">
        ...
        <div class="thead text-center" style="background-color: #2b2d7f; color: white; font-size: 22px;">
            <strong>NOTA POST ANESTÉSICA</strong>
        </div>
        <section class="content container-fluid">
            ...
            <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ¡Nota post anestésica registrada correctamente!
                    ...
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="mytable">
                                ...
                                <tbody>
                                    <?php
                                    $sql_postanest = "SELECT * FROM nota_post_anestesia_oftalmologia WHERE id_atencion = ? ORDER BY fecha_registro DESC";
                                    $stmt_postanest = $conexion->prepare($sql_postanest);
                                    $stmt_postanest->bind_param("i", $id_atencion);
                                    $stmt_postanest->execute();
                                    $result_postanest = $stmt_postanest->get_result();
                                    while ($f = $result_postanest->fetch_assoc()) {
                                        $id_nota = $f['id_nota'];
                                        ?>
                                        <tr>
                                            <td>
                                                <a href="../pdf/pdf_post_anestesia.php?id_nota=<?php echo (int)$id_nota; ?>&id_exp=<?php echo (int)$id_exp; ?>&id_atencion=<?php echo (int)$id_atencion; ?>" target="_blank">

...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="css/select2.css">
  ...
  <title>Vista Mediciones de la Cornea</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
     ...
     <button type="button" class="btn btn-danger btn-sm" onclick="history.back()">Regresar...</button>
              <hr>
               <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>
                   IMPRESIÓN DE MEDICIONES DE LA CORNEA</center> </strong></div>         
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from mediciones_cornea WHERE id_exp=$id_exp ORDER BY id DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id=$f['id'];
                    ...
                    ?>
                    <tr>
                        <td><a href="../pdf/pdf_mediciones_cornea.php?id=<?php echo $id; ?>&id_exp=<?php echo $id_exp?>&id_atencion=<?php echo $id_atencion?>" 

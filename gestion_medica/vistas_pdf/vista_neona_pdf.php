...
-->
  ...
  <title>EDITAR NOTA NEONATAL</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
<body>
  <section class="content container-fluid">
    ...
    <?php
        ...
        ?>
        <button type="button" class="btn btn-danger btn-sm" onclick="history.back()">Regresar...</button><hr>
        <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>IMPRESIÓN DE NOTA NEONATOLÓGIA </center> </strong></div>         
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from dat_not_neona WHERE id_atencion=$id_atencion ORDER BY id_neona DESC") or die($conexion->error);
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_neona=$f['id_neona'];
                    ...
                    <tr>
                        <td><a href="../pdf/pdf_neo.php?id_neona=<?php echo $id_neona; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td></a>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_neona']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha_neona']); echo date_format($date,"h:i");;?></strong></td>
                    </tr>
                    <?php
                }

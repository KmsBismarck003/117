...
<body>
  <div class="container">
    <button type="button" class="btn btn-danger btn-sm" onclick="history.back()">Regresar...</button>
              <hr>
               <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>IMPRESIÓN DE NOTA DE EGRESO </center> </strong></div>         
...
$resultado = $conexion->query("SELECT * from dat_egreso WHERE id_atencion=$id_atencion ORDER BY id_egreso DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_egreso=$f['id_egreso'];
              $id_atencion=$f['id_atencion'];
                
                    ?>
                   
                    <tr>
                        <td><a href="../pdf/pdf_egreso.php?id_in=<?php echo $id_egreso; ?>&id_exp=<?php echo $id_exp?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        
                         <td><a href="edit_egreso.php?id_in=<?php echo $id_egreso; ?>&id_exp=<?php echo $id_exp?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-warning"><i class="fa fa-edit" aria-hidden="true"></i></button></td>
                        <td><strong><?php $date=date_create($f['fech_egreso']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fech_egreso']); echo date_format($date,"H:i").' horas';?></strong></td>
                    </tr>
                    <?php
                }

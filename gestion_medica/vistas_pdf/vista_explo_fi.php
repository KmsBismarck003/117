     ...
     <button type="button" class="btn btn-danger btn-sm" onclick="history.back()">Regresar...</button>
              <hr>
               <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>
                   IMPRESIÓN DE NOTA DE EXPLORACION FÍSICA</center> </strong></div>         
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * FROM exploracion_fisica WHERE id_atencion=$id_atencion ORDER BY id DESC") or die($conexion->error);$usuario = $_SESSION['login'];
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id=$f['id'];
                    ...
                    <tr>
                       <td>
  <a href="../pdf/pdf_exploracion.php?id=<?php echo $id; ?>&id_exp=<?php echo $id_exp?>&id_atencion=<?php echo $id_atencion?>" 
     target="_blank">

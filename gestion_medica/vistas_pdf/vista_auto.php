...
<body>
    <div class="container">
        ...
        <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong>
                <center>
                    IMPRESIÓN DE NOTA DE AUTORREFRACCIÓN  / QUERATOCONO</center>
            </strong></div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col col-12">
                            ...
                            include "../../conexionbd.php";
                            $id_atencion = $_SESSION['hospital'];
                            $resultado = $conexion->query("SELECT * FROM autorefractor WHERE id_atencion=$id_atencion ORDER BY id DESC") or die($conexion->error);
                                ...
                                <table class="table table-bordered table-striped" id="mytable">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <a href="../pdf/pdf_auto.php?id=<?php echo $id; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>"
                                                        target="_blank">

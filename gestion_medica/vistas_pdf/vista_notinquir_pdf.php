...
-->
  ...
  <title>NOTA INTERVENCION QUIRURGICA</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
<body>
 <div class="container">
    ...
    <hr>
    <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>IMPRESIÓN DE DESCRIPCIÓN QUIRÚRGICA Y PORTOPERATORIA </center> </strong></div> 
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from dat_not_inquir WHERE id_atencion=$id_atencion ORDER BY id_not_inquir DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_not_inquir=$f['id_not_inquir'];

                    ?>

                    <tr>
                        <td><a href="../quirurgico/pdf_intervencion_quirurgica.php?id_not_inquir=<?php echo $id_not_inquir; ?>&id_exp=<?php echo $id_exp ?>&id=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>

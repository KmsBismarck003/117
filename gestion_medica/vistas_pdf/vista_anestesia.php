...
<head>
    <meta charset="UTF-8">
    <title>Vista Registro Anestésico</title>
...
<body>
    <div class="container">
        ...
        <div class="thead text-center" style="background-color: #2b2d7f; color: white; font-size: 22px;">
            <strong>REGISTRO ANESTÉSICO</strong>
        </div>
        <section class="content container-fluid">
            ...
            <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ¡Registro anestésico guardado correctamente!
                    ...
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="mytable">
                                ...
                                <tbody>
                                    <?php
                                    $sql_anestesico = "SELECT * FROM registro_anestesico WHERE id_atencion = ? ORDER BY fecha_registro DESC";
                                    $stmt_anestesico = $conexion->prepare($sql_anestesico);
                                    $stmt_anestesico->bind_param("i", $id_atencion);
                                    $stmt_anestesico->execute();
                                    $result_anestesico = $stmt_anestesico->get_result();
                                    while ($f = $result_anestesico->fetch_assoc()) {
                                        $id_registro_anestesico = $f['id_registro_anestesico'];
                                        ?>
                                        <tr>
                                            <td>
                                                <a href="../pdf/pdf_registro_anestesico.php?id_registro_anestesico=<?php echo (int)$id_registro_anestesico; ?>&id_exp=<?php echo (int)$id_exp; ?>&id_atencion=<?php echo (int)$id_atencion; ?>" target="_blank">

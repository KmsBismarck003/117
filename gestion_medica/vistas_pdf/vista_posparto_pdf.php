...
-->
  ...
  <title>EDITAR NOTA DE POSPARTO</title>
  <style type="text/css">
    #contenido{
        display: none;
    }
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from nota_posparto WHERE id_atencion=$id_atencion ORDER BY id_notpos DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_notpos=$f['id_notpos'];

                    ?>

                    <tr>
                        <td><a href="../pdf/pdf_posparto.php?id_notpos=<?php echo $id_notpos; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        ...
                        <td><strong><?php $date=date_create($f['fecha_nu']); echo date_format($date,"h:i");;?></strong></td>
                    </tr>
                    <?php
                }

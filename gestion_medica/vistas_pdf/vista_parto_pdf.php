...
-->
  ...
  <title>EDITAR NOTA DE PARTOGRAMA </title>
  <style type="text/css">
    #contenido{
        display: none;
    }
  ...
  <section class="content container-fluid">
    ...
    <?php
        ...
        ?>
              ...
              <hr>
               <div class="thead" style="background-color: #2b2d7f; color: white; font-size: 22px;"><strong><center>IMPRESIÓN DE NOTA DE PARTOGRAMA </center> </strong></div>         
      <div class="row">
        <div class="col-sm-2">
...
include "../../conexionbd.php";
$id_atencion=$_SESSION['hospital'];
$resultado = $conexion->query("SELECT * from partograma WHERE id_atencion=$id_atencion ORDER BY id_partograma DESC") or die($conexion->error);
...
?>
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_partograma=$f['id_partograma'];

                    ?>

                    <tr>
                        <td><a href="../pdf/pdf_partograma.php?id_partograma=<?php echo $id_partograma; ?>&id_exp=<?php echo $id_exp ?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button></td>
                        <td><strong><?php echo $f['id_atencion'];?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['fecha']); echo date_format($date,"h:i");;?></strong></td>
                    </tr>
                    <?php
                }

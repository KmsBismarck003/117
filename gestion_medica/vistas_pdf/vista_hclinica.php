...
//include "../../conexionbd.php";
 ...
 if($rol == 2) {
    ...
    include "../header_administrativo.php";
 }
            ...
            <table class="table table-bordered table-striped" id="mytable">
                ...
                while($f = mysqli_fetch_array($resultado)){
                  $id_hc=$f['id_hc'];
                    ...
                    ?>
                    <tr>
                        <td><a href="../pdf/pdf_traslados.php?id_in=<?php echo $id_hc; ?>&id_exp=<?php echo $id_exp?>&id_atencion=<?php echo $id_atencion ?>" target="_blank" ><button type="button" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></td>
                        <td><strong><?php $date=date_create($f['horenv']); echo date_format($date,"d/m/Y");?></strong></td>
                        <td><strong><?php $date=date_create($f['horec']); echo date_format($date,"H:i").' horas';?></strong></td>
                    </tr>
                    <?php
                }
                ?>
